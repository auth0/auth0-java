...
**defaultFor:** `Optional<ClientGrantDefaultForEnum>` 
...
**anonymousSessions:** `Optional<CreateAnonymousSessions>` 
...
**redirectionPolicy:** `Optional<ClientRedirectionPolicyEnum>` 
...
**anonymousSessions:** `Optional<UpdateAnonymousSessions>` 
...
**type:** `Optional<DeviceCredentialTypeEnum>` — Type of credentials to retrieve. Must be `public_key`, `refresh_token` or `rotating_refresh_token`. If none is provided a combined list of `refresh_tokens` and `public_keys` will be returned (and no `rotating_refresh_token`), in this case `page`, `per_page` and `include_totals` will be ignored.
...
<details><summary><code>client.organizations.search() -> SyncPagingIterable&amp;lt;SearchOrganization&amp;gt;</code></summary>
<dl>
<dd>
...
**parser:** `Optional<SearchParserEnum>` — Query parser to use for the filter expression. Use "scim" for SCIM filter syntax or "lucene" for Lucene query syntax (default).
...
**take:** `Optional<Integer>` — Maximum number of results to return per page (1-100). Defaults to 50.
...
**from:** `Optional<String>` — Cursor for the next page of results. Use the value from the next field in the previous response.
...
**sort:** `Optional<OrganizationSortFieldEnum>` — Field name to sort results by in ascending order only. Defaults to insertion order (oldest first) if not provided.
...
## RateLimitPolicies
<details><summary><code>client.rateLimitPolicies.list() -> SyncPagingIterable&amp;lt;RateLimitPolicy&amp;gt;</code></summary>
<dl>
<dd>
...
**resource:** `Optional<RateLimitPolicyResourceEnum>` — The API protected by the Rate Limit Policy.
...
**consumer:** `Optional<RateLimitPolicyConsumerEnum>` — The consumer to which the rate limit policy applies.
...
**consumerSelector:** `Optional<String>` — Identifier or category within the consumer to which the policy applies. Supported values: `client_id:<client_id>` to target a specific client by ID, `client_id:<cimd_uri>` to target a CIMD client by URI, `cimd_clients` to target all CIMD clients, `third_party_clients` to target all third-party clients, or `default` to apply the policy to any consumer identifier not otherwise explicitly targeted.
...
**from:** `Optional<String>` — Cursor for pagination.
...
**tokenLifetimeForAnonymousAccessTokens:** `Optional<Integer>` — Expiration value (in seconds) for anonymous-session access tokens issued for this API.
...
<details><summary><code>client.resourceServers.search() -> SyncPagingIterable&amp;lt;ResourceServerSearchResponse&amp;gt;</code></summary>
<dl>
<dd>
...
**fields:** `Optional<String>` — Comma-separated list of fields to include or exclude in the response. Works with the include_fields parameter to control projection mode.
...
**includeFields:** `Optional<Boolean>` — Controls field projection mode. Set to true to include only fields specified in the fields parameter. Set to false to exclude fields specified in the fields parameter. Defaults to true if not specified.
...
**sort:** `Optional<ResourceServerSortFieldEnum>` — Field name to sort results by in ascending order only. Defaults to insertion order (oldest first) if not provided.
...
<details><summary><code>client.connections.directoryProvisioning.listSynchronizedGroups(id) -> SyncPagingIterable&amp;lt;SynchronizedGroupPayload&amp;gt;</code></summary>
<dl>
<dd>
...
## Groups Roles
<details><summary><code>client.groups.roles.list(id) -> SyncPagingIterable&amp;lt;Role&amp;gt;</code></summary>
<dl>
<dd>
...
**roles:** `List<String>` — Array of role IDs to assign to the group.
...
**roles:** `List<String>` — Array of role IDs to remove from the group.
...
client.guardian().factors().email().set(
    SetEmailFactorSettingsRequestContent
        .builder()
        .otpLength(1)
        .otpExpirationTime(1)
        .build()
...
client.guardian().factors().phone().set(
    SetPhoneFactorSettingsRequestContent
        .builder()
        .otpLength(1)
        .otpExpirationTime(1)
        .build()
...
<details><summary><code>client.organizations.groups.list(organizationId) -> SyncPagingIterable&amp;lt;Group&amp;gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.organizations.groups.roles.list(organizationId, groupId) -> SyncPagingIterable&amp;lt;Role&amp;gt;</code></summary>
<dl>
<dd>
...
**roles:** `List<String>` — Array of role IDs to assign to organization group.
...
**roles:** `List<String>` — Array of role IDs to delete from organization group.
...
<details><summary><code>client.organizations.members.effectiveRoles.list(id, userId) -> SyncPagingIterable&amp;lt;OrganizationMemberEffectiveRole&amp;gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.organizations.members.effectiveRoles.sources.groups.list(id, userId) -> SyncPagingIterable&amp;lt;Group&amp;gt;</code></summary>
<dl>
<dd>
...
## Roles Groups
<details><summary><code>client.roles.groups.get(id) -> SyncPagingIterable&amp;lt;Group&amp;gt;</code></summary>
<dl>
<dd>
...
**groups:** `List<String>` — Array of group IDs to assign to the role.
...
**groups:** `List<String>` — Array of group IDs to remove from the role.
...
**clientIdMetadataDocumentSupported:** `Optional<Boolean>` — Whether the authorization server supports retrieving client metadata from a client_id URL.
...
**countryCodes:** `Optional<TenantSettingsCountryCodes>` 
...
<details><summary><code>client.users.effectivePermissions.list(id) -> SyncPagingIterable&amp;lt;UserEffectivePermissionResponseContent&amp;gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.users.effectiveRoles.list(id) -> SyncPagingIterable&amp;lt;UserEffectiveRole&amp;gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.users.effectivePermissions.sources.roles.list(id) -> SyncPagingIterable&amp;lt;UserEffectivePermissionRoleSourceResponseContent&amp;gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.users.effectiveRoles.sources.groups.list(id) -> SyncPagingIterable&amp;lt;Group&amp;gt;</code></summary>
<dl>
<dd>
