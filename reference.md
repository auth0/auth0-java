...
<details><summary><code>client.actions.modules.create() -> CreateActionModuleResponseContent</code></summary>
<dl>
<dd>
...
<details><summary><code>client.actions.modules.update(id) -> UpdateActionModuleResponseContent</code></summary>
<dl>
<dd>
...
```java
client.actions().modules().update("id");
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.actions.modules.rollback(id) -> RollbackActionModuleResponseContent</code></summary>
<dl>
<dd>
