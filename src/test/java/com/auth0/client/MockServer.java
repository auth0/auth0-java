...
public class MockServer {
    ...
    public static final String AUTH_ERROR_WITH_ERROR_DESCRIPTION =
            "src/test/resources/auth/error_with_error_description.json";
    ...
    public static final String AUTH_ERROR_WITH_DESCRIPTION_AND_EXTRA_PROPERTIES =
            "src/test/resources/auth/error_with_description_and_extra_properties.json";
    public static final String AUTH_ERROR_PLAINTEXT = "src/test/resources/auth/error_plaintext.json";
    public static final String AUTH_OOB_AUTHENTICATOR_RESPONSE =
            "src/test/resources/auth/add_oob_authenticator_response.json";
    public static final String AUTH_OTP_AUTHENTICATOR_RESPONSE =
            "src/test/resources/auth/add_otp_authenticator_response.json";
    public static final String AUTH_LIST_AUTHENTICATORS_RESPONSE =
            "src/test/resources/auth/list_authenticators_response.json";
    ...
    public static final String MGMT_CONNECTION_SCIM_CONFIGURATION =
            "src/test/resources/mgmt/connection_scim_configuration.json";
    public static final String MGMT_CONNECTION_DEFAULT_SCIM_CONFIGURATION =
            "src/test/resources/mgmt/default_connection_scim_configuration.json";
    ...
    public static final String MGMT_ENABLED_CLIENTS_FOR_CONNECTION =
            "src/test/resources/mgmt/enabled_clients_for_connection.json";
    ...
    public static final String MGMT_RESOURCE_SERVERS_PAGED_LIST =
            "src/test/resources/mgmt/resource_servers_paged_list.json";
    ...
    public static final String MGMT_ROLE_PERMISSIONS_PAGED_LIST =
            "src/test/resources/mgmt/role_permissions_paged_list.json";
    ...
    public static final String MGMT_ROLE_USERS_CHECKPOINT_PAGED_LIST =
            "src/test/resources/mgmt/role_users_checkpoint_paged_list.json";
    ...
    public static final String MGMT_USER_PERMISSIONS_PAGED_LIST =
            "src/test/resources/mgmt/user_permissions_paged_list.json";
    ...
    public static final String MGMT_GUARDIAN_AUTHENTICATION_POLICIES_LIST =
            "src/test/resources/mgmt/guardian_authentication_policies_list.json";
    public static final String MGMT_GUARDIAN_ENROLLMENT = "src/test/resources/mgmt/guardian_enrollment.json";
    public static final String MGMT_GUARDIAN_ENROLLMENTS_LIST =
            "src/test/resources/mgmt/guardian_enrollments_list.json";
    public static final String MGMT_GUARDIAN_ENROLLMENT_TICKET =
            "src/test/resources/mgmt/guardian_enrollment_ticket.json";
    ...
    public static final String MGMT_GUARDIAN_SNS_FACTOR_PROVIDER_EMPTY =
            "src/test/resources/mgmt/guardian_sns_factor_provider_empty.json";
    public static final String MGMT_GUARDIAN_SNS_FACTOR_PROVIDER =
            "src/test/resources/mgmt/guardian_sns_factor_provider.json";
    public static final String MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_EMPTY =
            "src/test/resources/mgmt/guardian_twilio_factor_provider_empty.json";
    public static final String MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_WITH_FROM =
            "src/test/resources/mgmt/guardian_twilio_factor_provider_with_from.json";
    public static final String MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_WITH_MSSID =
            "src/test/resources/mgmt/guardian_twilio_factor_provider_with_messaging_service_sid.json";
    ...
    public static final String MGMT_EMAIL_VERIFICATION_TICKET =
            "src/test/resources/mgmt/email_verification_ticket.json";
    ...
    public static final String MGMT_JOB_POST_VERIFICATION_EMAIL =
            "src/test/resources/mgmt/job_post_verification_email.json";
    ...
    public static final String MGMT_JOB_POST_USERS_IMPORTS_INPUT =
            "src/test/resources/mgmt/job_post_users_imports_input.json";
    ...
    public static final String MGMT_USER_ATTRIBUTE_PROFILES_LIST =
    ...
    public static final String MGMT_USER_ATTRIBUTE_PROFILE_TEMPLATE =
            "src/test/resources/mgmt/user_attribute_profile_template.json";
    public static final String MGMT_USER_ATTRIBUTE_PROFILE_TEMPLATES_LIST =
            "src/test/resources/mgmt/user_attribute_profile_templates_list.json";
    ...
    public static final String PUSHED_AUTHORIZATION_RESPONSE =
            "src/test/resources/auth/pushed_authorization_response.json";
    public static final String BACK_CHANNEL_AUTHORIZE_RESPONSE =
            "src/test/resources/auth/back_channel_authorize_response.json";
    public static final String BACK_CHANNEL_LOGIN_STATUS_RESPONSE =
            "src/test/resources/auth/back_channel_login_status_response.json";
    ...
    public static final String AUTHENTICATOR_METHOD_PAGED_LIST =
            "src/test/resources/mgmt/authenticator_method_paged_list.json";
    public static final String AUTHENTICATOR_METHOD_UPDATE = "src/test/resources/mgmt/authenticator_method_update.json";
    public static final String AUTHENTICATOR_METHOD_UPDATE_BY_ID =
            "src/test/resources/mgmt/authenticator_method_update_by_id.json";
    ...
    public static final String ORGANIZATIONS_CHECKPOINT_PAGED_LIST =
            "src/test/resources/mgmt/organizations_checkpoint_paged_list.json";
    public static final String ORGANIZATION_MEMBERS_LIST = "src/test/resources/mgmt/organization_members_list.json";
    public static final String ORGANIZATION_MEMBERS_PAGED_LIST =
            "src/test/resources/mgmt/organization_members_paged_list.json";
    public static final String ORGANIZATION_MEMBERS_CHECKPOINT_PAGED_LIST =
            "src/test/resources/mgmt/organization_members_checkpoint_paged_list.json";
    public static final String ORGANIZATION_CONNECTIONS_LIST =
            "src/test/resources/mgmt/organization_connections_list.json";
    public static final String ORGANIZATION_CONNECTIONS_PAGED_LIST =
    ...
    public static final String ORGANIZATION_MEMBER_ROLES_LIST =
            "src/test/resources/mgmt/organization_member_roles_list.json";
    public static final String ORGANIZATION_MEMBER_ROLES_PAGED_LIST =
            "src/test/resources/mgmt/organization_member_roles_paged_list.json";
    public static final String ORGANIZATION_CLIENT_GRANTS = "src/test/resources/mgmt/organization_client_grants.json";
    public static final String ORGANIZATION_CLIENT_GRANTS_PAGED_LIST =
            "src/test/resources/mgmt/organization_client_grants_paged_list.json";
    ...
    public static final String SUSPICIOUS_IP_THROTTLING_CONFIGURATION =
            "src/test/resources/mgmt/suspicious_ip_throttling_configuration.json";
    ...
    public static final String SELF_SERVICE_PROFILE_RESPONSE =
            "src/test/resources/mgmt/self_service_profile_response.json";
    public static final String SELF_SERVICE_PROFILE_CUSTOM_TEXT =
            "src/test/resources/mgmt/self_service_profile_custom_text.json";
    public static final String SELF_SERVICE_PROFILE_SSO_TICKET =
            "src/test/resources/mgmt/self_service_profile_sso_ticket.json";
    ...
    public void rateLimitReachedResponse(long limit, long remaining, long reset, String path) throws IOException {
        ...
        if (path != null) {
            response.addHeader("Content-Type", "application/json").setBody(readTextFile(path));
        }
        server.enqueue(response);
    }

    public void rateLimitReachedResponse(
            long limit,
            long remaining,
            long reset,
            String clientQuotaLimit,
