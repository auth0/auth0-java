...
public class AuthorizeUrlBuilderTest {
    ...
    public void shouldBuildValidAuthorizeUrlWithHttp() {
        ...
        String url = AuthorizeUrlBuilder.newInstance(httpBaseUrl, CLIENT_ID, REDIRECT_URI)
                .build();
    ...
    public void shouldBuildValidAuthorizeUrlWithHttps() {
        ...
        String url = AuthorizeUrlBuilder.newInstance(httpsBaseUrl, CLIENT_ID, REDIRECT_URI)
                .build();
    ...
    public void shouldAddResponseTypeCode() {
        String url =
                AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI).build();
    ...
    public void shouldNotEncodeTwiceTheRedirectUri() throws Exception {
        ...
        String url =
                AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, encodedUrl).build();
