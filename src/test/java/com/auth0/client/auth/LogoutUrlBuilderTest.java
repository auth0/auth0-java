...
public class LogoutUrlBuilderTest {
    ...
    public void shouldBuildValidLogoutUrlWithHttp() {
        ...
        String url = LogoutUrlBuilder.newInstance(httpBaseUrl, CLIENT_ID, RETURN_TO_URL, true)
                .build();
    ...
    public void shouldBuildValidLogoutUrlWithHttps() {
        ...
        String url = LogoutUrlBuilder.newInstance(httpsBaseUrl, CLIENT_ID, RETURN_TO_URL, true)
                .build();
    ...
    public void shouldNotEncodeTwiceTheReturnToURL() throws Exception {
        ...
        String url = LogoutUrlBuilder.newInstance(DOMAIN, CLIENT_ID, encodedUrl, true)
                .build();
    ...
    public void shouldNotAddClientId() {
        String url = LogoutUrlBuilder.newInstance(DOMAIN, CLIENT_ID, RETURN_TO_URL, false)
                .build();
