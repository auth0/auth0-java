...
public class RSAClientAssertionSignerTest {
    ...
    public void throwsWhenErrorSigning256() {
        ...
        ClientAssertionSigningException e = verifyThrows(
                ClientAssertionSigningException.class,
    ...
    public void throwsWhenErrorSigning384() {
        ...
        ClientAssertionSigningException e = verifyThrows(
                ClientAssertionSigningException.class,
                () -> new RSAClientAssertionSigner(mockPrivateKey, RSAClientAssertionSigner.RSASigningAlgorithm.RSA384)
                        .createSignedClientAssertion("iss", "aud", "sub"),
    ...
    public void createsVerifiedRSA256SigningAssertion() throws Exception {
        ...
        assertThat(
                ...
                is(decodedJWT.getIssuedAtAsInstant().plusSeconds(180)));
    ...
    public void createsVerifiedRSA384SigningAssertion() throws Exception {
        ...
        RSAClientAssertionSigner clientAssertion = new RSAClientAssertionSigner(
                (RSAPrivateKey) keyPair.getPrivate(), RSAClientAssertionSigner.RSASigningAlgorithm.RSA384);
        String jwt = clientAssertion.createSignedClientAssertion("issuer", "audience", "subject");
