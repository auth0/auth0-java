...
public class AuthAPITest {
    ...
    private static final String PASSWORD_STRENGTH_ERROR_RESPONSE_NONE =
            "src/test/resources/auth/password_strength_error_none.json";
    private static final String PASSWORD_STRENGTH_ERROR_RESPONSE_SOME =
            "src/test/resources/auth/password_strength_error_some.json";
    ...
    public void setUp() throws Exception {
        ...
        apiNoClientAuthentication =
                AuthAPI.newBuilder(server.getBaseUrl(), CLIENT_ID).build();
    }
    ...
    public void shouldAcceptDomainWithNoScheme() {
        AuthAPI api =
                AuthAPI.newBuilder("me.something.com", CLIENT_ID, CLIENT_SECRET).build();
    ...
    public void shouldAcceptDomainWithHttpScheme() {
        AuthAPI api = AuthAPI.newBuilder("http://me.something.com", CLIENT_ID, CLIENT_SECRET)
                .build();
    ...
    public void shouldAcceptNullClientSecret() {
        assertThat(AuthAPI.newBuilder(DOMAIN, CLIENT_ID, (String) null).build(), is(notNullValue()));
    }
    ...
    public void shouldThrowWhenAuthorizeUrlBuilderRedirectUriIsNull() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.authorizeUrl(null), "'redirect uri' must be a valid URL!");
    }
    ...
    public void shouldSetAuthorizeUrlBuilderDefaultValues() {
        AuthAPI api =
                AuthAPI.newBuilder("domain.auth0.com", CLIENT_ID, CLIENT_SECRET).build();
    ...
    public void shouldThrowOnUserInfoWithNullAccessToken() {
        verifyThrows(IllegalArgumentException.class, () -> api.userInfo(null), "'access token' cannot be null!");
    }
    ...
    public void shouldCreateUserInfoRequest() throws Exception {
        ...
        List<Map<String, Object>> identities =
                (List<Map<String, Object>>) response.getValues().get("identities");
    ...
    public void shouldThrowOnSignUpWithNullEmail() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.signUp(null, new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "my-connection"),
                "'email' cannot be null!");
    }
    ...
    public void shouldThrowOnSignUpWithNullConnection() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.signUp("me@auth0.com", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, null),
                "'connection' cannot be null!");
    }
    ...
    public void shouldThrowOnUsernameSignUpWithNullEmail() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.signUp(null, "me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "my-connection"),
                "'email' cannot be null!");
    }
    ...
    public void shouldThrowOnUsernameSignUpWithNullUsername() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.signUp(
                        "me@auth0.com", null, new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "my-connection"),
    ...
    public void shouldThrowOnUsernameSignUpWithNullConnection() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.signUp("me@auth0.com", "me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, null),
                "'connection' cannot be null!");
    }
    ...
    public void shouldHaveNotStrongPasswordWithShortDetailedDescription() throws Exception {
        ...
        assertThat(ex.getError(), is("invalid_password"));
        String expectedDescription =
                "Should contain: lower case letters (a-z), upper case letters (A-Z), numbers (i.e. 0-9), special characters (e.g. !@#$%^&*)";
        assertThat(ex.getDescription(), is(expectedDescription));
    }

    @Test
    public void shouldCreateSignUpRequestWithUsernameAndPhoneNumber() throws Exception {
        SignUpRequest request = api.signUp(
                "me@auth0.com",
                "me",
                new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'},
                "db-connection",
    ...
    public void shouldCreateSignUpRequestWithUsername() throws Exception {
        SignUpRequest request =
                api.signUp("me@auth0.com", "me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "db-connection");
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreateSignUpRequest() throws Exception {
        SignUpRequest request =
                api.signUp("me@auth0.com", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "db-connection");
    ...
    public void shouldThrowOnLogInWithAuthorizationCodeGrantAndRedirectUriWithNullRedirectUri() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.exchangeCode("code", null), "'redirect uri' cannot be null!");
    }
    ...
    public void shouldThrowOnLogInWithPasswordWithNullUsername() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.login(null, new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}),
    ...
    public void shouldThrowOnLogInWithCharPasswordWithNullPassword() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.login("me", (char[]) null), "'password' cannot be null!");
    }

    @Test
    public void shouldCreateLogInWithPasswordGrantRequest() throws Exception {
        TokenRequest request = api.login("me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'});
        assertThat(request, is(notNullValue()));
    ...
    public void passwordGrantRequestRequiresClientAuthentication() {
        verifyThrows(
                IllegalStateException.class,
                () -> apiNoClientAuthentication.login("me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}),
                "A client secret or client assertion signing key is required for this operation");
    }
    ...
    public void shouldThrowOnLogInWithPasswordRealmWithNullUsername() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.login(null, new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "realm"),
                "'email or username' cannot be null!");
    }
    ...
    public void shouldThrowOnLogInWithPasswordRealmWithNullRealm() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.login("me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, null),
                "'realm' cannot be null!");
    }

    @Test
    public void shouldCreateLogInWithPasswordRealmGrantRequest() throws Exception {
        TokenRequest request = api.login("me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "realm");
        assertThat(request, is(notNullValue()));
    ...
    public void passwordRealmGrantRequestRequiresClientAuthentication() {
        verifyThrows(
                IllegalStateException.class,
                () -> apiNoClientAuthentication.login(
                        "me", new char[] {'p', '4', '5', '5', 'w', '0', 'r', 'd'}, "realm"),
                "A client secret or client assertion signing key is required for this operation");
    }
    ...
    public void shouldThrowOnLogInWithClientCredentialsWithNullAudience() {
        verifyThrows(IllegalArgumentException.class, () -> api.requestToken(null), "'audience' cannot be null!");
    }
    ...
    @Test
    public void shouldThrowOnExchangeTokenWithNullSubjectToken() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.exchangeToken(null, "urn:mycompany:m2m-test-token"),
                "'subject token' cannot be null!");
    }

    @Test
    public void shouldThrowOnExchangeTokenWithNullSubjectTokenType() {
        verifyThrows(
                IllegalArgumentException.class,
                () -> api.exchangeToken("test-user123-john@example.com", null),
                "'subject token type' cannot be null!");
    }

    @Test
    public void shouldCreateTokenExchangeRequest() throws Exception {
        TokenRequest request = api.exchangeToken("test-user123-john@example.com", "urn:mycompany:m2m-test-token")
        ...
        Map<String, Object> body = bodyFromRequest(recordedRequest);
        assertThat(body, hasEntry("grant_type", "urn:ietf:params:oauth:grant-type:token-exchange"));
        assertThat(body, hasEntry("client_id", CLIENT_ID));
        assertThat(body, hasEntry("client_secret", CLIENT_SECRET));
        assertThat(body, hasEntry("subject_token", "test-user123-john@example.com"));
        assertThat(body, hasEntry("subject_token_type", "urn:mycompany:m2m-test-token"));
        assertThat(body, hasEntry("audience", "https://myapi.auth0.com/users"));
        assertThat(body, hasEntry("scope", "openid profile email"));
    ...
    @Test
    public void tokenExchangeRequestRequiresClientAuthentication() {
        verifyThrows(
                IllegalStateException.class,
                () -> apiNoClientAuthentication.exchangeToken(
                        "test-user123-john@example.com", "urn:mycompany:m2m-test-token"),
                "A client secret or client assertion signing key is required for this operation");
    }

    @Test
    public void shouldCreateTokenExchangeRequestWithClientAssertion() throws Exception {
    ...
    public void shouldCreateStartEmailPasswordlessFlowRequest() throws Exception {
        Request<PasswordlessEmailResponse> request =
                api.startPasswordlessEmailFlow("user@domain.com", PasswordlessEmailType.CODE);
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreateStartEmailPasswordlessFlowRequestWithoutClientAuthentication() throws Exception {
        Request<PasswordlessEmailResponse> request =
                apiNoClientAuthentication.startPasswordlessEmailFlow("user@domain.com", PasswordlessEmailType.CODE);
        assertThat(request, is(notNullValue()));

        emailPasswordlessRequest(request, false);
    }

    private void emailPasswordlessRequest(Request<PasswordlessEmailResponse> request, boolean secretSent)
            throws Exception {
    ...
    public void shouldCreateStartEmailPasswordlessFlowRequestWithCustomParams() throws Exception {
        ...
        BaseRequest<PasswordlessEmailResponse> request = api.startPasswordlessEmailFlow(
                        "user@domain.com", PasswordlessEmailType.CODE)
    ...
    public void shouldCreateLoginWithPasswordlessCodeRequestWithoutClientAuthentication() throws Exception {
        TokenRequest request =
                apiNoClientAuthentication.exchangePasswordlessOtp("+16511234567", "email", "otp".toCharArray());
        assertThat(request, is(notNullValue()));
    ...
    public void shouldThrowOnRevokeTokenWithNullToken() {
        verifyThrows(IllegalArgumentException.class, () -> api.revokeToken(null), "'refresh token' cannot be null!");
    }
    ...
    public void shouldThrowOnRenewAuthWithNullRefreshToken() {
        verifyThrows(IllegalArgumentException.class, () -> api.renewAuth(null), "'refresh token' cannot be null!");
    }
    ...
    public void shouldThrowWhenExchangeMfaOtpCalledWithNullOtp() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.exchangeMfaOtp("mfaToken", null), "'otp' cannot be null!");
    }
    ...
    public void shouldCreateExchangeMfaOobRequestWithoutSecret() throws Exception {
        TokenRequest request = apiNoClientAuthentication.exchangeMfaOob(
                "mfaToken", new char[] {'o', 'o', 'b'}, new char[] {'b', 'o', 'b'});
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreateExchangeMfaRecoveryCodeRequestWithoutSecret() throws Exception {
        TokenRequest request =
                apiNoClientAuthentication.exchangeMfaRecoveryCode("mfaToken", new char[] {'c', 'o', 'd', 'e'});
        assertThat(request, is(notNullValue()));
    ...
    public void addOtpAuthenticatorThrowsWhenTokenNull() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.addOtpAuthenticator(null), "'mfa token' cannot be null!");
    }
    ...
    public void addOobAuthenticatorRequestWithPhoneNumber() throws Exception {
        Request<CreatedOobResponse> request =
                api.addOobAuthenticator("mfaToken", Collections.singletonList("sms"), "phone-number", null);
    ...
    public void addOobAuthenticatorRequestWithEmail() throws Exception {
        Request<CreatedOobResponse> request =
                api.addOobAuthenticator("mfaToken", Collections.singletonList("email"), null, "email-address");
    ...
    public void addOobAuthenticatorRequestWithNoContactInfo() throws Exception {
        Request<CreatedOobResponse> request =
                api.addOobAuthenticator("mfaToken", Collections.singletonList("auth0"), null, null);
    ...
    public void addOobAuthenticatorRequestWithMultipleChannels() throws Exception {
        Request<CreatedOobResponse> request = api.addOobAuthenticator(
                "mfaToken", Arrays.asList("sms", "email", "auth0"), "phone-number", "email-address");
    ...
    public void addOobAuthenticatorRequestWithAuth0Channel() throws Exception {
        Request<CreatedOobResponse> request =
                api.addOobAuthenticator("mfaToken", Collections.singletonList("auth0"), null, "email-address");
    ...
    public void listAuthenticatorsThrowsWhenTokenNull() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.listAuthenticators(null), "'access token' cannot be null!");
    }
    ...
    public void shouldNotAddAnyParamsIfNoSecretOrAssertion() throws Exception {
        ...
        TokenRequest request =
                authAPI.exchangeCodeWithVerifier("code123", "verifier", "https://domain.auth0.com/callback");
        ...
        assertThat(
                body, not(hasEntry("client_assertion_type", "urn:ietf:params:oauth:client-assertion-type:jwt-bearer")));
    ...
    public void authorizeUrlWithPARShouldThrowWhenRequestUriNull() {
        verifyThrows(
                IllegalArgumentException.class, () -> api.authorizeUrlWithPAR(null), "'request uri' cannot be null!");
    }
    ...
    public void shouldCreatePushedAuthorizationRequestWithNullAdditionalParams() throws Exception {
        Request<PushedAuthorizationResponse> request =
                api.pushedAuthorizationRequest("https://domain.com/callback", "code", null);
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreatePushedAuthorizationRequestWithAdditionalParams() throws Exception {
        ...
        Request<PushedAuthorizationResponse> request =
                api.pushedAuthorizationRequest("https://domain.com/callback", "code", additionalParams);
        assertThat(request, is(notNullValue()));
    ...
    public void shouldCreatePushedAuthorizationRequestWithAuthDetails() throws Exception {
        ...
        Request<PushedAuthorizationResponse> request =
                api.pushedAuthorizationRequest("https://domain.com/callback", "code", null, authDetailsList);
        assertThat(request, is(notNullValue()));
        ...
        List<Map<String, Object>> deserialized =
                ObjectMapperProvider.getMapper().readValue(decodedAuthDetails, typeReference);
    ...
    public void shouldThrowWhenCreatePushedAuthorizationRequestWithInvalidAuthDetails() {
        ...
        IllegalArgumentException e = verifyThrows(
                IllegalArgumentException.class,
    ...
    public void authorizeUrlWithJARShouldThrowWhenRequestNull() {
        verifyThrows(IllegalArgumentException.class, () -> api.authorizeUrlWithJAR(null), "'request' cannot be null!");
    }

    @Test
    public void shouldBuildAuthorizeUrlWithJAR() {
        String requestJwt =
                "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbGllbnRfaWQiOiIxMjM0NTYiLCJyZWRpcmVjdF91cmkiOiJodHRwOi8vbG9jYWxob3N0OjMwMDAiLCJyZXNwb25zZV90eXBlIjoiY29kZSIsIm5vbmNlIjoiMTIzNCIsInN0YXRlIjoiNzhkeXVma2poZGYifQ.UQDz8hBIabaqatY75BvqGyiPoOqNYJQIsimUKg4_VrU";
        AuthAPI api =
                AuthAPI.newBuilder("domain.auth0.com", CLIENT_ID, CLIENT_SECRET).build();
        String url = api.authorizeUrlWithJAR(
                "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbGllbnRfaWQiOiIxMjM0NTYiLCJyZWRpcmVjdF91cmkiOiJodHRwOi8vbG9jYWxob3N0OjMwMDAiLCJyZXNwb25zZV90eXBlIjoiY29kZSIsIm5vbmNlIjoiMTIzNCIsInN0YXRlIjoiNzhkeXVma2poZGYifQ.UQDz8hBIabaqatY75BvqGyiPoOqNYJQIsimUKg4_VrU");
        assertThat(url, is(notNullValue()));
        assertThat(url, isUrl("https", "domain.auth0.com", "/authorize"));
    ...
    public void shouldCreatePushedAuthorizationJarRequestWithoutAuthDetails() throws Exception {
        ...
        Request<PushedAuthorizationResponse> request =
                api.pushedAuthorizationRequestWithJAR(requestJwt, authDetailsList);
        assertThat(request, is(notNullValue()));
    ...
    public void shouldThrowWhenCreatePushedAuthorizationJarRequestWithInvalidAuthDetails() {
        ...
        IllegalArgumentException e = verifyThrows(
                IllegalArgumentException.class, () -> api.pushedAuthorizationRequestWithJAR(requestJwt, mockList));
    ...
    public void authorizeBackChannel() throws Exception {
        Request<BackChannelAuthorizeResponse> request =
                api.authorizeBackChannel("openid", "This is binding message", getLoginHint());
        assertThat(request, is(notNullValue()));
        ...
        assertThat(
                body,
                containsString(
                        "login_hint={\"sub\":\"auth0|user1\",\"format\":\"format1\",\"iss\":\"https://auth0.com\"}"));
    ...
    public void authorizeBackChannelWithAudienceAndRequestedExpiry() throws Exception {
        Request<BackChannelAuthorizeResponse> request = api.authorizeBackChannel(
                "openid", "This is binding message", getLoginHint(), "https://api.example.com", 300);
        assertThat(request, is(notNullValue()));
    ...
    private Map<String, String> getQueryMap(String input) {
        ...
        return Arrays.stream(params).map(param -> param.split("=")).collect(Collectors.toMap(p -> p[0], p -> p[1]));
    }
