...
public class RulesEntity extends BaseManagementEntity {
    ...
    public Request<RulesPage> listAll(RulesFilter filter) {
        ...
        CustomRequest<RulesPage> request = new CustomRequest<>(client, tokenProvider, url, HttpMethod.GET, new TypeReference<RulesPage>() {
        });
    ...
    public Request<List<Rule>> list(RulesFilter filter) {
        ...
        String url = builder.build().toString();
        CustomRequest<List<Rule>> request = new CustomRequest<>(client, tokenProvider, url, HttpMethod.GET, new TypeReference<List<Rule>>() {
        });
        // request.addHeader("Authorization", "Bearer " + apiToken);
        return request;
    }
    ...
    public Request<Rule> get(String ruleId, RulesFilter filter) {
        ...
        String url = builder.build().toString();
        CustomRequest<Rule> request = new CustomRequest<>(client, tokenProvider, url, HttpMethod.GET, new TypeReference<Rule>() {
        });
        // request.addHeader("Authorization", "Bearer " + apiToken);
        return request;
    }
