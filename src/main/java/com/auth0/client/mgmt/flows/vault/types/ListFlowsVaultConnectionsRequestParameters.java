...
public final class ListFlowsVaultConnectionsRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListFlowsVaultConnectionsRequestParameters
                && equalTo((ListFlowsVaultConnectionsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListFlowsVaultConnectionsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListFlowsVaultConnectionsRequestParameters other) {
            page(other.getPage());
        ...
        public ListFlowsVaultConnectionsRequestParameters build() {
            return new ListFlowsVaultConnectionsRequestParameters(page, perPage, includeTotals, additionalProperties);
        }
    }
}
