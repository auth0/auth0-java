...
public class EmailProviderEntity extends BaseManagementEntity {
    ...
    public Request<EmailProvider> get(FieldsFilter filter) {
        ...
        ExtendedBaseRequest<EmailProvider> request = new ExtendedBaseRequest<>(client, url, HttpMethod.GET, new TypeReference<EmailProvider>() {
        });
    ...
    public Request<EmailProvider> setup(EmailProvider emailProvider) {
        ...
        String url = baseUrl
                ...
                .build()
                .toString();
        ExtendedBaseRequest<EmailProvider> request = new ExtendedBaseRequest<>(this.client, url, HttpMethod.POST, new TypeReference<EmailProvider>() {
        });
        request.addHeader("Authorization", "Bearer " + apiToken);
    ...
    public Request<EmailProvider> update(EmailProvider emailProvider) {
        ...
        String url = baseUrl
                ...
                .build()
                .toString();
        ExtendedBaseRequest<EmailProvider> request = new ExtendedBaseRequest<>(this.client, url, HttpMethod.PATCH, new TypeReference<EmailProvider>() {
        });
        request.addHeader("Authorization", "Bearer " + apiToken);
        request.setBody(emailProvider);
        return request;
