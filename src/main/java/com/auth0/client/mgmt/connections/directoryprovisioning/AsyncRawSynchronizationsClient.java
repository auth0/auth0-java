...
public class AsyncRawSynchronizationsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSynchronizationsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateDirectorySynchronizationResponseContent>> create(
            String id) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<CreateDirectorySynchronizationResponseContent>> create(
        ...
        CompletableFuture<ManagementApiHttpResponse<CreateDirectorySynchronizationResponseContent>> future =
