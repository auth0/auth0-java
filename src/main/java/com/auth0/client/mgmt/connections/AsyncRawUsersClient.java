...
public class AsyncRawUsersClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> deleteByEmail(
            String id, DeleteConnectionUsersByEmailQueryParameters request) {
        return deleteByEmail(id, request, null);
    }
