...
public class AsyncModulesClient {
     ...
     * Create a new Actions Module for reusable code across actions.
     */
    public CompletableFuture<CreateActionModuleResponseContent> create(RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<RollbackActionModuleResponseContent> rollback(String id) {
     ...
     * Rolls back an Actions Module's draft to a previously created version. This action copies the code, dependencies, and secrets from the specified version into the current draft.
     */
    public CompletableFuture<RollbackActionModuleResponseContent> rollback(String id, RequestOptions requestOptions) {
