...
public final class GetActionModuleVersionsRequestParameters {
    ...
    private GetActionModuleVersionsRequestParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetActionModuleVersionsRequestParameters
                && equalTo((GetActionModuleVersionsRequestParameters) other);
    }
    ...
    private boolean equalTo(GetActionModuleVersionsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetActionModuleVersionsRequestParameters other) {
            page(other.getPage());
        ...
        /**
         * <p>The maximum number of results to be returned by the server in a single response. 20 by default.</p>
         */
        ...
        public GetActionModuleVersionsRequestParameters build() {
            return new GetActionModuleVersionsRequestParameters(page, perPage, additionalProperties);
        }
    }
}
