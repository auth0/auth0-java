...
public class AsyncRawTriggersClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<ListActionTriggersResponseContent>> list() {
        return list(null);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<ListActionTriggersResponseContent>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<ListActionTriggersResponseContent>> future =
