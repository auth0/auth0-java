...
@JsonDeserialize(builder = ListRolePermissionsRequestParameters.Builder.class)
public final class ListRolePermissionsRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListRolePermissionsRequestParameters
                && equalTo((ListRolePermissionsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListRolePermissionsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListRolePermissionsRequestParameters other) {
        ...
        public ListRolePermissionsRequestParameters build() {
            return new ListRolePermissionsRequestParameters(perPage, page, includeTotals, additionalProperties);
        }
    }
}
