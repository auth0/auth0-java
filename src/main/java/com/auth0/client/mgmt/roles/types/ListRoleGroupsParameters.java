...
@JsonDeserialize(builder = ListRoleGroupsParameters.Builder.class)
public final class ListRoleGroupsParameters {
    ...
    private ListRoleGroupsParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListRoleGroupsParameters && equalTo((ListRoleGroupsParameters) other);
    }
    ...
    private boolean equalTo(ListRoleGroupsParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListRoleGroupsParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        public ListRoleGroupsParameters build() {
            return new ListRoleGroupsParameters(from, take, additionalProperties);
        }
