...
public class RawEffectivePermissionsClient {
    protected final ClientOptions clientOptions;

    public RawEffectivePermissionsClient(ClientOptions clientOptions) {
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<UserEffectivePermissionResponseContent>> list(
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<UserEffectivePermissionResponseContent>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListUserEffectivePermissionsResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
