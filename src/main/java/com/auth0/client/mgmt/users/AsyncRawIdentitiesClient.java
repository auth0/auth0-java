...
public class AsyncRawIdentitiesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawIdentitiesClient(ClientOptions clientOptions) {
     ...
     * <ul>
     * <li>
     * <p>With the authenticated primary account's JWT in the Authorization header, which has the <code>update:current_user_identities</code> scope:</p>
     * <pre><code class="language-http">POST /api/v2/users/PRIMARY_ACCOUNT_USER_ID/identities
     * Authorization: &quot;Bearer PRIMARY_ACCOUNT_JWT&quot;
     * {
     *   &quot;link_with&quot;: &quot;SECONDARY_ACCOUNT_JWT&quot;
     * }
     * </code></pre>
     * <p>In this case, only the <code>link_with</code> param is required in the body, which also contains the JWT obtained upon the secondary account's authentication.</p>
     * </li>
     * <li>
     * <p>With a token generated by the API V2 containing the <code>update:users</code> scope:</p>
     * <pre><code class="language-http">POST /api/v2/users/PRIMARY_ACCOUNT_USER_ID/identities
     ...
     * }
     * </code></pre>
     * <p>In this case you need to send <code>provider</code> and <code>user_id</code> in the body. Optionally you can also send the <code>connection_id</code> param which is suitable for identifying a particular database connection for the 'auth0' provider.</p>
     * </li>
     * </ul>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(String id) {
     ...
     * </ul>
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(
            String id, LinkUserIdentityRequestContent request) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> link(
        ...
        CompletableFuture<ManagementApiHttpResponse<List<UserIdentity>>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<List<DeleteUserIdentityResponseContentItem>>> delete(
    ...
    public CompletableFuture<ManagementApiHttpResponse<List<DeleteUserIdentityResponseContentItem>>> delete(
        ...
        CompletableFuture<ManagementApiHttpResponse<List<DeleteUserIdentityResponseContentItem>>> future =
