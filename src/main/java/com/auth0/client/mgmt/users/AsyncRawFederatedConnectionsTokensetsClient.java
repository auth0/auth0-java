...
public class AsyncRawFederatedConnectionsTokensetsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawFederatedConnectionsTokensetsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<List<FederatedConnectionTokenSet>>> list(String id) {
        return list(id, null);
    }
     ...
     * List active federated connections tokensets for a provided user
     */
    public CompletableFuture<ManagementApiHttpResponse<List<FederatedConnectionTokenSet>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<List<FederatedConnectionTokenSet>>> future =
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> delete(String id, String tokensetId) {
        return delete(id, tokensetId, null);
    }

    public CompletableFuture<ManagementApiHttpResponse<Void>> delete(
            String id, String tokensetId, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users")
                .addPathSegment(id)
