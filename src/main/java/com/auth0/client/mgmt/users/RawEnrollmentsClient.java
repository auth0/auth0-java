...
public class RawEnrollmentsClient {
     ...
     */
    public ManagementApiHttpResponse<List<UsersEnrollment>> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieve the first <a href="https://auth0.com/docs/secure/multi-factor-authentication/multi-factor-authentication-factors">multi-factor authentication</a> enrollment that a specific user has confirmed.
     */
    public ManagementApiHttpResponse<List<UsersEnrollment>> get(String id, RequestOptions requestOptions) {
