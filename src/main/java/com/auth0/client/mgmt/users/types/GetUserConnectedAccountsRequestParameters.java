...
@JsonDeserialize(builder = GetUserConnectedAccountsRequestParameters.Builder.class)
public final class GetUserConnectedAccountsRequestParameters {
    ...
    /**
     * @return Number of results to return.  Defaults to 10 with a maximum of 20
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("take")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetUserConnectedAccountsRequestParameters
                && equalTo((GetUserConnectedAccountsRequestParameters) other);
    }
    ...
    private boolean equalTo(GetUserConnectedAccountsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetUserConnectedAccountsRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        public GetUserConnectedAccountsRequestParameters build() {
            return new GetUserConnectedAccountsRequestParameters(from, take, additionalProperties);
        }
    }
}
