...
@JsonDeserialize(builder = ListUserOrganizationsRequestParameters.Builder.class)
public final class ListUserOrganizationsRequestParameters {
    ...
    private ListUserOrganizationsRequestParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUserOrganizationsRequestParameters
                && equalTo((ListUserOrganizationsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListUserOrganizationsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUserOrganizationsRequestParameters other) {
            page(other.getPage());
