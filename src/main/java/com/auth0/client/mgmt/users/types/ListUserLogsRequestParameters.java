...
public final class ListUserLogsRequestParameters {
    ...
    private ListUserLogsRequestParameters(
    ...
    /**
     * @return Field to sort by. Use <code>fieldname:1</code> for ascending order and <code>fieldname:-1</code> for descending.
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("sort")
    ...
    private boolean equalTo(ListUserLogsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUserLogsRequestParameters other) {
            page(other.getPage());
        ...
        public ListUserLogsRequestParameters build() {
            return new ListUserLogsRequestParameters(page, perPage, sort, includeTotals, additionalProperties);
        }
    }
}
