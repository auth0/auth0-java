...
public class AsyncRawPermissionsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserPermissionSchema>>> list(String id) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserPermissionSchema>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserPermissionSchema>>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListUserPermissionsOffsetPaginatedResponseContent parsedResponse =
                        ...
                        int newPageNumber = request.getPage()
                                ...
                                .orElse(1);
                        ListUserPermissionsRequestParameters nextRequest =
                        ...
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<UserPermissionSchema>(true, result, parsedResponse, () -> {
                                    try {
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> create(
            String id, CreateUserPermissionsRequestContent request) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> delete(
            String id, DeleteUserPermissionsRequestContent request) {
