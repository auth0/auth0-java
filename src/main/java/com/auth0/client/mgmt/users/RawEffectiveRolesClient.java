...
public class RawEffectiveRolesClient {
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>> list(String id) {
     ...
     * Retrieve detailed list of effective roles for a user, including roles assigned directly and through group memberships.
     */
    public ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>> list(
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                ListUserEffectiveRolesRequestParameters nextRequest = ListUserEffectiveRolesRequestParameters.builder()
                        .from(request)
                        .from(startingAfter)
                        .build();
