...
@JsonDeserialize(builder = ListUserRolesRequestParameters.Builder.class)
public final class ListUserRolesRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUserRolesRequestParameters && equalTo((ListUserRolesRequestParameters) other);
    }
    ...
    private boolean equalTo(ListUserRolesRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUserRolesRequestParameters other) {
        ...
        public ListUserRolesRequestParameters build() {
            return new ListUserRolesRequestParameters(perPage, page, includeTotals, additionalProperties);
        }
    }
}
