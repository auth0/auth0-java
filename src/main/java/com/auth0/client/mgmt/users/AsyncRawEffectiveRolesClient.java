...
public class AsyncRawEffectiveRolesClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>>> list(String id) {
        return list(id, ListUserEffectiveRolesRequestParameters.builder().build());
    }

    /**
     * Retrieve detailed list of effective roles for a user, including roles assigned directly and through group memberships.
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>>> list(
            String id, RequestOptions requestOptions) {
        return list(id, ListUserEffectiveRolesRequestParameters.builder().build(), requestOptions);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectiveRole>>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListUserEffectiveRolesResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListUserEffectiveRolesResponseContent.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        ListUserEffectiveRolesRequestParameters nextRequest =
                                ListUserEffectiveRolesRequestParameters.builder()
                                        .from(request)
                                        .from(startingAfter)
                                        .build();
                        List<UserEffectiveRole> result = parsedResponse.getRoles();
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<UserEffectiveRole>(
