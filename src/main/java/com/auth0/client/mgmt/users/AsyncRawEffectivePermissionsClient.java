...
import com.auth0.client.mgmt.types.ListUserEffectivePermissionsResponseContent;
...
public class AsyncRawEffectivePermissionsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawEffectivePermissionsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectivePermissionResponseContent>>>
            list(String id, ListUserEffectivePermissionsRequestParameters request) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectivePermissionResponseContent>>>
            list(String id, ListUserEffectivePermissionsRequestParameters request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("users")
                .addPathSegment(id)
                .addPathSegments("effective-permissions");
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<UserEffectivePermissionResponseContent>>>
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListUserEffectivePermissionsResponseContent parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ListUserEffectivePermissionsResponseContent.class);
                        Optional<String> startingAfter = parsedResponse.getNext();
                        ListUserEffectivePermissionsRequestParameters nextRequest =
                                ListUserEffectivePermissionsRequestParameters.builder()
                                        .from(request)
                                        .from(startingAfter)
                                        .build();
                        List<UserEffectivePermissionResponseContent> result = parsedResponse.getPermissions();
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<UserEffectivePermissionResponseContent>(
