...
public class AsyncRawExperimentsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<AdvanceRampResponseContent>> advanceRamp(
    ...
    public CompletableFuture<ManagementApiHttpResponse<AdvanceRampResponseContent>> advanceRamp(
        ...
        CompletableFuture<ManagementApiHttpResponse<AdvanceRampResponseContent>> future = new CompletableFuture<>();
