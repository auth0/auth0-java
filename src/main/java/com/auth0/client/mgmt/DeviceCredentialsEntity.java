...
public class DeviceCredentialsEntity extends BaseManagementEntity {
    ...
    public Request<List<DeviceCredentials>> list(DeviceCredentialsFilter filter) {
        ...
        ExtendedBaseRequest<List<DeviceCredentials>> request = new ExtendedBaseRequest<>(client, url, HttpMethod.GET, new TypeReference<List<DeviceCredentials>>() {
        });
    ...
    public Request<DeviceCredentials> create(DeviceCredentials deviceCredentials) {
        ...
        String url = baseUrl
                ...
                .build()
                .toString();
        ExtendedBaseRequest<DeviceCredentials> request = new ExtendedBaseRequest<>(this.client, url, HttpMethod.POST, new TypeReference<DeviceCredentials>() {
        });
        request.addHeader("Authorization", "Bearer " + apiToken);
