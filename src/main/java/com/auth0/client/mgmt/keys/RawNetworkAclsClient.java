...
public class RawNetworkAclsClient {
     ...
     */
    public ManagementApiHttpResponse<GetAllKeysNetworkAclsResponseContent> list() {
        return list(null);
    }
     ...
     * Retrieve all keys used to verify HTTP Message Signatures on Network ACL rules, ordered by creation time descending.
     */
    public ManagementApiHttpResponse<GetAllKeysNetworkAclsResponseContent> list(RequestOptions requestOptions) {
     ...
     */
    public ManagementApiHttpResponse<CreateKeysNetworkAclsResponseContent> create(
     ...
     */
    public ManagementApiHttpResponse<NetworkAclKey> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieve a specific key used to verify HTTP Message Signatures on Network ACL rules.
     */
    public ManagementApiHttpResponse<NetworkAclKey> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("keys/network-acls")
                .addPathSegment(id);
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ManagementApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, NetworkAclKey.class), response);
            }
            try {
                switch (response.code()) {
                    case 400:
