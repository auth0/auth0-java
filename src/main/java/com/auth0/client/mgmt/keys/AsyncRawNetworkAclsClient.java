...
public class AsyncRawNetworkAclsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<GetAllKeysNetworkAclsResponseContent>> list() {
        return list(null);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetAllKeysNetworkAclsResponseContent>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetAllKeysNetworkAclsResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetAllKeysNetworkAclsResponseContent.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<CreateKeysNetworkAclsResponseContent>> create(
    ...
    public CompletableFuture<ManagementApiHttpResponse<CreateKeysNetworkAclsResponseContent>> create(
        ...
        CompletableFuture<ManagementApiHttpResponse<CreateKeysNetworkAclsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateKeysNetworkAclsResponseContent.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<NetworkAclKey>> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieve a specific key used to verify HTTP Message Signatures on Network ACL rules.
     */
    public CompletableFuture<ManagementApiHttpResponse<NetworkAclKey>> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("keys/network-acls")
                .addPathSegment(id);
        ...
        CompletableFuture<ManagementApiHttpResponse<NetworkAclKey>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, NetworkAclKey.class),
                                response));
                        return;
                    }
                    try {
