...
public class RawJobsClient {
     ...
     */
    public ManagementApiHttpResponse<GetJobResponseContent> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieves a job. Useful to check its status.
     */
    public ManagementApiHttpResponse<GetJobResponseContent> get(String id, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ManagementApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetJobResponseContent.class), response);
            }
            try {
