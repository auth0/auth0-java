...
public class AsyncRawEventStreamsClient {
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetEventStreamStatsResponseContent>> getStats(String id) {
        return getStats(id, EventStreamsGetStatsRequest.builder().build());
    }

    public CompletableFuture<ManagementApiHttpResponse<GetEventStreamStatsResponseContent>> getStats(
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetEventStreamStatsResponseContent>> getStats(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetEventStreamStatsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
