...
public class AsyncRawSupplementalSignalsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSupplementalSignalsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<GetSupplementalSignalsResponseContent>> get() {
        return get(null);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetSupplementalSignalsResponseContent>> get(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("supplemental-signals")
                .build();
        ...
        CompletableFuture<ManagementApiHttpResponse<GetSupplementalSignalsResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetSupplementalSignalsResponseContent.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<PatchSupplementalSignalsResponseContent>> patch(
    ...
    public CompletableFuture<ManagementApiHttpResponse<PatchSupplementalSignalsResponseContent>> patch(
        ...
        CompletableFuture<ManagementApiHttpResponse<PatchSupplementalSignalsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, PatchSupplementalSignalsResponseContent.class),
                                response));
                        return;
                    }
                    try {
