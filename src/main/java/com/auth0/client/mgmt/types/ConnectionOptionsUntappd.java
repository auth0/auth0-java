...
@JsonDeserialize(builder = ConnectionOptionsUntappd.Builder.class)
public final class ConnectionOptionsUntappd implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsUntappd(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsUntappd && equalTo((ConnectionOptionsUntappd) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsUntappd other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsUntappd other) {
        ...
        public ConnectionOptionsUntappd build() {
            return new ConnectionOptionsUntappd(
                    clientId,
                    clientSecret,
                    upstreamParams,
