...
@JsonDeserialize(builder = CreateConnectionRequestContentLine.Builder.class)
public final class CreateConnectionRequestContentLine implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentLineStrategy strategy;

    private final Optional<ConnectionOptionsLine> options;
    ...
    private CreateConnectionRequestContentLine(
            ...
            CreateConnectionRequestContentLineStrategy strategy,
            Optional<ConnectionOptionsLine> options,
    ...
    public CreateConnectionRequestContentLineStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsLine> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentLine
                && equalTo((CreateConnectionRequestContentLine) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentLine other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentLineStrategy strategy);

        Builder from(CreateConnectionRequestContentLine other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentLine build();
        ...
        _FinalStage options(Optional<ConnectionOptionsLine> options);

        _FinalStage options(ConnectionOptionsLine options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentLineStrategy strategy;

        private Optional<ConnectionOptionsLine> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentLine other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentLineStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsLine options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsLine> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentLine build() {
            return new CreateConnectionRequestContentLine(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
