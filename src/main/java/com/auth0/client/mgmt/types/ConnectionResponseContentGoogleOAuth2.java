...
@JsonDeserialize(builder = ConnectionResponseContentGoogleOAuth2.Builder.class)
public final class ConnectionResponseContentGoogleOAuth2
    ...
    private final ConnectionResponseContentGoogleOAuth2Strategy strategy;
    ...
    private ConnectionResponseContentGoogleOAuth2(
            ...
            ConnectionResponseContentGoogleOAuth2Strategy strategy,
    ...
    public ConnectionResponseContentGoogleOAuth2Strategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentGoogleOAuth2
                && equalTo((ConnectionResponseContentGoogleOAuth2) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentGoogleOAuth2 other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentGoogleOAuth2Strategy strategy);

        Builder from(ConnectionResponseContentGoogleOAuth2 other);
    }

    public interface _FinalStage {
        ConnectionResponseContentGoogleOAuth2 build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentGoogleOAuth2Strategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentGoogleOAuth2 other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentGoogleOAuth2Strategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentGoogleOAuth2 build() {
            return new ConnectionResponseContentGoogleOAuth2(
                    id,
                    realms,
                    name,
                    authentication,
