...
public final class EventStreamCloudEventConnectionUpdatedPreviousObject1OptionsTokenEndpointAuthMethodEnum {
    ...
    public static EventStreamCloudEventConnectionUpdatedPreviousObject1OptionsTokenEndpointAuthMethodEnum valueOf(
            String value) {
        switch (value) {
            case "private_key_jwt":
