...
@JsonDeserialize(builder = UpdateConnectionRequestContentWindowsLive.Builder.class)
public final class UpdateConnectionRequestContentWindowsLive implements IConnectionCommon, IConnectionPurposes {
    ...
    private UpdateConnectionRequestContentWindowsLive(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentWindowsLive
                && equalTo((UpdateConnectionRequestContentWindowsLive) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentWindowsLive other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentWindowsLive other) {
        ...
        public UpdateConnectionRequestContentWindowsLive build() {
            return new UpdateConnectionRequestContentWindowsLive(
                    displayName,
                    enabledClients,
                    isDomainConnection,
                    metadata,
