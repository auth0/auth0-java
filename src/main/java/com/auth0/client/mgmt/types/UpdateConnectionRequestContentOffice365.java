...
@JsonDeserialize(builder = UpdateConnectionRequestContentOffice365.Builder.class)
public final class UpdateConnectionRequestContentOffice365 implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentOffice365
                && equalTo((UpdateConnectionRequestContentOffice365) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentOffice365 other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentOffice365 other) {
        ...
        public UpdateConnectionRequestContentOffice365 build() {
            return new UpdateConnectionRequestContentOffice365(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
