...
public final class UnauthorizedSchema {
    ...
    private UnauthorizedSchema(
            String message,
            String statusCode,
            UnauthorizedSchemaError error,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UnauthorizedSchema && equalTo((UnauthorizedSchema) other);
    }
    ...
    public static final class Builder implements MessageStage, StatusCodeStage, ErrorStage, _FinalStage {
        ...
        public UnauthorizedSchema build() {
            return new UnauthorizedSchema(message, statusCode, error, additionalProperties);
        }
