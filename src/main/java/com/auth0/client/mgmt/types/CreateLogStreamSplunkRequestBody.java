...
@JsonDeserialize(builder = CreateLogStreamSplunkRequestBody.Builder.class)
public final class CreateLogStreamSplunkRequestBody {
    private final Optional<String> name;

    private final LogStreamSplunkEnum type;
    ...
    @JsonProperty("type")
    public LogStreamSplunkEnum getType() {
        return type;
    }
    ...
    @JsonProperty("sink")
    public LogStreamSplunkSink getSink() {
        return sink;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateLogStreamSplunkRequestBody && equalTo((CreateLogStreamSplunkRequestBody) other);
    }
    ...
    private boolean equalTo(CreateLogStreamSplunkRequestBody other) {
    ...
    public interface TypeStage {
        SinkStage type(@NotNull LogStreamSplunkEnum type);

        Builder from(CreateLogStreamSplunkRequestBody other);
    }

    public interface SinkStage {
        _FinalStage sink(@NotNull LogStreamSplunkSink sink);
    }

    public interface _FinalStage {
        CreateLogStreamSplunkRequestBody build();
    ...
    public static final class Builder implements TypeStage, SinkStage, _FinalStage {
        private LogStreamSplunkEnum type;

        private LogStreamSplunkSink sink;
        ...
        @java.lang.Override
        public Builder from(CreateLogStreamSplunkRequestBody other) {
            name(other.getName());
            type(other.getType());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public SinkStage type(@NotNull LogStreamSplunkEnum type) {
        ...
        @java.lang.Override
        @JsonSetter("sink")
        public _FinalStage sink(@NotNull LogStreamSplunkSink sink) {
        ...
        @java.lang.Override
        public CreateLogStreamSplunkRequestBody build() {
            return new CreateLogStreamSplunkRequestBody(
