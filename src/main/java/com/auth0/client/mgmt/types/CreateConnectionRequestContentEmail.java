...
@JsonDeserialize(builder = CreateConnectionRequestContentEmail.Builder.class)
public final class CreateConnectionRequestContentEmail implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentEmailStrategy strategy;
    ...
    private CreateConnectionRequestContentEmail(
            ...
            CreateConnectionRequestContentEmailStrategy strategy,
    ...
    public CreateConnectionRequestContentEmailStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentEmail
                && equalTo((CreateConnectionRequestContentEmail) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentEmail other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentEmailStrategy strategy);

        Builder from(CreateConnectionRequestContentEmail other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentEmail build();
        ...
        _FinalStage options(Optional<ConnectionOptionsEmail> options);

        _FinalStage options(ConnectionOptionsEmail options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentEmailStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentEmail other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentEmailStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsEmail options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsEmail> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentEmail build() {
            return new CreateConnectionRequestContentEmail(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
