...
@JsonDeserialize(builder = ConnectionResponseContentSalesforce.Builder.class)
public final class ConnectionResponseContentSalesforce
    ...
    private final ConnectionResponseContentSalesforceStrategy strategy;

    private final Optional<ConnectionOptionsSalesforce> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentSalesforce(
            Optional<String> id,
            ...
            ConnectionResponseContentSalesforceStrategy strategy,
    ...
    public ConnectionResponseContentSalesforceStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentSalesforce
                && equalTo((ConnectionResponseContentSalesforce) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentSalesforce other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentSalesforceStrategy strategy);

        Builder from(ConnectionResponseContentSalesforce other);
    }
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentSalesforceStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentSalesforce other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentSalesforceStrategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentSalesforce build() {
            return new ConnectionResponseContentSalesforce(
                    id,
                    realms,
                    name,
                    authentication,
