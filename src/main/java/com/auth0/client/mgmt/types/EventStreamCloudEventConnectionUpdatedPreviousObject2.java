...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedPreviousObject2.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject2 {
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedPreviousObject2(
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication> authentication,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject2
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject2) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedPreviousObject2 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject2 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedPreviousObject2 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject2Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject2 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject2Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedPreviousObject2 build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject2(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
