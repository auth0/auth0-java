...
@JsonDeserialize(builder = ConnectionResponseContentSoundcloud.Builder.class)
public final class ConnectionResponseContentSoundcloud
    ...
    private final ConnectionResponseContentSoundcloudStrategy strategy;

    private final Optional<ConnectionOptionsSoundcloud> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentSoundcloud(
            Optional<String> id,
            ...
            ConnectionResponseContentSoundcloudStrategy strategy,
    ...
    public ConnectionResponseContentSoundcloudStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentSoundcloud
                && equalTo((ConnectionResponseContentSoundcloud) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentSoundcloud other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentSoundcloudStrategy strategy);

        Builder from(ConnectionResponseContentSoundcloud other);
    }

    public interface _FinalStage {
        ConnectionResponseContentSoundcloud build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentSoundcloudStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentSoundcloud other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentSoundcloudStrategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentSoundcloud build() {
            return new ConnectionResponseContentSoundcloud(
                    id,
                    realms,
                    name,
                    authentication,
