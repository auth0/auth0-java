...
@JsonDeserialize(builder = ListNetworkAclsRequestParameters.Builder.class)
public final class ListNetworkAclsRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListNetworkAclsRequestParameters && equalTo((ListNetworkAclsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListNetworkAclsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListNetworkAclsRequestParameters other) {
            page(other.getPage());
        ...
        /**
         * <p>The amount of results per page.</p>
         */
        ...
        public ListNetworkAclsRequestParameters build() {
            return new ListNetworkAclsRequestParameters(page, perPage, includeTotals, additionalProperties);
        }
