...
@JsonDeserialize(builder = UpdateConnectionRequestContentSalesforce.Builder.class)
public final class UpdateConnectionRequestContentSalesforce implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSalesforce(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentSalesforce
                && equalTo((UpdateConnectionRequestContentSalesforce) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentSalesforce other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentSalesforce other) {
        ...
        public UpdateConnectionRequestContentSalesforce build() {
            return new UpdateConnectionRequestContentSalesforce(
