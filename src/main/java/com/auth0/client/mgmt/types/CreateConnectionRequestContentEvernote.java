...
@JsonDeserialize(builder = CreateConnectionRequestContentEvernote.Builder.class)
public final class CreateConnectionRequestContentEvernote implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentEvernoteStrategy strategy;

    private final Optional<ConnectionOptionsEvernote> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentEvernote(
            ...
            CreateConnectionRequestContentEvernoteStrategy strategy,
            Optional<ConnectionOptionsEvernote> options,
    ...
    public CreateConnectionRequestContentEvernoteStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsEvernote> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentEvernote
                && equalTo((CreateConnectionRequestContentEvernote) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentEvernote other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentEvernoteStrategy strategy);

        Builder from(CreateConnectionRequestContentEvernote other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentEvernote build();
        ...
        _FinalStage options(Optional<ConnectionOptionsEvernote> options);

        _FinalStage options(ConnectionOptionsEvernote options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentEvernoteStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentEvernote other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentEvernoteStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsEvernote options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsEvernote> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentEvernote build() {
            return new CreateConnectionRequestContentEvernote(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
