...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject0.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject0 {
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Authentication> authentication;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts> connectedAccounts;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedPreviousObject0(
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Authentication> authentication,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts> connectedAccounts,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Authentication> getAuthentication() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts> getConnectedAccounts() {
        return connectedAccounts;
    }

    @JsonProperty("options")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject0
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject0) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject0 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject0 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum strategy);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedPreviousObject0Authentication authentication);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject0Metadata metadata);
        ...
        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts connectedAccounts);

        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject0Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> options = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject0 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject0Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject0Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject0Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionDeletedPreviousObject0Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject0 build() {
