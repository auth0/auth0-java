...
public final class EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSetUserRootAttributesEnum {
    ...
    EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSetUserRootAttributesEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public static EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSetUserRootAttributesEnum valueOf(
            String value) {
        switch (value) {
            case "never_on_login":
