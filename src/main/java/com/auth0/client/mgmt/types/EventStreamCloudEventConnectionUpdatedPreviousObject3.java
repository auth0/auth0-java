...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedPreviousObject3.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject3 {
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedPreviousObject3(
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication> authentication,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject3
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject3) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedPreviousObject3 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject3 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedPreviousObject3 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject3Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject3 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionUpdatedPreviousObject3StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject3Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject3Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionUpdatedPreviousObject3Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedPreviousObject3 build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject3(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
