...
@JsonDeserialize(builder = UpdateConnectionRequestContentYandex.Builder.class)
public final class UpdateConnectionRequestContentYandex implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentYandex(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentYandex
                && equalTo((UpdateConnectionRequestContentYandex) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentYandex other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentYandex other) {
        ...
        public Builder options(Optional<ConnectionOptionsYandex> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsYandex options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentYandex build() {
            return new UpdateConnectionRequestContentYandex(
