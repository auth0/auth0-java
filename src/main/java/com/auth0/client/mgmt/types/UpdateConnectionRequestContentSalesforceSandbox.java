...
@JsonDeserialize(builder = UpdateConnectionRequestContentSalesforceSandbox.Builder.class)
public final class UpdateConnectionRequestContentSalesforceSandbox implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSalesforceSandbox(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentSalesforceSandbox
                && equalTo((UpdateConnectionRequestContentSalesforceSandbox) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentSalesforceSandbox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentSalesforceSandbox other) {
        ...
        public UpdateConnectionRequestContentSalesforceSandbox build() {
            return new UpdateConnectionRequestContentSalesforceSandbox(
