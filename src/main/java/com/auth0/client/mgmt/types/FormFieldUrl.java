...
@JsonDeserialize(builder = FormFieldUrl.Builder.class)
public final class FormFieldUrl {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeUrlConst type;

    private final Optional<FormFieldUrlConfig> config;
    ...
    private FormFieldUrl(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypeUrlConst type,
            Optional<FormFieldUrlConfig> config,
    ...
    @JsonProperty("type")
    public FormFieldTypeUrlConst getType() {
        return type;
    }

    @JsonProperty("config")
    public Optional<FormFieldUrlConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldUrl && equalTo((FormFieldUrl) other);
    }
    ...
    private boolean equalTo(FormFieldUrl other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldUrl other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull FormFieldTypeUrlConst type);
    }
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private FormFieldTypeUrlConst type;
        ...
        private Optional<FormFieldUrlConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldUrl other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull FormFieldTypeUrlConst type) {
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldUrlConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldUrlConfig> config) {
            this.config = config;
            return this;
        }
