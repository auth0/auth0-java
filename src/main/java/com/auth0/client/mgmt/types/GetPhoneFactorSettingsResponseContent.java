...
@JsonDeserialize(builder = GetPhoneFactorSettingsResponseContent.Builder.class)
public final class GetPhoneFactorSettingsResponseContent {
    ...
    private GetPhoneFactorSettingsResponseContent(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetPhoneFactorSettingsResponseContent
                && equalTo((GetPhoneFactorSettingsResponseContent) other);
    }
    ...
    private boolean equalTo(GetPhoneFactorSettingsResponseContent other) {
    ...
    public interface OtpLengthStage {
        ...
        Builder from(GetPhoneFactorSettingsResponseContent other);
    }
    ...
    public interface _FinalStage {
        GetPhoneFactorSettingsResponseContent build();
    ...
    public static final class Builder implements OtpLengthStage, OtpExpirationTimeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetPhoneFactorSettingsResponseContent other) {
        ...
        @java.lang.Override
        public GetPhoneFactorSettingsResponseContent build() {
            return new GetPhoneFactorSettingsResponseContent(otpLength, otpExpirationTime, additionalProperties);
        }
