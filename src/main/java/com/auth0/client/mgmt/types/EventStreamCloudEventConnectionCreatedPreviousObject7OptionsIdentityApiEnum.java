...
public final class EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum {
    ...
    EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum valueOf(String value) {
        switch (value) {
