...
@JsonDeserialize(builder = UpdateConnectionRequestContentPaypal.Builder.class)
public final class UpdateConnectionRequestContentPaypal implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentPaypal(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentPaypal
                && equalTo((UpdateConnectionRequestContentPaypal) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentPaypal other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentPaypal other) {
        ...
        public UpdateConnectionRequestContentPaypal build() {
            return new UpdateConnectionRequestContentPaypal(
