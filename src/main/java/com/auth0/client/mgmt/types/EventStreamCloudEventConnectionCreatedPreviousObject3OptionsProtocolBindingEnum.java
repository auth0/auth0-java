...
public final class EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum
    ...
    EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum
                        && this.string.equals(
    ...
    public static EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum valueOf(
            String value) {
        switch (value) {
            ...
            default:
                return new EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum(
                        Value.UNKNOWN, value);
        }
    }
