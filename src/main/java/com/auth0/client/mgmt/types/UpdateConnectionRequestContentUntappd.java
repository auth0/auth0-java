...
@JsonDeserialize(builder = UpdateConnectionRequestContentUntappd.Builder.class)
public final class UpdateConnectionRequestContentUntappd implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentUntappd
                && equalTo((UpdateConnectionRequestContentUntappd) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentUntappd other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentUntappd other) {
        ...
        public Builder options(Optional<ConnectionOptionsUntappd> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsUntappd options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentUntappd build() {
