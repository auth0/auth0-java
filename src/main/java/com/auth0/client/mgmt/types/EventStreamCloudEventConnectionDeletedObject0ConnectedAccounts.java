...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts {
    ...
    private EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts
                && equalTo((EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts other) {
    ...
    public interface ActiveStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts build();
    ...
    public static final class Builder implements ActiveStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts build() {
            return new EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts(
