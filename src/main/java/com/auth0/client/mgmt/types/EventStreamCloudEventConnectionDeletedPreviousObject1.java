...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject1.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject1 {
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedPreviousObject1(
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Authentication> authentication,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject1
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject1) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject1 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject1 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedPreviousObject1 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedPreviousObject1Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject1Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject1Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject1ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject1 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionDeletedPreviousObject1StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject1Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject1Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject1Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionDeletedPreviousObject1Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject1 build() {
            return new EventStreamCloudEventConnectionDeletedPreviousObject1(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
