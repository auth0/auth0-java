...
public final class EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum
    ...
    EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum valueOf(String value) {
        switch (value) {
            ...
            default:
                return new EventStreamCloudEventConnectionUpdatedObject2OptionsProtocolBindingEnum(
                        Value.UNKNOWN, value);
        }
    }
