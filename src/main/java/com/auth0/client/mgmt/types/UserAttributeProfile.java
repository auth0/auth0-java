...
@JsonDeserialize(builder = UserAttributeProfile.Builder.class)
public final class UserAttributeProfile {
    ...
    private boolean equalTo(UserAttributeProfile other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UserAttributeProfile other) {
            id(other.getId());
            name(other.getName());
        ...
        public UserAttributeProfile build() {
            return new UserAttributeProfile(id, name, userId, userAttributes, additionalProperties);
        }
