...
@JsonDeserialize(builder = ConnectionResponseContentBitly.Builder.class)
public final class ConnectionResponseContentBitly
    ...
    private final ConnectionResponseContentBitlyStrategy strategy;
    ...
    private ConnectionResponseContentBitly(
            ...
            ConnectionResponseContentBitlyStrategy strategy,
    ...
    public ConnectionResponseContentBitlyStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentBitly && equalTo((ConnectionResponseContentBitly) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentBitly other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentBitlyStrategy strategy);

        Builder from(ConnectionResponseContentBitly other);
    }

    public interface _FinalStage {
        ConnectionResponseContentBitly build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentBitlyStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentBitly other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentBitlyStrategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentBitly build() {
            return new ConnectionResponseContentBitly(
                    authentication,
                    connectedAccounts,
                    id,
                    realms,
