...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedPreviousObject7Options.Builder.class)
public final class EventStreamCloudEventConnectionCreatedPreviousObject7Options {
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum> identityApi;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsSetUserRootAttributesEnum>
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum>
            useridAttribute;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol;
    ...
    private EventStreamCloudEventConnectionCreatedPreviousObject7Options(
            ...
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
                    federatedConnectionsAccessTokens,
            Optional<Boolean> granted,
            Optional<String> iconUrl,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum> identityApi,
            Optional<String> maxGroupsToRetrieve,
            Optional<List<String>> nonPersistentAttrs,
            Optional<List<String>> scope,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsSetUserRootAttributesEnum>
                    setUserRootAttributes,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
                    shouldTrustEmailVerifiedConnection,
            ...
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum> useridAttribute,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum> getIdentityApi() {
        return identityApi;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsSetUserRootAttributesEnum>
            getSetUserRootAttributes() {
        return setUserRootAttributes;
    }

    @JsonProperty("should_trust_email_verified_connection")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum>
            getUseridAttribute() {
        return useridAttribute;
    }

    @JsonProperty("waad_protocol")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum> getWaadProtocol() {
        return waadProtocol;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedPreviousObject7Options
                && equalTo((EventStreamCloudEventConnectionCreatedPreviousObject7Options) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedPreviousObject7Options other) {
    ...
    public interface ClientIdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedPreviousObject7Options other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedPreviousObject7Options build();
        ...
        _FinalStage identityApi(
                EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum identityApi);
        ...
        _FinalStage useridAttribute(
                Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum>
                        useridAttribute);

        _FinalStage useridAttribute(
                EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum useridAttribute);

        _FinalStage waadProtocol(
                Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol);

        _FinalStage waadProtocol(
                EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum waadProtocol);
    }
    ...
    public static final class Builder implements ClientIdStage, _FinalStage {
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum>
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsSetUserRootAttributesEnum>
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum> identityApi =
                Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedPreviousObject7Options other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedPreviousObject7Options build() {
