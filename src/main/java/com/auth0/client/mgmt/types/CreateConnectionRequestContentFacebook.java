...
@JsonDeserialize(builder = CreateConnectionRequestContentFacebook.Builder.class)
public final class CreateConnectionRequestContentFacebook implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentFacebookStrategy strategy;

    private final Optional<ConnectionOptionsFacebook> options;
    ...
    private CreateConnectionRequestContentFacebook(
            ...
            CreateConnectionRequestContentFacebookStrategy strategy,
            Optional<ConnectionOptionsFacebook> options,
    ...
    public CreateConnectionRequestContentFacebookStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsFacebook> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentFacebook
                && equalTo((CreateConnectionRequestContentFacebook) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentFacebook other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentFacebookStrategy strategy);

        Builder from(CreateConnectionRequestContentFacebook other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentFacebook build();
        ...
        _FinalStage options(Optional<ConnectionOptionsFacebook> options);

        _FinalStage options(ConnectionOptionsFacebook options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentFacebookStrategy strategy;

        private Optional<ConnectionOptionsFacebook> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentFacebook other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentFacebookStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsFacebook options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsFacebook> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentFacebook build() {
            return new CreateConnectionRequestContentFacebook(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
