...
@JsonDeserialize(builder = CreateFlowsVaultConnectionSlackWebhook.Builder.class)
public final class CreateFlowsVaultConnectionSlackWebhook {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateFlowsVaultConnectionSlackWebhook
                && equalTo((CreateFlowsVaultConnectionSlackWebhook) other);
    }
    ...
    private boolean equalTo(CreateFlowsVaultConnectionSlackWebhook other) {
    ...
    public interface NameStage {
        ...
        Builder from(CreateFlowsVaultConnectionSlackWebhook other);
    }
    ...
    public interface _FinalStage {
        CreateFlowsVaultConnectionSlackWebhook build();
    }
    ...
    public static final class Builder implements NameStage, AppIdStage, SetupStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateFlowsVaultConnectionSlackWebhook other) {
            name(other.getName());
        ...
        @java.lang.Override
        public CreateFlowsVaultConnectionSlackWebhook build() {
            return new CreateFlowsVaultConnectionSlackWebhook(name, appId, setup, additionalProperties);
        }
    }
}
