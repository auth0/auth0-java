...
@JsonDeserialize(builder = FormFieldPassword.Builder.class)
public final class FormFieldPassword {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypePasswordConst type;

    private final FormFieldPasswordConfig config;
    ...
    private FormFieldPassword(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypePasswordConst type,
    ...
    @JsonProperty("type")
    public FormFieldTypePasswordConst getType() {
        return type;
    }

    @JsonProperty("config")
    public FormFieldPasswordConfig getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldPassword && equalTo((FormFieldPassword) other);
    }
    ...
    private boolean equalTo(FormFieldPassword other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldPassword other);
    }
    ...
    public interface TypeStage {
        ConfigStage type(@NotNull FormFieldTypePasswordConst type);
    }

    public interface ConfigStage {
        _FinalStage config(@NotNull FormFieldPasswordConfig config);
    }

    public interface _FinalStage {
        FormFieldPassword build();
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, ConfigStage, _FinalStage {
        ...
        private FormFieldTypePasswordConst type;

        private FormFieldPasswordConfig config;
        ...
        @java.lang.Override
        public Builder from(FormFieldPassword other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public ConfigStage type(@NotNull FormFieldTypePasswordConst type) {
        ...
        @java.lang.Override
        @JsonSetter("config")
        public _FinalStage config(@NotNull FormFieldPasswordConfig config) {
        ...
        @java.lang.Override
        public FormFieldPassword build() {
