...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedPreviousObject4Options.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject4Options {
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsSetUserRootAttributesEnum>
    ...
    private EventStreamCloudEventConnectionUpdatedPreviousObject4Options(
            ...
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsSetUserRootAttributesEnum>
                    setUserRootAttributes,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsShouldTrustEmailVerifiedConnectionEnum>
                    shouldTrustEmailVerifiedConnection,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsSetUserRootAttributesEnum>
            getSetUserRootAttributes() {
        return setUserRootAttributes;
    }

    @JsonProperty("should_trust_email_verified_connection")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject4Options
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject4Options) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedPreviousObject4Options other) {
    ...
    public static final class Builder {
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject4OptionsSetUserRootAttributesEnum>
        ...
        public Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject4Options other) {
        ...
        public EventStreamCloudEventConnectionUpdatedPreviousObject4Options build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject4Options(
                    adfsServer,
