...
@JsonDeserialize(builder = ConnectionOptionsYammer.Builder.class)
public final class ConnectionOptionsYammer implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsYammer && equalTo((ConnectionOptionsYammer) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsYammer other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsYammer other) {
        ...
        public ConnectionOptionsYammer build() {
            return new ConnectionOptionsYammer(
                    clientId,
                    clientSecret,
                    scope,
