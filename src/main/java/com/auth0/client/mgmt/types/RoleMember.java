...
@JsonDeserialize(builder = RoleMember.Builder.class)
public final class RoleMember {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RoleMember && equalTo((RoleMember) other);
    }
    ...
    private boolean equalTo(RoleMember other) {
    ...
    public static final class Builder {
        ...
        public Builder from(RoleMember other) {
        ...
        public RoleMember build() {
            return new RoleMember(userId, picture, name, email, additionalProperties);
        }
