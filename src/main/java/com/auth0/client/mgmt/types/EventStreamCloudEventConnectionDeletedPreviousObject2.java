...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject2.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject2 {
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedPreviousObject2(
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Authentication> authentication,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject2
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject2) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject2 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject2 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedPreviousObject2 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedPreviousObject2Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject2Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject2Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject2 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject2Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject2Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject2Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionDeletedPreviousObject2Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject2 build() {
            return new EventStreamCloudEventConnectionDeletedPreviousObject2(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
