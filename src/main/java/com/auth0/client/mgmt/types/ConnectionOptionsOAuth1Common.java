...
@JsonDeserialize(builder = ConnectionOptionsOAuth1Common.Builder.class)
public final class ConnectionOptionsOAuth1Common implements IConnectionOptionsOAuth1Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsOAuth1Common && equalTo((ConnectionOptionsOAuth1Common) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsOAuth1Common other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsOAuth1Common other) {
        ...
        public ConnectionOptionsOAuth1Common build() {
            return new ConnectionOptionsOAuth1Common(
                    clientId,
                    clientSecret,
