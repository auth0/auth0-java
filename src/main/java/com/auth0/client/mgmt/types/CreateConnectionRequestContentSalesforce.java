...
@JsonDeserialize(builder = CreateConnectionRequestContentSalesforce.Builder.class)
public final class CreateConnectionRequestContentSalesforce implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentSalesforceStrategy strategy;

    private final Optional<ConnectionOptionsSalesforce> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentSalesforce(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentSalesforceStrategy strategy,
    ...
    public CreateConnectionRequestContentSalesforceStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentSalesforce
                && equalTo((CreateConnectionRequestContentSalesforce) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentSalesforce other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentSalesforceStrategy strategy);

        Builder from(CreateConnectionRequestContentSalesforce other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentSalesforce build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentSalesforceStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentSalesforce other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentSalesforceStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentSalesforce build() {
            return new CreateConnectionRequestContentSalesforce(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
