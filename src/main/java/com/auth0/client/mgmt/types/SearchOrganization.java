...
@JsonDeserialize(builder = SearchOrganization.Builder.class)
public final class SearchOrganization {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SearchOrganization && equalTo((SearchOrganization) other);
    }
    ...
    private boolean equalTo(SearchOrganization other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SearchOrganization other) {
            id(other.getId());
            name(other.getName());
