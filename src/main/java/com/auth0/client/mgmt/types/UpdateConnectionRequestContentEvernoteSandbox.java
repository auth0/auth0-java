...
@JsonDeserialize(builder = UpdateConnectionRequestContentEvernoteSandbox.Builder.class)
public final class UpdateConnectionRequestContentEvernoteSandbox implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentEvernoteSandbox
                && equalTo((UpdateConnectionRequestContentEvernoteSandbox) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentEvernoteSandbox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentEvernoteSandbox other) {
        ...
        public Builder options(Optional<ConnectionOptionsEvernote> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsEvernote options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentEvernoteSandbox build() {
            return new UpdateConnectionRequestContentEvernoteSandbox(
