...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedPreviousObject4.Builder.class)
public final class EventStreamCloudEventConnectionCreatedPreviousObject4 {
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionCreatedPreviousObject4(
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Authentication> authentication,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedPreviousObject4
                && equalTo((EventStreamCloudEventConnectionCreatedPreviousObject4) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedPreviousObject4 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedPreviousObject4 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedPreviousObject4 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionCreatedPreviousObject4Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject4Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> options);

        _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject4Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedPreviousObject4 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject4Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject4Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject4Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionCreatedPreviousObject4Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedPreviousObject4 build() {
            return new EventStreamCloudEventConnectionCreatedPreviousObject4(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
