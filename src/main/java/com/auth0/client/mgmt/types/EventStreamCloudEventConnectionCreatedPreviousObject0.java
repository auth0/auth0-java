...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedPreviousObject0.Builder.class)
public final class EventStreamCloudEventConnectionCreatedPreviousObject0 {
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Authentication> authentication;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts> connectedAccounts;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionCreatedPreviousObject0(
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Authentication> authentication,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts> connectedAccounts,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Authentication> getAuthentication() {
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts> getConnectedAccounts() {
        return connectedAccounts;
    }

    @JsonProperty("options")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedPreviousObject0
                && equalTo((EventStreamCloudEventConnectionCreatedPreviousObject0) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedPreviousObject0 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedPreviousObject0 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedPreviousObject0 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionCreatedPreviousObject0Authentication authentication);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject0Metadata metadata);
        ...
        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts connectedAccounts);

        _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> options);

        _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject0Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> options = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedPreviousObject0 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject0Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject0Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject0Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionCreatedPreviousObject0Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedPreviousObject0 build() {
            return new EventStreamCloudEventConnectionCreatedPreviousObject0(
                    authentication,
                    displayName,
                    enabledClients,
                    id,
