...
@JsonDeserialize(builder = ListConnectionsQueryParameters.Builder.class)
public final class ListConnectionsQueryParameters {
    ...
    /**
     * @return Provide the name of the connection to retrieve
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("name")
    ...
    public static final class Builder {
        ...
        /**
         * <p>Provide the name of the connection to retrieve</p>
         */
