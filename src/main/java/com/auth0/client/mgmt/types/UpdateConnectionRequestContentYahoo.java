...
@JsonDeserialize(builder = UpdateConnectionRequestContentYahoo.Builder.class)
public final class UpdateConnectionRequestContentYahoo implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentYahoo(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentYahoo
                && equalTo((UpdateConnectionRequestContentYahoo) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentYahoo other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentYahoo other) {
        ...
        public UpdateConnectionRequestContentYahoo build() {
            return new UpdateConnectionRequestContentYahoo(
