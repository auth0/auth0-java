...
@JsonDeserialize(builder = FormFieldChoice.Builder.class)
public final class FormFieldChoice {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeChoiceConst type;

    private final Optional<FormFieldChoiceConfig> config;
    ...
    private FormFieldChoice(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypeChoiceConst type,
            Optional<FormFieldChoiceConfig> config,
    ...
    @JsonProperty("type")
    public FormFieldTypeChoiceConst getType() {
        return type;
    }

    @JsonProperty("config")
    public Optional<FormFieldChoiceConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldChoice && equalTo((FormFieldChoice) other);
    }
    ...
    private boolean equalTo(FormFieldChoice other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldChoice other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull FormFieldTypeChoiceConst type);
    }

    public interface _FinalStage {
        FormFieldChoice build();

        _FinalStage additionalProperty(String key, Object value);

        _FinalStage additionalProperties(Map<String, Object> additionalProperties);

        _FinalStage config(Optional<FormFieldChoiceConfig> config);

        _FinalStage config(FormFieldChoiceConfig config);
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private FormFieldTypeChoiceConst type;
        ...
        private Optional<FormFieldChoiceConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldChoice other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull FormFieldTypeChoiceConst type) {
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldChoiceConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldChoiceConfig> config) {
            this.config = config;
            return this;
        }

        @java.lang.Override
        public FormFieldChoice build() {
