...
@JsonDeserialize(builder = CreateConnectionRequestContentAuth0Oidc.Builder.class)
public final class CreateConnectionRequestContentAuth0Oidc implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentAuth0OidcStrategy strategy;

    private final Optional<ConnectionOptionsAuth0Oidc> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentAuth0Oidc(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentAuth0OidcStrategy strategy,
            Optional<ConnectionOptionsAuth0Oidc> options,
    ...
    public CreateConnectionRequestContentAuth0OidcStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsAuth0Oidc> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentAuth0Oidc
                && equalTo((CreateConnectionRequestContentAuth0Oidc) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentAuth0Oidc other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentAuth0OidcStrategy strategy);

        Builder from(CreateConnectionRequestContentAuth0Oidc other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentAuth0Oidc build();
        ...
        _FinalStage options(Optional<ConnectionOptionsAuth0Oidc> options);

        _FinalStage options(ConnectionOptionsAuth0Oidc options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentAuth0OidcStrategy strategy;

        private Optional<ConnectionOptionsAuth0Oidc> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentAuth0Oidc other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentAuth0OidcStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsAuth0Oidc options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsAuth0Oidc> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentAuth0Oidc build() {
            return new CreateConnectionRequestContentAuth0Oidc(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
