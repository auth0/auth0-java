...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedPreviousObject7Options.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject7Options {
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum> identityApi;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsSetUserRootAttributesEnum>
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum>
            useridAttribute;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedPreviousObject7Options(
            ...
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
                    federatedConnectionsAccessTokens,
            Optional<Boolean> granted,
            Optional<String> iconUrl,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum> identityApi,
            Optional<String> maxGroupsToRetrieve,
            Optional<List<String>> nonPersistentAttrs,
            Optional<List<String>> scope,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsSetUserRootAttributesEnum>
                    setUserRootAttributes,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
                    shouldTrustEmailVerifiedConnection,
            ...
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum> useridAttribute,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum> getIdentityApi() {
        return identityApi;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsSetUserRootAttributesEnum>
            getSetUserRootAttributes() {
        return setUserRootAttributes;
    }

    @JsonProperty("should_trust_email_verified_connection")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum>
            getUseridAttribute() {
        return useridAttribute;
    }

    @JsonProperty("waad_protocol")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum> getWaadProtocol() {
        return waadProtocol;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject7Options
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject7Options) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedPreviousObject7Options other) {
    ...
    public interface ClientIdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject7Options other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedPreviousObject7Options build();
        ...
        _FinalStage identityApi(
                EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum identityApi);
        ...
        _FinalStage useridAttribute(
                Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum>
                        useridAttribute);

        _FinalStage useridAttribute(
                EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum useridAttribute);

        _FinalStage waadProtocol(
                Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol);

        _FinalStage waadProtocol(
                EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum waadProtocol);
    }
    ...
    public static final class Builder implements ClientIdStage, _FinalStage {
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum> waadProtocol =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum>
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsSetUserRootAttributesEnum>
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum> identityApi =
                Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsFederatedConnectionsAccessTokens>
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject7Options other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedPreviousObject7Options build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject7Options(
                    apiEnableUsers,
                    appDomain,
                    appId,
                    basicProfile,
