...
@JsonDeserialize(builder = ClientGrantResponseContent.Builder.class)
public final class ClientGrantResponseContent {
    ...
    private ClientGrantResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClientGrantResponseContent && equalTo((ClientGrantResponseContent) other);
    }
    ...
    private boolean equalTo(ClientGrantResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ClientGrantResponseContent other) {
            id(other.getId());
        ...
        public ClientGrantResponseContent build() {
            return new ClientGrantResponseContent(
                    id,
                    clientId,
                    audience,
                    scope,
