...
@JsonDeserialize(builder = CreateConnectionRequestContentApple.Builder.class)
public final class CreateConnectionRequestContentApple implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentAppleStrategy strategy;

    private final Optional<ConnectionOptionsApple> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentApple(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentAppleStrategy strategy,
            Optional<ConnectionOptionsApple> options,
    ...
    public CreateConnectionRequestContentAppleStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsApple> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentApple
                && equalTo((CreateConnectionRequestContentApple) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentApple other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentAppleStrategy strategy);

        Builder from(CreateConnectionRequestContentApple other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentApple build();
        ...
        _FinalStage options(Optional<ConnectionOptionsApple> options);

        _FinalStage options(ConnectionOptionsApple options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentAppleStrategy strategy;

        private Optional<ConnectionOptionsApple> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentApple other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentAppleStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsApple options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsApple> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentApple build() {
            return new CreateConnectionRequestContentApple(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
