...
@JsonDeserialize(builder = UpdateConnectionRequestContentOAuth1.Builder.class)
public final class UpdateConnectionRequestContentOAuth1 implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentOAuth1(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentOAuth1
                && equalTo((UpdateConnectionRequestContentOAuth1) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentOAuth1 other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentOAuth1 other) {
        ...
        public Builder options(Optional<ConnectionOptionsOAuth1> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsOAuth1 options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentOAuth1 build() {
            return new UpdateConnectionRequestContentOAuth1(
