...
@JsonDeserialize(builder = CreateConnectionRequestContentSms.Builder.class)
public final class CreateConnectionRequestContentSms implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentSmsStrategy strategy;

    private final Optional<ConnectionOptionsSms> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentSms(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentSmsStrategy strategy,
            Optional<ConnectionOptionsSms> options,
    ...
    public CreateConnectionRequestContentSmsStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsSms> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentSms && equalTo((CreateConnectionRequestContentSms) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentSms other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentSmsStrategy strategy);

        Builder from(CreateConnectionRequestContentSms other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentSms build();
        ...
        _FinalStage options(Optional<ConnectionOptionsSms> options);

        _FinalStage options(ConnectionOptionsSms options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentSmsStrategy strategy;

        private Optional<ConnectionOptionsSms> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentSms other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentSmsStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsSms options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsSms> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentSms build() {
            return new CreateConnectionRequestContentSms(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
