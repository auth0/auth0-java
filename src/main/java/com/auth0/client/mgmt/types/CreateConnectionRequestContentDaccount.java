...
@JsonDeserialize(builder = CreateConnectionRequestContentDaccount.Builder.class)
public final class CreateConnectionRequestContentDaccount implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentDaccountStrategy strategy;

    private final Optional<ConnectionOptionsDaccount> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentDaccount(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentDaccountStrategy strategy,
            Optional<ConnectionOptionsDaccount> options,
    ...
    public CreateConnectionRequestContentDaccountStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentDaccount
                && equalTo((CreateConnectionRequestContentDaccount) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentDaccount other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentDaccountStrategy strategy);

        Builder from(CreateConnectionRequestContentDaccount other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentDaccount build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentDaccountStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentDaccount other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentDaccountStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentDaccount build() {
            return new CreateConnectionRequestContentDaccount(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
