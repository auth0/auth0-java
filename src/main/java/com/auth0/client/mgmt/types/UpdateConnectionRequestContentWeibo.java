...
@JsonDeserialize(builder = UpdateConnectionRequestContentWeibo.Builder.class)
public final class UpdateConnectionRequestContentWeibo implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentWeibo(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentWeibo
                && equalTo((UpdateConnectionRequestContentWeibo) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentWeibo other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentWeibo other) {
        ...
        public Builder options(Optional<ConnectionOptionsWeibo> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsWeibo options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentWeibo build() {
            return new UpdateConnectionRequestContentWeibo(
