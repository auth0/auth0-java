...
@JsonDeserialize(builder = LogStreamDatadogResponseSchema.Builder.class)
public final class LogStreamDatadogResponseSchema {
    ...
    private final Optional<LogStreamDatadogEnum> type;
    ...
    private final Optional<LogStreamDatadogSink> sink;

    private final Map<String, Object> additionalProperties;

    private LogStreamDatadogResponseSchema(
            Optional<String> id,
            Optional<String> name,
            Optional<LogStreamStatusEnum> status,
            Optional<LogStreamDatadogEnum> type,
            Optional<Boolean> isPriority,
            Optional<List<LogStreamFilter>> filters,
            Optional<LogStreamPiiConfig> piiConfig,
            Optional<LogStreamDatadogSink> sink,
    ...
    @JsonProperty("type")
    public Optional<LogStreamDatadogEnum> getType() {
        return type;
    }
    ...
    @JsonProperty("sink")
    public Optional<LogStreamDatadogSink> getSink() {
        return sink;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LogStreamDatadogResponseSchema && equalTo((LogStreamDatadogResponseSchema) other);
    }
    ...
    private boolean equalTo(LogStreamDatadogResponseSchema other) {
    ...
    public static final class Builder {
        ...
        private Optional<LogStreamDatadogEnum> type = Optional.empty();
        ...
        private Optional<LogStreamDatadogSink> sink = Optional.empty();
        ...
        public Builder from(LogStreamDatadogResponseSchema other) {
            id(other.getId());
            name(other.getName());
        ...
        public Builder type(Optional<LogStreamDatadogEnum> type) {
            this.type = type;
            return this;
        }

        public Builder type(LogStreamDatadogEnum type) {
        ...
        public Builder sink(Optional<LogStreamDatadogSink> sink) {
            this.sink = sink;
            return this;
        }

        public Builder sink(LogStreamDatadogSink sink) {
            this.sink = Optional.ofNullable(sink);
            return this;
        }

        public LogStreamDatadogResponseSchema build() {
            return new LogStreamDatadogResponseSchema(
