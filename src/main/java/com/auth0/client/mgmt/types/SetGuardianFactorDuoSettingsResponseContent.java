...
@JsonDeserialize(builder = SetGuardianFactorDuoSettingsResponseContent.Builder.class)
public final class SetGuardianFactorDuoSettingsResponseContent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SetGuardianFactorDuoSettingsResponseContent
                && equalTo((SetGuardianFactorDuoSettingsResponseContent) other);
    }
    ...
    private boolean equalTo(SetGuardianFactorDuoSettingsResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SetGuardianFactorDuoSettingsResponseContent other) {
            ikey(other.getIkey());
            skey(other.getSkey());
            host(other.getHost());
            return this;
        ...
        public SetGuardianFactorDuoSettingsResponseContent build() {
            return new SetGuardianFactorDuoSettingsResponseContent(ikey, skey, host, additionalProperties);
        }
    }
}
