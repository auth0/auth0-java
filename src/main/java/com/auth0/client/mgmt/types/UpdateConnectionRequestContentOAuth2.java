...
@JsonDeserialize(builder = UpdateConnectionRequestContentOAuth2.Builder.class)
public final class UpdateConnectionRequestContentOAuth2 implements IConnectionCommon, IConnectionPurposes {
    ...
    private UpdateConnectionRequestContentOAuth2(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentOAuth2
                && equalTo((UpdateConnectionRequestContentOAuth2) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentOAuth2 other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentOAuth2 other) {
        ...
        public UpdateConnectionRequestContentOAuth2 build() {
            return new UpdateConnectionRequestContentOAuth2(
                    displayName,
                    enabledClients,
                    isDomainConnection,
                    metadata,
