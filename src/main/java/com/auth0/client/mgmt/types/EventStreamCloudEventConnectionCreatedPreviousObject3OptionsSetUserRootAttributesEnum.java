...
public final class EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSetUserRootAttributesEnum {
    ...
    EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSetUserRootAttributesEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public static EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSetUserRootAttributesEnum valueOf(
            String value) {
        switch (value) {
            case "never_on_login":
