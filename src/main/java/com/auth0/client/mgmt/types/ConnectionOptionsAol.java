...
@JsonDeserialize(builder = ConnectionOptionsAol.Builder.class)
public final class ConnectionOptionsAol implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsAol && equalTo((ConnectionOptionsAol) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsAol other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsAol other) {
        ...
        public ConnectionOptionsAol build() {
            return new ConnectionOptionsAol(
                    clientId,
                    clientSecret,
                    scope,
