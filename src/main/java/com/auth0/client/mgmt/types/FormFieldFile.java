...
@JsonDeserialize(builder = FormFieldFile.Builder.class)
public final class FormFieldFile {
    ...
    @JsonProperty("config")
    public Optional<FormFieldFileConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldFile && equalTo((FormFieldFile) other);
    }
    ...
    private boolean equalTo(FormFieldFile other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldFile other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage config(Optional<FormFieldFileConfig> config);

        _FinalStage config(FormFieldFileConfig config);
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private Optional<FormFieldFileConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldFile other) {
            id(other.getId());
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldFileConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldFileConfig> config) {
            this.config = config;
            return this;
        }

        @java.lang.Override
        public FormFieldFile build() {
            return new FormFieldFile(
