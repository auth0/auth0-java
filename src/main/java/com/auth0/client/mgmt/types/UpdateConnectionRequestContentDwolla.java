...
@JsonDeserialize(builder = UpdateConnectionRequestContentDwolla.Builder.class)
public final class UpdateConnectionRequestContentDwolla implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentDwolla
                && equalTo((UpdateConnectionRequestContentDwolla) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentDwolla other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentDwolla other) {
        ...
        public Builder options(Optional<ConnectionOptionsDwolla> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsDwolla options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentDwolla build() {
            return new UpdateConnectionRequestContentDwolla(
