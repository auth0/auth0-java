...
@JsonDeserialize(builder = ConnectionResponseContentEvernoteSandbox.Builder.class)
public final class ConnectionResponseContentEvernoteSandbox
    ...
    private final ConnectionResponseContentEvernoteSandboxStrategy strategy;
    ...
    private ConnectionResponseContentEvernoteSandbox(
            ...
            ConnectionResponseContentEvernoteSandboxStrategy strategy,
    ...
    public ConnectionResponseContentEvernoteSandboxStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentEvernoteSandbox
                && equalTo((ConnectionResponseContentEvernoteSandbox) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentEvernoteSandbox other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentEvernoteSandboxStrategy strategy);

        Builder from(ConnectionResponseContentEvernoteSandbox other);
    }
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentEvernoteSandboxStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentEvernoteSandbox other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentEvernoteSandboxStrategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentEvernoteSandbox build() {
            return new ConnectionResponseContentEvernoteSandbox(
                    id,
                    realms,
                    name,
                    authentication,
