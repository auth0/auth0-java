...
@JsonDeserialize(builder = UpdateConnectionRequestContentDropbox.Builder.class)
public final class UpdateConnectionRequestContentDropbox implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentDropbox(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentDropbox
                && equalTo((UpdateConnectionRequestContentDropbox) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentDropbox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentDropbox other) {
        ...
        public UpdateConnectionRequestContentDropbox build() {
            return new UpdateConnectionRequestContentDropbox(
