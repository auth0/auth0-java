...
@JsonDeserialize(builder = CreateConnectionRequestContentInstagram.Builder.class)
public final class CreateConnectionRequestContentInstagram implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentInstagramStrategy strategy;

    private final Optional<ConnectionOptionsInstagram> options;
    ...
    private CreateConnectionRequestContentInstagram(
            ...
            CreateConnectionRequestContentInstagramStrategy strategy,
            Optional<ConnectionOptionsInstagram> options,
    ...
    public CreateConnectionRequestContentInstagramStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsInstagram> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentInstagram
                && equalTo((CreateConnectionRequestContentInstagram) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentInstagram other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentInstagramStrategy strategy);

        Builder from(CreateConnectionRequestContentInstagram other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentInstagram build();
        ...
        _FinalStage options(Optional<ConnectionOptionsInstagram> options);

        _FinalStage options(ConnectionOptionsInstagram options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentInstagramStrategy strategy;

        private Optional<ConnectionOptionsInstagram> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentInstagram other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentInstagramStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsInstagram options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsInstagram> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentInstagram build() {
            return new CreateConnectionRequestContentInstagram(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
