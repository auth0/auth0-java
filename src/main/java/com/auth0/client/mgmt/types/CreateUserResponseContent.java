...
@JsonDeserialize(builder = CreateUserResponseContent.Builder.class)
public final class CreateUserResponseContent {
    ...
    private boolean equalTo(CreateUserResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateUserResponseContent other) {
        ...
        public CreateUserResponseContent build() {
            return new CreateUserResponseContent(
                    userId,
                    email,
                    emailVerified,
                    username,
