...
public final class EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum
    ...
    EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionCreatedObject2OptionsProtocolBindingEnum valueOf(String value) {
        switch (value) {
