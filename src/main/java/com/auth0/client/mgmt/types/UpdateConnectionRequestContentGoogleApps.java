...
@JsonDeserialize(builder = UpdateConnectionRequestContentGoogleApps.Builder.class)
public final class UpdateConnectionRequestContentGoogleApps implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentGoogleApps(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentGoogleApps
                && equalTo((UpdateConnectionRequestContentGoogleApps) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentGoogleApps other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentGoogleApps other) {
        ...
        public Builder options(Optional<ConnectionOptionsGoogleApps> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsGoogleApps options) {
        ...
        public UpdateConnectionRequestContentGoogleApps build() {
            return new UpdateConnectionRequestContentGoogleApps(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
