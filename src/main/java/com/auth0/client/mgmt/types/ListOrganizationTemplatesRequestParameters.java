...
@JsonDeserialize(builder = ListOrganizationTemplatesRequestParameters.Builder.class)
public final class ListOrganizationTemplatesRequestParameters {
    ...
    private ListOrganizationTemplatesRequestParameters(
    ...
    /**
     * @return Number of results per page. Defaults to 5. Values greater than 10 are capped at 10.
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("take")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrganizationTemplatesRequestParameters
                && equalTo((ListOrganizationTemplatesRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrganizationTemplatesRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListOrganizationTemplatesRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        /**
         * <p>Number of results per page. Defaults to 5. Values greater than 10 are capped at 10.</p>
         */
        ...
        public ListOrganizationTemplatesRequestParameters build() {
            return new ListOrganizationTemplatesRequestParameters(from, take, additionalProperties);
        }
