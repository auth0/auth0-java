...
@JsonDeserialize(builder = FormFieldLegal.Builder.class)
public final class FormFieldLegal {
    ...
    @JsonProperty("config")
    public Optional<FormFieldLegalConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldLegal && equalTo((FormFieldLegal) other);
    }
    ...
    private boolean equalTo(FormFieldLegal other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldLegal other);
    }
    ...
    public interface _FinalStage {
        FormFieldLegal build();

        _FinalStage additionalProperty(String key, Object value);

        _FinalStage additionalProperties(Map<String, Object> additionalProperties);

        _FinalStage config(Optional<FormFieldLegalConfig> config);

        _FinalStage config(FormFieldLegalConfig config);
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private Optional<FormFieldLegalConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldLegal other) {
            id(other.getId());
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldLegalConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldLegalConfig> config) {
            this.config = config;
            return this;
        }

        @java.lang.Override
        public FormFieldLegal build() {
            return new FormFieldLegal(
