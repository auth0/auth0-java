...
@JsonDeserialize(builder = CreateFlowsVaultConnectionAirtableApiKey.Builder.class)
public final class CreateFlowsVaultConnectionAirtableApiKey {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateFlowsVaultConnectionAirtableApiKey
                && equalTo((CreateFlowsVaultConnectionAirtableApiKey) other);
    }
    ...
    private boolean equalTo(CreateFlowsVaultConnectionAirtableApiKey other) {
    ...
    public interface NameStage {
        ...
        Builder from(CreateFlowsVaultConnectionAirtableApiKey other);
    }
    ...
    public interface _FinalStage {
        CreateFlowsVaultConnectionAirtableApiKey build();
    ...
    public static final class Builder implements NameStage, AppIdStage, SetupStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateFlowsVaultConnectionAirtableApiKey other) {
            name(other.getName());
        ...
        @java.lang.Override
        public CreateFlowsVaultConnectionAirtableApiKey build() {
            return new CreateFlowsVaultConnectionAirtableApiKey(name, appId, setup, additionalProperties);
        }
