...
@JsonDeserialize(builder = CreateConnectionRequestContentOkta.Builder.class)
public final class CreateConnectionRequestContentOkta implements ICreateConnectionCommon, IConnectionCommon {
    ...
    public CreateConnectionRequestContentOktaStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentOkta
                && equalTo((CreateConnectionRequestContentOkta) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentOkta other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentOktaStrategy strategy);

        Builder from(CreateConnectionRequestContentOkta other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentOkta build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentOktaStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentOkta other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentOktaStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentOkta build() {
            return new CreateConnectionRequestContentOkta(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
