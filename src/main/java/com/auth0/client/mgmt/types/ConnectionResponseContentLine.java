...
@JsonDeserialize(builder = ConnectionResponseContentLine.Builder.class)
public final class ConnectionResponseContentLine
    ...
    private final ConnectionResponseContentLineStrategy strategy;

    private final Optional<ConnectionOptionsLine> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentLine(
            Optional<String> id,
            ...
            ConnectionResponseContentLineStrategy strategy,
    ...
    public ConnectionResponseContentLineStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentLine && equalTo((ConnectionResponseContentLine) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentLine other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentLineStrategy strategy);

        Builder from(ConnectionResponseContentLine other);
    }

    public interface _FinalStage {
        ConnectionResponseContentLine build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentLineStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentLine other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentLineStrategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentLine build() {
            return new ConnectionResponseContentLine(
                    id,
                    realms,
                    name,
                    authentication,
