...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedObject6.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedObject6 {
    private final Optional<EventStreamCloudEventConnectionUpdatedObject6Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject6Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedObject6StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedObject6(
            Optional<EventStreamCloudEventConnectionUpdatedObject6Authentication> authentication,
            Optional<EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedObject6Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedObject6StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject6Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject6Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedObject6StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedObject6
                && equalTo((EventStreamCloudEventConnectionUpdatedObject6) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedObject6 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedObject6 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject6StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedObject6 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject6Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject6Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject6Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedObject6Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedObject6StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject6Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject6Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedObject6 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject6StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedObject6Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject6Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject6Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject6Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject6Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedObject6 build() {
            return new EventStreamCloudEventConnectionUpdatedObject6(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
