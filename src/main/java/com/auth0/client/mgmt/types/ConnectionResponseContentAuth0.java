...
@JsonDeserialize(builder = ConnectionResponseContentAuth0.Builder.class)
public final class ConnectionResponseContentAuth0
    ...
    private final ConnectionResponseContentAuth0Strategy strategy;

    private final Optional<ConnectionOptionsAuth0> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentAuth0(
            Optional<String> id,
            ...
            ConnectionResponseContentAuth0Strategy strategy,
    ...
    public ConnectionResponseContentAuth0Strategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentAuth0 && equalTo((ConnectionResponseContentAuth0) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentAuth0 other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentAuth0Strategy strategy);

        Builder from(ConnectionResponseContentAuth0 other);
    }

    public interface _FinalStage {
        ConnectionResponseContentAuth0 build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentAuth0Strategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentAuth0 other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentAuth0Strategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentAuth0 build() {
            return new ConnectionResponseContentAuth0(
                    id,
                    realms,
                    name,
                    authentication,
