...
@JsonDeserialize(builder = GetRiskAssessmentsSettingsNewDeviceResponseContent.Builder.class)
public final class GetRiskAssessmentsSettingsNewDeviceResponseContent {
    private final int rememberFor;

    private final Map<String, Object> additionalProperties;

    private GetRiskAssessmentsSettingsNewDeviceResponseContent(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetRiskAssessmentsSettingsNewDeviceResponseContent
                && equalTo((GetRiskAssessmentsSettingsNewDeviceResponseContent) other);
    }
    ...
    private boolean equalTo(GetRiskAssessmentsSettingsNewDeviceResponseContent other) {
    ...
    public interface RememberForStage {
        ...
        Builder from(GetRiskAssessmentsSettingsNewDeviceResponseContent other);
    }

    public interface _FinalStage {
        GetRiskAssessmentsSettingsNewDeviceResponseContent build();
