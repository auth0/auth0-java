...
@JsonDeserialize(builder = ResourceServerSearchResponse.Builder.class)
public final class ResourceServerSearchResponse {
    ...
    private ResourceServerSearchResponse(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ResourceServerSearchResponse && equalTo((ResourceServerSearchResponse) other);
    }
    ...
    private boolean equalTo(ResourceServerSearchResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ResourceServerSearchResponse other) {
            id(other.getId());
            name(other.getName());
        ...
        public ResourceServerSearchResponse build() {
            return new ResourceServerSearchResponse(
                    id,
                    name,
                    isSystem,
                    identifier,
