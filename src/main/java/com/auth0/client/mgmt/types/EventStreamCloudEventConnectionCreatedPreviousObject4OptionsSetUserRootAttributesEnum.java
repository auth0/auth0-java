...
public final class EventStreamCloudEventConnectionCreatedPreviousObject4OptionsSetUserRootAttributesEnum {
    ...
    EventStreamCloudEventConnectionCreatedPreviousObject4OptionsSetUserRootAttributesEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public static EventStreamCloudEventConnectionCreatedPreviousObject4OptionsSetUserRootAttributesEnum valueOf(
            String value) {
        switch (value) {
            case "never_on_login":
