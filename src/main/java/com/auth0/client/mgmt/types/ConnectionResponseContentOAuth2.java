...
@JsonDeserialize(builder = ConnectionResponseContentOAuth2.Builder.class)
public final class ConnectionResponseContentOAuth2
    ...
    private final ConnectionResponseContentOAuth2Strategy strategy;

    private final Optional<ConnectionOptionsOAuth2> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentOAuth2(
            ...
            ConnectionResponseContentOAuth2Strategy strategy,
    ...
    public ConnectionResponseContentOAuth2Strategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsOAuth2> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentOAuth2 && equalTo((ConnectionResponseContentOAuth2) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentOAuth2 other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentOAuth2Strategy strategy);

        Builder from(ConnectionResponseContentOAuth2 other);
    }

    public interface _FinalStage {
        ConnectionResponseContentOAuth2 build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentOAuth2Strategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentOAuth2 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentOAuth2Strategy strategy) {
        ...
        @java.lang.Override
        public ConnectionResponseContentOAuth2 build() {
            return new ConnectionResponseContentOAuth2(
                    authentication,
                    connectedAccounts,
                    id,
                    realms,
