...
@JsonDeserialize(builder = UpdateConnectionRequestContentSoundcloud.Builder.class)
public final class UpdateConnectionRequestContentSoundcloud implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSoundcloud(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentSoundcloud
                && equalTo((UpdateConnectionRequestContentSoundcloud) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentSoundcloud other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentSoundcloud other) {
        ...
        public UpdateConnectionRequestContentSoundcloud build() {
            return new UpdateConnectionRequestContentSoundcloud(
