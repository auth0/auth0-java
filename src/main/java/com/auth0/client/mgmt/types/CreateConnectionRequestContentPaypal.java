...
@JsonDeserialize(builder = CreateConnectionRequestContentPaypal.Builder.class)
public final class CreateConnectionRequestContentPaypal implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentPaypalStrategy strategy;

    private final Optional<ConnectionOptionsPaypal> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentPaypal(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentPaypalStrategy strategy,
    ...
    public CreateConnectionRequestContentPaypalStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentPaypal
                && equalTo((CreateConnectionRequestContentPaypal) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentPaypal other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentPaypalStrategy strategy);

        Builder from(CreateConnectionRequestContentPaypal other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentPaypal build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentPaypalStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentPaypal other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentPaypalStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentPaypal build() {
            return new CreateConnectionRequestContentPaypal(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
