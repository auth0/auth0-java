...
@JsonDeserialize(builder = UpdateConnectionRequestContentVkontakte.Builder.class)
public final class UpdateConnectionRequestContentVkontakte implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentVkontakte(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentVkontakte
                && equalTo((UpdateConnectionRequestContentVkontakte) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentVkontakte other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentVkontakte other) {
        ...
        public Builder options(Optional<ConnectionOptionsVkontakte> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsVkontakte options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentVkontakte build() {
            return new UpdateConnectionRequestContentVkontakte(
