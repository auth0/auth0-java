...
@JsonDeserialize(builder = UpdateConnectionRequestContentApple.Builder.class)
public final class UpdateConnectionRequestContentApple implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentApple(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentApple
                && equalTo((UpdateConnectionRequestContentApple) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentApple other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentApple other) {
        ...
        public Builder options(Optional<ConnectionOptionsApple> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsApple options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentApple build() {
            return new UpdateConnectionRequestContentApple(
