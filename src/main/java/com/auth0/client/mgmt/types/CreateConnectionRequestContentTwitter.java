...
@JsonDeserialize(builder = CreateConnectionRequestContentTwitter.Builder.class)
public final class CreateConnectionRequestContentTwitter implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentTwitterStrategy strategy;

    private final Optional<ConnectionOptionsTwitter> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentTwitter(
            ...
            CreateConnectionRequestContentTwitterStrategy strategy,
            Optional<ConnectionOptionsTwitter> options,
    ...
    public CreateConnectionRequestContentTwitterStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentTwitter
                && equalTo((CreateConnectionRequestContentTwitter) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentTwitter other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentTwitterStrategy strategy);

        Builder from(CreateConnectionRequestContentTwitter other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentTwitter build();
        ...
        _FinalStage options(Optional<ConnectionOptionsTwitter> options);

        _FinalStage options(ConnectionOptionsTwitter options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentTwitterStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentTwitter other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentTwitterStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsTwitter options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsTwitter> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentTwitter build() {
            return new CreateConnectionRequestContentTwitter(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
