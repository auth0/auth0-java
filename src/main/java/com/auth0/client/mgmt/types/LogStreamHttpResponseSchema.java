...
@JsonDeserialize(builder = LogStreamHttpResponseSchema.Builder.class)
public final class LogStreamHttpResponseSchema {
    ...
    private final Optional<LogStreamHttpSink> sink;

    private final Map<String, Object> additionalProperties;

    private LogStreamHttpResponseSchema(
            Optional<String> id,
            ...
            Optional<LogStreamHttpSink> sink,
    ...
    @JsonProperty("sink")
    public Optional<LogStreamHttpSink> getSink() {
        return sink;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LogStreamHttpResponseSchema && equalTo((LogStreamHttpResponseSchema) other);
    }
    ...
    private boolean equalTo(LogStreamHttpResponseSchema other) {
    ...
    public static final class Builder {
        ...
        private Optional<LogStreamHttpSink> sink = Optional.empty();
        ...
        public Builder from(LogStreamHttpResponseSchema other) {
            id(other.getId());
            name(other.getName());
        ...
        public Builder sink(Optional<LogStreamHttpSink> sink) {
            this.sink = sink;
            return this;
        }

        public Builder sink(LogStreamHttpSink sink) {
            this.sink = Optional.ofNullable(sink);
            return this;
        }

        public LogStreamHttpResponseSchema build() {
            return new LogStreamHttpResponseSchema(
