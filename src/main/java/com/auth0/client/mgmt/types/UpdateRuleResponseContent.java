...
@JsonDeserialize(builder = UpdateRuleResponseContent.Builder.class)
public final class UpdateRuleResponseContent {
    ...
    private boolean equalTo(UpdateRuleResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateRuleResponseContent other) {
            name(other.getName());
            id(other.getId());
        ...
        public UpdateRuleResponseContent build() {
            return new UpdateRuleResponseContent(name, id, enabled, script, order, stage, additionalProperties);
        }
