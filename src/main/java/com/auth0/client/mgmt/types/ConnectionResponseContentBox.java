...
@JsonDeserialize(builder = ConnectionResponseContentBox.Builder.class)
public final class ConnectionResponseContentBox
    ...
    private final ConnectionResponseContentBoxStrategy strategy;

    private final Optional<ConnectionOptionsBox> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentBox(
            Optional<String> id,
            ...
            ConnectionResponseContentBoxStrategy strategy,
    ...
    public ConnectionResponseContentBoxStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentBox && equalTo((ConnectionResponseContentBox) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentBox other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentBoxStrategy strategy);

        Builder from(ConnectionResponseContentBox other);
    }

    public interface _FinalStage {
        ConnectionResponseContentBox build();
        ...
        _FinalStage options(Optional<ConnectionOptionsBox> options);

        _FinalStage options(ConnectionOptionsBox options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentBoxStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentBox other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentBoxStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsBox options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsBox> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public ConnectionResponseContentBox build() {
            return new ConnectionResponseContentBox(
                    id,
                    realms,
                    name,
                    authentication,
