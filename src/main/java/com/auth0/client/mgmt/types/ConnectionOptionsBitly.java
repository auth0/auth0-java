...
@JsonDeserialize(builder = ConnectionOptionsBitly.Builder.class)
public final class ConnectionOptionsBitly implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsBitly(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsBitly && equalTo((ConnectionOptionsBitly) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsBitly other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsBitly other) {
        ...
        public ConnectionOptionsBitly build() {
            return new ConnectionOptionsBitly(
                    clientId,
                    clientSecret,
                    scope,
