...
@JsonDeserialize(builder = CreateConnectionRequestContentThirtySevenSignals.Builder.class)
public final class CreateConnectionRequestContentThirtySevenSignals
        implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentThirtySevenSignalsStrategy strategy;
    ...
    private CreateConnectionRequestContentThirtySevenSignals(
            ...
            CreateConnectionRequestContentThirtySevenSignalsStrategy strategy,
    ...
    public CreateConnectionRequestContentThirtySevenSignalsStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentThirtySevenSignals
                && equalTo((CreateConnectionRequestContentThirtySevenSignals) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentThirtySevenSignals other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentThirtySevenSignalsStrategy strategy);

        Builder from(CreateConnectionRequestContentThirtySevenSignals other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentThirtySevenSignals build();
        ...
        _FinalStage options(Optional<ConnectionOptionsThirtySevenSignals> options);

        _FinalStage options(ConnectionOptionsThirtySevenSignals options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentThirtySevenSignalsStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentThirtySevenSignals other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentThirtySevenSignalsStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsThirtySevenSignals options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsThirtySevenSignals> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentThirtySevenSignals build() {
            return new CreateConnectionRequestContentThirtySevenSignals(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
