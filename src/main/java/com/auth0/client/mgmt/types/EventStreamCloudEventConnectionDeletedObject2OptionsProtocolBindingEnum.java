...
public final class EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum
            URN_OASIS_NAMES_TC_SAML20BINDINGS_HTTP_REDIRECT =
                    new EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum(
    ...
    EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionDeletedObject2OptionsProtocolBindingEnum valueOf(String value) {
        switch (value) {
