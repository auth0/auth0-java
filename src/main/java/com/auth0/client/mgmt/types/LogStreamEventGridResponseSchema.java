...
@JsonDeserialize(builder = LogStreamEventGridResponseSchema.Builder.class)
public final class LogStreamEventGridResponseSchema {
    ...
    private final Optional<LogStreamEventGridEnum> type;
    ...
    private final Optional<LogStreamEventGridSink> sink;
    ...
    @JsonProperty("type")
    public Optional<LogStreamEventGridEnum> getType() {
        return type;
    }
    ...
    @JsonProperty("sink")
    public Optional<LogStreamEventGridSink> getSink() {
        return sink;
    }
    ...
    private boolean equalTo(LogStreamEventGridResponseSchema other) {
    ...
    public static final class Builder {
        ...
        private Optional<LogStreamEventGridEnum> type = Optional.empty();
        ...
        private Optional<LogStreamEventGridSink> sink = Optional.empty();
        ...
        public Builder from(LogStreamEventGridResponseSchema other) {
            id(other.getId());
            name(other.getName());
        ...
        public Builder type(Optional<LogStreamEventGridEnum> type) {
            this.type = type;
            return this;
        }

        public Builder type(LogStreamEventGridEnum type) {
        ...
        public Builder sink(Optional<LogStreamEventGridSink> sink) {
            this.sink = sink;
            return this;
        }

        public Builder sink(LogStreamEventGridSink sink) {
            this.sink = Optional.ofNullable(sink);
            return this;
        }

        public LogStreamEventGridResponseSchema build() {
            return new LogStreamEventGridResponseSchema(
