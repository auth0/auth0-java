...
@JsonDeserialize(builder = CreateConnectionRequestContentYandex.Builder.class)
public final class CreateConnectionRequestContentYandex implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentYandexStrategy strategy;

    private final Optional<ConnectionOptionsYandex> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentYandex(
            ...
            CreateConnectionRequestContentYandexStrategy strategy,
            Optional<ConnectionOptionsYandex> options,
    ...
    public CreateConnectionRequestContentYandexStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsYandex> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentYandex
    ...
    private boolean equalTo(CreateConnectionRequestContentYandex other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentYandexStrategy strategy);

        Builder from(CreateConnectionRequestContentYandex other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentYandex build();
        ...
        _FinalStage options(Optional<ConnectionOptionsYandex> options);

        _FinalStage options(ConnectionOptionsYandex options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentYandexStrategy strategy;

        private Optional<ConnectionOptionsYandex> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentYandex other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentYandexStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsYandex options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsYandex> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentYandex build() {
            return new CreateConnectionRequestContentYandex(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
