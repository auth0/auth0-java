...
@JsonDeserialize(builder = GetClientGrantResponseContent.Builder.class)
public final class GetClientGrantResponseContent {
    ...
    private GetClientGrantResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetClientGrantResponseContent && equalTo((GetClientGrantResponseContent) other);
    }
    ...
    private boolean equalTo(GetClientGrantResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetClientGrantResponseContent other) {
            id(other.getId());
        ...
        public GetClientGrantResponseContent build() {
            return new GetClientGrantResponseContent(
                    id,
                    clientId,
                    audience,
                    scope,
