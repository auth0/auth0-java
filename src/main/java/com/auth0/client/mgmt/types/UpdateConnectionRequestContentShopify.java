...
@JsonDeserialize(builder = UpdateConnectionRequestContentShopify.Builder.class)
public final class UpdateConnectionRequestContentShopify implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentShopify(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentShopify
                && equalTo((UpdateConnectionRequestContentShopify) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentShopify other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentShopify other) {
        ...
        public Builder options(Optional<ConnectionOptionsShopify> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsShopify options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentShopify build() {
            return new UpdateConnectionRequestContentShopify(
