...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedObject2.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject2 {
    private final Optional<EventStreamCloudEventConnectionDeletedObject2Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedObject2Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedObject2StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedObject2(
            Optional<EventStreamCloudEventConnectionDeletedObject2Authentication> authentication,
            Optional<EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedObject2Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedObject2StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject2Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject2Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedObject2StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject2
                && equalTo((EventStreamCloudEventConnectionDeletedObject2) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject2 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject2 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject2StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject2 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject2Authentication authentication);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject2Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject2Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedObject2Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedObject2StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject2Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject2Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject2 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject2StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedObject2Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject2Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject2Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject2Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject2Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject2 build() {
            return new EventStreamCloudEventConnectionDeletedObject2(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
