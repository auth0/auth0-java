...
@JsonDeserialize(builder = GetOrganizationResponseContent.Builder.class)
public final class GetOrganizationResponseContent {
    ...
    private GetOrganizationResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetOrganizationResponseContent && equalTo((GetOrganizationResponseContent) other);
    }
    ...
    private boolean equalTo(GetOrganizationResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetOrganizationResponseContent other) {
            id(other.getId());
            name(other.getName());
        ...
        public GetOrganizationResponseContent build() {
            return new GetOrganizationResponseContent(
