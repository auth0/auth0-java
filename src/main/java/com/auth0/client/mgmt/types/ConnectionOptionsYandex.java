...
@JsonDeserialize(builder = ConnectionOptionsYandex.Builder.class)
public final class ConnectionOptionsYandex implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsYandex(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsYandex && equalTo((ConnectionOptionsYandex) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsYandex other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsYandex other) {
        ...
        public ConnectionOptionsYandex build() {
            return new ConnectionOptionsYandex(
                    clientId,
                    clientSecret,
                    scope,
