...
@JsonDeserialize(builder = CreateConnectionRequestContentAmazon.Builder.class)
public final class CreateConnectionRequestContentAmazon implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentAmazonStrategy strategy;

    private final Optional<ConnectionOptionsAmazon> options;
    ...
    private CreateConnectionRequestContentAmazon(
            ...
            CreateConnectionRequestContentAmazonStrategy strategy,
            Optional<ConnectionOptionsAmazon> options,
    ...
    public CreateConnectionRequestContentAmazonStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsAmazon> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentAmazon
                && equalTo((CreateConnectionRequestContentAmazon) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentAmazon other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentAmazonStrategy strategy);

        Builder from(CreateConnectionRequestContentAmazon other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentAmazon build();
        ...
        _FinalStage options(Optional<ConnectionOptionsAmazon> options);

        _FinalStage options(ConnectionOptionsAmazon options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentAmazonStrategy strategy;

        private Optional<ConnectionOptionsAmazon> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentAmazon other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentAmazonStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsAmazon options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsAmazon> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentAmazon build() {
            return new CreateConnectionRequestContentAmazon(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
