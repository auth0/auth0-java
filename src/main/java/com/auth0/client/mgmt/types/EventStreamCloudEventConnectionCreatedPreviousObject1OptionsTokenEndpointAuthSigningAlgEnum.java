...
public final class EventStreamCloudEventConnectionCreatedPreviousObject1OptionsTokenEndpointAuthSigningAlgEnum {
    ...
    public static EventStreamCloudEventConnectionCreatedPreviousObject1OptionsTokenEndpointAuthSigningAlgEnum valueOf(
            String value) {
        switch (value) {
            case "RS512":
                return RS512;
