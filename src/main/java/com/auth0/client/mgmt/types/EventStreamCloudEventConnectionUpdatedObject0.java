...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedObject0.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedObject0 {
    private final Optional<EventStreamCloudEventConnectionUpdatedObject0Authentication> authentication;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts> connectedAccounts;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject0Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedObject0StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedObject0(
            Optional<EventStreamCloudEventConnectionUpdatedObject0Authentication> authentication,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts> connectedAccounts,
            Optional<EventStreamCloudEventConnectionUpdatedObject0Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedObject0StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject0Authentication> getAuthentication() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts> getConnectedAccounts() {
        return connectedAccounts;
    }

    @JsonProperty("options")
    public Optional<EventStreamCloudEventConnectionUpdatedObject0Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedObject0StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedObject0
                && equalTo((EventStreamCloudEventConnectionUpdatedObject0) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedObject0 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedObject0 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject0StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedObject0 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject0Authentication authentication);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject0Metadata metadata);
        ...
        _FinalStage connectedAccounts(EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts connectedAccounts);

        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject0Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedObject0Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedObject0StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject0Options> options = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedObject0Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedObject0 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject0StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedObject0Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject0Options> options) {
            this.options = options;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject0Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject0Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject0Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedObject0 build() {
            return new EventStreamCloudEventConnectionUpdatedObject0(
                    authentication,
                    displayName,
                    enabledClients,
                    id,
