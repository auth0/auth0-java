...
@JsonDeserialize(builder = UpdateConnectionRequestContentPlanningCenter.Builder.class)
public final class UpdateConnectionRequestContentPlanningCenter implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentPlanningCenter
                && equalTo((UpdateConnectionRequestContentPlanningCenter) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentPlanningCenter other) {
    ...
    public int hashCode() {
        return Objects.hash(
                this.displayName, this.enabledClients, this.isDomainConnection, this.metadata, this.options);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentPlanningCenter other) {
        ...
        public Builder options(Optional<ConnectionOptionsPlanningCenter> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsPlanningCenter options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentPlanningCenter build() {
            return new UpdateConnectionRequestContentPlanningCenter(
