...
@JsonDeserialize(builder = CreateResourceServerResponseContent.Builder.class)
public final class CreateResourceServerResponseContent {
    ...
    private CreateResourceServerResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateResourceServerResponseContent
                && equalTo((CreateResourceServerResponseContent) other);
    }
    ...
    private boolean equalTo(CreateResourceServerResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateResourceServerResponseContent other) {
            id(other.getId());
            name(other.getName());
        ...
        public CreateResourceServerResponseContent build() {
            return new CreateResourceServerResponseContent(
                    id,
                    name,
                    isSystem,
                    identifier,
