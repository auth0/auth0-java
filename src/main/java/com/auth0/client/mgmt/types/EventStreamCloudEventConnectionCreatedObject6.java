...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedObject6.Builder.class)
public final class EventStreamCloudEventConnectionCreatedObject6 {
    private final Optional<EventStreamCloudEventConnectionCreatedObject6Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionCreatedObject6Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionCreatedObject6StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionCreatedObject6(
            Optional<EventStreamCloudEventConnectionCreatedObject6Authentication> authentication,
            Optional<EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionCreatedObject6Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionCreatedObject6StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedObject6Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedObject6Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionCreatedObject6StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedObject6
                && equalTo((EventStreamCloudEventConnectionCreatedObject6) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedObject6 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedObject6 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedObject6StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedObject6 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionCreatedObject6Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionCreatedObject6Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedObject6Options> options);

        _FinalStage options(EventStreamCloudEventConnectionCreatedObject6Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionCreatedObject6StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedObject6Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedObject6Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedObject6 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedObject6StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionCreatedObject6Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedObject6Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionCreatedObject6Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedObject6Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionCreatedObject6Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedObject6 build() {
            return new EventStreamCloudEventConnectionCreatedObject6(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
