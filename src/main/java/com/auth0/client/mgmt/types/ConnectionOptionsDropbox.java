...
@JsonDeserialize(builder = ConnectionOptionsDropbox.Builder.class)
public final class ConnectionOptionsDropbox implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsDropbox && equalTo((ConnectionOptionsDropbox) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsDropbox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsDropbox other) {
        ...
        public ConnectionOptionsDropbox build() {
            return new ConnectionOptionsDropbox(
                    clientId,
                    clientSecret,
                    scope,
