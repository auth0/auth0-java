...
@JsonDeserialize(builder = ConnectionOptionsThirtySevenSignals.Builder.class)
public final class ConnectionOptionsThirtySevenSignals
        implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsThirtySevenSignals
                && equalTo((ConnectionOptionsThirtySevenSignals) other);
    }
    ...
    public static final class Builder {
        ...
        public ConnectionOptionsThirtySevenSignals build() {
