...
@JsonDeserialize(builder = GetConnectionResponseContent.Builder.class)
public final class GetConnectionResponseContent {
    ...
    private boolean equalTo(GetConnectionResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetConnectionResponseContent other) {
            name(other.getName());
