...
public final class EventStreamCloudEventConnectionUpdatedObject0OptionsTokenEndpointAuthMethodEnum {
    ...
    EventStreamCloudEventConnectionUpdatedObject0OptionsTokenEndpointAuthMethodEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionUpdatedObject0OptionsTokenEndpointAuthMethodEnum
                        && this.string.equals(
    ...
    public static EventStreamCloudEventConnectionUpdatedObject0OptionsTokenEndpointAuthMethodEnum valueOf(
            String value) {
        switch (value) {
            case "private_key_jwt":
