...
@JsonDeserialize(builder = CreateConnectionRequestContentAol.Builder.class)
public final class CreateConnectionRequestContentAol implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentAolStrategy strategy;

    private final Optional<ConnectionOptionsAol> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentAol(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentAolStrategy strategy,
            Optional<ConnectionOptionsAol> options,
    ...
    public CreateConnectionRequestContentAolStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsAol> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentAol && equalTo((CreateConnectionRequestContentAol) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentAol other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentAolStrategy strategy);

        Builder from(CreateConnectionRequestContentAol other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentAol build();
        ...
        _FinalStage options(Optional<ConnectionOptionsAol> options);

        _FinalStage options(ConnectionOptionsAol options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentAolStrategy strategy;

        private Optional<ConnectionOptionsAol> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentAol other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentAolStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsAol options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsAol> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentAol build() {
            return new CreateConnectionRequestContentAol(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
