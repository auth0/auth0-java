...
@JsonDeserialize(builder = UpdateConnectionRequestContentFacebook.Builder.class)
public final class UpdateConnectionRequestContentFacebook implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentFacebook
                && equalTo((UpdateConnectionRequestContentFacebook) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentFacebook other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentFacebook other) {
        ...
        public Builder options(Optional<ConnectionOptionsFacebook> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsFacebook options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentFacebook build() {
            return new UpdateConnectionRequestContentFacebook(
