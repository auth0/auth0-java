...
@JsonDeserialize(builder = ConnectionResponseContentGitHub.Builder.class)
public final class ConnectionResponseContentGitHub
    ...
    private final ConnectionResponseContentGitHubStrategy strategy;

    private final Optional<ConnectionOptionsGitHub> options;

    private final Map<String, Object> additionalProperties;

    private ConnectionResponseContentGitHub(
            ...
            ConnectionResponseContentGitHubStrategy strategy,
    ...
    public ConnectionResponseContentGitHubStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsGitHub> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentGitHub && equalTo((ConnectionResponseContentGitHub) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentGitHub other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentGitHubStrategy strategy);

        Builder from(ConnectionResponseContentGitHub other);
    }

    public interface _FinalStage {
        ConnectionResponseContentGitHub build();
        ...
        _FinalStage options(Optional<ConnectionOptionsGitHub> options);

        _FinalStage options(ConnectionOptionsGitHub options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentGitHubStrategy strategy;

        private Optional<ConnectionOptionsGitHub> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentGitHub other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentGitHubStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsGitHub options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsGitHub> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public ConnectionResponseContentGitHub build() {
            return new ConnectionResponseContentGitHub(
                    authentication,
                    connectedAccounts,
                    id,
                    realms,
