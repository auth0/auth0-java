...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedObject7.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedObject7 {
    private final Optional<EventStreamCloudEventConnectionUpdatedObject7Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedObject7Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedObject7StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedObject7(
            Optional<EventStreamCloudEventConnectionUpdatedObject7Authentication> authentication,
            Optional<EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedObject7Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedObject7StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject7Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedObject7Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedObject7StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedObject7
                && equalTo((EventStreamCloudEventConnectionUpdatedObject7) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedObject7 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedObject7 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject7StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedObject7 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject7Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject7Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject7Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedObject7Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedObject7StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject7Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedObject7Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedObject7 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedObject7StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedObject7Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedObject7Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedObject7Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedObject7Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionUpdatedObject7Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedObject7 build() {
            return new EventStreamCloudEventConnectionUpdatedObject7(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
