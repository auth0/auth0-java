...
public final class EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum {
    ...
    EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum valueOf(String value) {
        switch (value) {
            ...
            default:
                return new EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum(
                        Value.UNKNOWN, value);
        }
    }
