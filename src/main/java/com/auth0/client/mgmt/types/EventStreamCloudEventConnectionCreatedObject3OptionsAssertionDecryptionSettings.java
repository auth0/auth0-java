...
@JsonDeserialize(
        builder = EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings.Builder.class)
public final class EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings {
    private final Optional<List<String>> algorithmExceptions;

    private final EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
            algorithmProfile;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings
                && equalTo((EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings other) {
    ...
    public interface AlgorithmProfileStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings build();
    ...
    public static final class Builder implements AlgorithmProfileStage, _FinalStage {
        private EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
                algorithmProfile;
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings build() {
            return new EventStreamCloudEventConnectionCreatedObject3OptionsAssertionDecryptionSettings(
