...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts other) {
    ...
    public interface ActiveStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts build();
    ...
    public static final class Builder implements ActiveStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts build() {
            return new EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts(
