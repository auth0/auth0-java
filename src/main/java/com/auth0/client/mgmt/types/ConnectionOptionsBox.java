...
@JsonDeserialize(builder = ConnectionOptionsBox.Builder.class)
public final class ConnectionOptionsBox implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsBox && equalTo((ConnectionOptionsBox) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsBox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsBox other) {
        ...
        public ConnectionOptionsBox build() {
            return new ConnectionOptionsBox(
                    clientId,
                    clientSecret,
                    scope,
