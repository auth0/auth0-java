...
@JsonDeserialize(builder = FlowActionFlowDoNothing.Builder.class)
public final class FlowActionFlowDoNothing {
    private final String id;

    private final Optional<String> alias;

    private final FlowActionFlowDoNothingType type;

    private final FlowActionFlowDoNothingAction action;

    private final Optional<Boolean> allowFailure;

    private final Optional<Boolean> maskOutput;

    private final Optional<FlowActionFlowDoNothingParams> params;
    ...
    private FlowActionFlowDoNothing(
            ...
            FlowActionFlowDoNothingType type,
            FlowActionFlowDoNothingAction action,
            Optional<Boolean> allowFailure,
            Optional<Boolean> maskOutput,
            Optional<FlowActionFlowDoNothingParams> params,
    ...
    @JsonProperty("type")
    public FlowActionFlowDoNothingType getType() {
        return type;
    }

    @JsonProperty("action")
    public FlowActionFlowDoNothingAction getAction() {
        return action;
    }
    ...
    @JsonProperty("params")
    public Optional<FlowActionFlowDoNothingParams> getParams() {
        return params;
    }
    ...
    private boolean equalTo(FlowActionFlowDoNothing other) {
    ...
    public interface IdStage {
        ...
        Builder from(FlowActionFlowDoNothing other);
    }

    public interface TypeStage {
        ActionStage type(@NotNull FlowActionFlowDoNothingType type);
    }

    public interface ActionStage {
        _FinalStage action(@NotNull FlowActionFlowDoNothingAction action);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage params(Optional<FlowActionFlowDoNothingParams> params);

        _FinalStage params(FlowActionFlowDoNothingParams params);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements IdStage, TypeStage, ActionStage, _FinalStage {
        private String id;

        private FlowActionFlowDoNothingType type;

        private FlowActionFlowDoNothingAction action;

        private Optional<FlowActionFlowDoNothingParams> params = Optional.empty();
        ...
        @java.lang.Override
        @JsonSetter("type")
        public ActionStage type(@NotNull FlowActionFlowDoNothingType type) {
        ...
        @java.lang.Override
        @JsonSetter("action")
        public _FinalStage action(@NotNull FlowActionFlowDoNothingAction action) {
