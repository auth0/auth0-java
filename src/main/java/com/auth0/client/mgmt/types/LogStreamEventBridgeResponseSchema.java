...
@JsonDeserialize(builder = LogStreamEventBridgeResponseSchema.Builder.class)
public final class LogStreamEventBridgeResponseSchema {
    ...
    private final Optional<LogStreamEventBridgeEnum> type;
    ...
    private final Optional<LogStreamEventBridgeSink> sink;

    private final Map<String, Object> additionalProperties;

    private LogStreamEventBridgeResponseSchema(
            Optional<String> id,
            Optional<String> name,
            Optional<LogStreamStatusEnum> status,
            Optional<LogStreamEventBridgeEnum> type,
            Optional<Boolean> isPriority,
            Optional<List<LogStreamFilter>> filters,
            Optional<LogStreamPiiConfig> piiConfig,
            Optional<LogStreamEventBridgeSink> sink,
    ...
    @JsonProperty("type")
    public Optional<LogStreamEventBridgeEnum> getType() {
        return type;
    }
    ...
    @JsonProperty("sink")
    public Optional<LogStreamEventBridgeSink> getSink() {
        return sink;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LogStreamEventBridgeResponseSchema
                && equalTo((LogStreamEventBridgeResponseSchema) other);
    }
    ...
    private boolean equalTo(LogStreamEventBridgeResponseSchema other) {
    ...
    public static final class Builder {
        ...
        private Optional<LogStreamEventBridgeEnum> type = Optional.empty();
        ...
        private Optional<LogStreamEventBridgeSink> sink = Optional.empty();
        ...
        public Builder from(LogStreamEventBridgeResponseSchema other) {
            id(other.getId());
            name(other.getName());
        ...
        public Builder type(Optional<LogStreamEventBridgeEnum> type) {
            this.type = type;
            return this;
        }

        public Builder type(LogStreamEventBridgeEnum type) {
        ...
        public Builder sink(Optional<LogStreamEventBridgeSink> sink) {
            this.sink = sink;
            return this;
        }

        public Builder sink(LogStreamEventBridgeSink sink) {
            this.sink = Optional.ofNullable(sink);
            return this;
        }

        public LogStreamEventBridgeResponseSchema build() {
            return new LogStreamEventBridgeResponseSchema(
