...
@JsonDeserialize(builder = ConnectionOptionsRenren.Builder.class)
public final class ConnectionOptionsRenren implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsRenren(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsRenren && equalTo((ConnectionOptionsRenren) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsRenren other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsRenren other) {
        ...
        public ConnectionOptionsRenren build() {
            return new ConnectionOptionsRenren(
                    clientId,
                    clientSecret,
                    scope,
