...
public final class EventStreamCloudEventConnectionCreatedObject4OptionsShouldTrustEmailVerifiedConnectionEnum {
    public static final EventStreamCloudEventConnectionCreatedObject4OptionsShouldTrustEmailVerifiedConnectionEnum
            NEVER_SET_EMAILS_AS_VERIFIED =
                    new EventStreamCloudEventConnectionCreatedObject4OptionsShouldTrustEmailVerifiedConnectionEnum(
    ...
    public static EventStreamCloudEventConnectionCreatedObject4OptionsShouldTrustEmailVerifiedConnectionEnum valueOf(
            String value) {
        switch (value) {
            case "never_set_emails_as_verified":
