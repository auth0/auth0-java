...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts {
    ...
    private EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts
                && equalTo((EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts other) {
    ...
    public interface ActiveStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts build();
    ...
    public static final class Builder implements ActiveStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts build() {
            return new EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts(
