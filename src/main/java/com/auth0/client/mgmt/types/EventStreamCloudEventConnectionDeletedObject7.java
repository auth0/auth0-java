...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedObject7.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject7 {
    private final Optional<EventStreamCloudEventConnectionDeletedObject7Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedObject7Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedObject7StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedObject7(
            Optional<EventStreamCloudEventConnectionDeletedObject7Authentication> authentication,
            Optional<EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedObject7Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedObject7StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedObject7StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject7
                && equalTo((EventStreamCloudEventConnectionDeletedObject7) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject7 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject7 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject7StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject7 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject7Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject7Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject7Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedObject7Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedObject7StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject7Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject7Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject7 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject7StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedObject7Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject7Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject7Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject7Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject7Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject7 build() {
            return new EventStreamCloudEventConnectionDeletedObject7(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
