...
@JsonDeserialize(builder = CreateConnectionRequestContentLinkedin.Builder.class)
public final class CreateConnectionRequestContentLinkedin implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentLinkedinStrategy strategy;

    private final Optional<ConnectionOptionsLinkedin> options;
    ...
    private CreateConnectionRequestContentLinkedin(
            ...
            CreateConnectionRequestContentLinkedinStrategy strategy,
            Optional<ConnectionOptionsLinkedin> options,
    ...
    public CreateConnectionRequestContentLinkedinStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsLinkedin> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentLinkedin
                && equalTo((CreateConnectionRequestContentLinkedin) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentLinkedin other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentLinkedinStrategy strategy);

        Builder from(CreateConnectionRequestContentLinkedin other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage options(Optional<ConnectionOptionsLinkedin> options);

        _FinalStage options(ConnectionOptionsLinkedin options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentLinkedinStrategy strategy;

        private Optional<ConnectionOptionsLinkedin> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentLinkedin other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentLinkedinStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsLinkedin options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsLinkedin> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentLinkedin build() {
            return new CreateConnectionRequestContentLinkedin(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
