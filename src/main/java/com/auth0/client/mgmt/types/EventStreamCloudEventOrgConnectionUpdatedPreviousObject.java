...
@JsonDeserialize(builder = EventStreamCloudEventOrgConnectionUpdatedPreviousObject.Builder.class)
public final class EventStreamCloudEventOrgConnectionUpdatedPreviousObject {
    private final EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganization organization;

    private final EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection connection;
    ...
    private final Optional<EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganizationAccessLevel>
            organizationAccessLevel;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventOrgConnectionUpdatedPreviousObject(
            EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganization organization,
            EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection connection,
            ...
            Optional<EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganizationAccessLevel>
                    organizationAccessLevel,
    ...
    public EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganization getOrganization() {
        return organization;
    }

    @JsonProperty("connection")
    public EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection getConnection() {
        return connection;
    }
    ...
    public Optional<EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganizationAccessLevel>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventOrgConnectionUpdatedPreviousObject
                && equalTo((EventStreamCloudEventOrgConnectionUpdatedPreviousObject) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventOrgConnectionUpdatedPreviousObject other) {
    ...
    public interface OrganizationStage {
        ConnectionStage organization(
                @NotNull EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganization organization);

        Builder from(EventStreamCloudEventOrgConnectionUpdatedPreviousObject other);
    }

    public interface ConnectionStage {
        _FinalStage connection(@NotNull EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection connection);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage organizationAccessLevel(
                EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganizationAccessLevel organizationAccessLevel);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements OrganizationStage, ConnectionStage, _FinalStage {
        private EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganization organization;

        private EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection connection;

        private Optional<EventStreamCloudEventOrgConnectionUpdatedPreviousObjectOrganizationAccessLevel>
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventOrgConnectionUpdatedPreviousObject other) {
        ...
        public _FinalStage connection(
                @NotNull EventStreamCloudEventOrgConnectionUpdatedPreviousObjectConnection connection) {
        ...
        @java.lang.Override
        public EventStreamCloudEventOrgConnectionUpdatedPreviousObject build() {
            return new EventStreamCloudEventOrgConnectionUpdatedPreviousObject(
                    organization,
                    connection,
