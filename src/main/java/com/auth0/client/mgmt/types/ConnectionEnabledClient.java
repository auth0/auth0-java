...
@JsonDeserialize(builder = ConnectionEnabledClient.Builder.class)
public final class ConnectionEnabledClient {
    private final String clientId;

    private final Map<String, Object> additionalProperties;

    private ConnectionEnabledClient(String clientId, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(ConnectionEnabledClient other) {
    ...
    public interface ClientIdStage {
        ...
        Builder from(ConnectionEnabledClient other);
    }

    public interface _FinalStage {
        ConnectionEnabledClient build();
