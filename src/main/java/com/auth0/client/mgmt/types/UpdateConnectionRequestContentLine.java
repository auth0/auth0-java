...
@JsonDeserialize(builder = UpdateConnectionRequestContentLine.Builder.class)
public final class UpdateConnectionRequestContentLine implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentLine
                && equalTo((UpdateConnectionRequestContentLine) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentLine other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentLine other) {
        ...
        public Builder options(Optional<ConnectionOptionsLine> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsLine options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentLine build() {
            return new UpdateConnectionRequestContentLine(
