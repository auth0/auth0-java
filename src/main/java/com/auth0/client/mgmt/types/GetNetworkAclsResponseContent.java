...
@JsonDeserialize(builder = GetNetworkAclsResponseContent.Builder.class)
public final class GetNetworkAclsResponseContent {
    ...
    private GetNetworkAclsResponseContent(
            Optional<String> id,
    ...
    private boolean equalTo(GetNetworkAclsResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetNetworkAclsResponseContent other) {
            id(other.getId());
        ...
        public GetNetworkAclsResponseContent build() {
            return new GetNetworkAclsResponseContent(
