...
@JsonDeserialize(builder = ConnectionOptionsShop.Builder.class)
public final class ConnectionOptionsShop implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsShop && equalTo((ConnectionOptionsShop) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsShop other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsShop other) {
        ...
        public ConnectionOptionsShop build() {
            return new ConnectionOptionsShop(
                    clientId,
                    clientSecret,
                    upstreamParams,
