...
@JsonDeserialize(builder = UpdateConnectionRequestContentCustom.Builder.class)
public final class UpdateConnectionRequestContentCustom implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentCustom
                && equalTo((UpdateConnectionRequestContentCustom) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentCustom other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentCustom other) {
        ...
        public UpdateConnectionRequestContentCustom build() {
            return new UpdateConnectionRequestContentCustom(
