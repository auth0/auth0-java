...
@JsonDeserialize(builder = CreateConnectionRequestContentMiicard.Builder.class)
public final class CreateConnectionRequestContentMiicard implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentMiicardStrategy strategy;

    private final Optional<ConnectionOptionsMiicard> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentMiicard(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentMiicardStrategy strategy,
            Optional<ConnectionOptionsMiicard> options,
    ...
    public CreateConnectionRequestContentMiicardStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsMiicard> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentMiicard
                && equalTo((CreateConnectionRequestContentMiicard) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentMiicard other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentMiicardStrategy strategy);

        Builder from(CreateConnectionRequestContentMiicard other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage options(Optional<ConnectionOptionsMiicard> options);

        _FinalStage options(ConnectionOptionsMiicard options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentMiicardStrategy strategy;

        private Optional<ConnectionOptionsMiicard> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentMiicard other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentMiicardStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsMiicard options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsMiicard> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentMiicard build() {
            return new CreateConnectionRequestContentMiicard(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
