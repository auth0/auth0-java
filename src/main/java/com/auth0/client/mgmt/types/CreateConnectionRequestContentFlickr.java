...
@JsonDeserialize(builder = CreateConnectionRequestContentFlickr.Builder.class)
public final class CreateConnectionRequestContentFlickr implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentFlickrStrategy strategy;

    private final Optional<ConnectionOptionsFlickr> options;
    ...
    private CreateConnectionRequestContentFlickr(
            ...
            CreateConnectionRequestContentFlickrStrategy strategy,
            Optional<ConnectionOptionsFlickr> options,
    ...
    public CreateConnectionRequestContentFlickrStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsFlickr> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentFlickr
                && equalTo((CreateConnectionRequestContentFlickr) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentFlickr other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentFlickrStrategy strategy);

        Builder from(CreateConnectionRequestContentFlickr other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentFlickr build();
        ...
        _FinalStage options(Optional<ConnectionOptionsFlickr> options);

        _FinalStage options(ConnectionOptionsFlickr options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentFlickrStrategy strategy;

        private Optional<ConnectionOptionsFlickr> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentFlickr other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentFlickrStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsFlickr options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsFlickr> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentFlickr build() {
            return new CreateConnectionRequestContentFlickr(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
