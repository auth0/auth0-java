...
@JsonDeserialize(builder = CreateConnectionRequestContentCustom.Builder.class)
public final class CreateConnectionRequestContentCustom implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentCustomStrategy strategy;

    private final Optional<Map<String, Object>> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentCustom(
            ...
            CreateConnectionRequestContentCustomStrategy strategy,
    ...
    public CreateConnectionRequestContentCustomStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentCustom
                && equalTo((CreateConnectionRequestContentCustom) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentCustom other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentCustomStrategy strategy);

        Builder from(CreateConnectionRequestContentCustom other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentCustom build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentCustomStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentCustom other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentCustomStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentCustom build() {
            return new CreateConnectionRequestContentCustom(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
