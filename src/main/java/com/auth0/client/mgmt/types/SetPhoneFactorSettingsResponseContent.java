...
@JsonDeserialize(builder = SetPhoneFactorSettingsResponseContent.Builder.class)
public final class SetPhoneFactorSettingsResponseContent {
    ...
    private SetPhoneFactorSettingsResponseContent(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SetPhoneFactorSettingsResponseContent
                && equalTo((SetPhoneFactorSettingsResponseContent) other);
    }
    ...
    private boolean equalTo(SetPhoneFactorSettingsResponseContent other) {
    ...
    public interface OtpLengthStage {
        ...
        Builder from(SetPhoneFactorSettingsResponseContent other);
    }
    ...
    public interface _FinalStage {
        SetPhoneFactorSettingsResponseContent build();
    ...
    public static final class Builder implements OtpLengthStage, OtpExpirationTimeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(SetPhoneFactorSettingsResponseContent other) {
        ...
        @java.lang.Override
        public SetPhoneFactorSettingsResponseContent build() {
            return new SetPhoneFactorSettingsResponseContent(otpLength, otpExpirationTime, additionalProperties);
        }
