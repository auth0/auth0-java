...
@JsonDeserialize(builder = CreateConnectionRequestContentAd.Builder.class)
public final class CreateConnectionRequestContentAd implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentAdStrategy strategy;
    ...
    private CreateConnectionRequestContentAd(
            ...
            CreateConnectionRequestContentAdStrategy strategy,
    ...
    public CreateConnectionRequestContentAdStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentAd && equalTo((CreateConnectionRequestContentAd) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentAd other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentAdStrategy strategy);

        Builder from(CreateConnectionRequestContentAd other);
    }
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentAdStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentAd other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentAdStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentAd build() {
            return new CreateConnectionRequestContentAd(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
