...
public final class UsernameAttribute {
    ...
    private final Optional<SignupSchema> signup;

    private final Optional<UsernameValidation> validation;
    ...
    public static final class Builder {
        ...
        private Optional<SignupSchema> signup = Optional.empty();

        private Optional<UsernameValidation> validation = Optional.empty();
