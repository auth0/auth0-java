...
@JsonDeserialize(builder = ConnectionOptionsFitbit.Builder.class)
public final class ConnectionOptionsFitbit implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsFitbit(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsFitbit && equalTo((ConnectionOptionsFitbit) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsFitbit other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsFitbit other) {
        ...
        public ConnectionOptionsFitbit build() {
            return new ConnectionOptionsFitbit(
                    clientId,
                    clientSecret,
                    scope,
