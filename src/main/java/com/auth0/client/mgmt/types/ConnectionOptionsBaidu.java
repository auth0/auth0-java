...
@JsonDeserialize(builder = ConnectionOptionsBaidu.Builder.class)
public final class ConnectionOptionsBaidu implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsBaidu(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsBaidu && equalTo((ConnectionOptionsBaidu) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsBaidu other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsBaidu other) {
        ...
        public ConnectionOptionsBaidu build() {
            return new ConnectionOptionsBaidu(
                    clientId,
                    clientSecret,
                    upstreamParams,
