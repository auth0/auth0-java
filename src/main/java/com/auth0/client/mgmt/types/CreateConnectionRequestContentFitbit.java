...
@JsonDeserialize(builder = CreateConnectionRequestContentFitbit.Builder.class)
public final class CreateConnectionRequestContentFitbit implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentFitbitStrategy strategy;

    private final Optional<ConnectionOptionsFitbit> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentFitbit(
            ...
            CreateConnectionRequestContentFitbitStrategy strategy,
            Optional<ConnectionOptionsFitbit> options,
    ...
    public CreateConnectionRequestContentFitbitStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsFitbit> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentFitbit
                && equalTo((CreateConnectionRequestContentFitbit) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentFitbit other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentFitbitStrategy strategy);

        Builder from(CreateConnectionRequestContentFitbit other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentFitbit build();
        ...
        _FinalStage options(Optional<ConnectionOptionsFitbit> options);

        _FinalStage options(ConnectionOptionsFitbit options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentFitbitStrategy strategy;

        private Optional<ConnectionOptionsFitbit> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentFitbit other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentFitbitStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsFitbit options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsFitbit> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentFitbit build() {
            return new CreateConnectionRequestContentFitbit(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
