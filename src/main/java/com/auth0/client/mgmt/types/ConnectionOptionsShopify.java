...
@JsonDeserialize(builder = ConnectionOptionsShopify.Builder.class)
public final class ConnectionOptionsShopify implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsShopify && equalTo((ConnectionOptionsShopify) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsShopify other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsShopify other) {
        ...
        public ConnectionOptionsShopify build() {
            return new ConnectionOptionsShopify(
                    clientId,
                    clientSecret,
                    upstreamParams,
