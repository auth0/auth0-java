...
@JsonDeserialize(builder = FormFieldEmail.Builder.class)
public final class FormFieldEmail {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeEmailConst type;

    private final Optional<FormFieldEmailConfig> config;
    ...
    private FormFieldEmail(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypeEmailConst type,
            Optional<FormFieldEmailConfig> config,
    ...
    @JsonProperty("type")
    public FormFieldTypeEmailConst getType() {
        return type;
    }

    @JsonProperty("config")
    public Optional<FormFieldEmailConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldEmail && equalTo((FormFieldEmail) other);
    }
    ...
    private boolean equalTo(FormFieldEmail other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldEmail other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull FormFieldTypeEmailConst type);
    }

    public interface _FinalStage {
        FormFieldEmail build();

        _FinalStage config(Optional<FormFieldEmailConfig> config);

        _FinalStage config(FormFieldEmailConfig config);
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private FormFieldTypeEmailConst type;
        ...
        private Optional<FormFieldEmailConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldEmail other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull FormFieldTypeEmailConst type) {
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldEmailConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldEmailConfig> config) {
            this.config = config;
            return this;
        }

        @java.lang.Override
        public FormFieldEmail build() {
            return new FormFieldEmail(
