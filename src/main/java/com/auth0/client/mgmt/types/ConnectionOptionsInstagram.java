...
@JsonDeserialize(builder = ConnectionOptionsInstagram.Builder.class)
public final class ConnectionOptionsInstagram implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsInstagram(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsInstagram && equalTo((ConnectionOptionsInstagram) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsInstagram other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsInstagram other) {
        ...
        public ConnectionOptionsInstagram build() {
            return new ConnectionOptionsInstagram(
                    clientId,
                    clientSecret,
                    scope,
