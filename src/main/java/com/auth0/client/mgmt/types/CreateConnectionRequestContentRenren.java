...
@JsonDeserialize(builder = CreateConnectionRequestContentRenren.Builder.class)
public final class CreateConnectionRequestContentRenren implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentRenrenStrategy strategy;

    private final Optional<ConnectionOptionsRenren> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentRenren(
            ...
            CreateConnectionRequestContentRenrenStrategy strategy,
            Optional<ConnectionOptionsRenren> options,
    ...
    public CreateConnectionRequestContentRenrenStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsRenren> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentRenren
                && equalTo((CreateConnectionRequestContentRenren) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentRenren other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentRenrenStrategy strategy);

        Builder from(CreateConnectionRequestContentRenren other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentRenren build();
        ...
        _FinalStage options(Optional<ConnectionOptionsRenren> options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentRenrenStrategy strategy;

        private Optional<ConnectionOptionsRenren> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentRenren other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentRenrenStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsRenren options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsRenren> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentRenren build() {
            return new CreateConnectionRequestContentRenren(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
