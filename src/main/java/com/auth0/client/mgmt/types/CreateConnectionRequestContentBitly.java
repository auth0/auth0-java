...
@JsonDeserialize(builder = CreateConnectionRequestContentBitly.Builder.class)
public final class CreateConnectionRequestContentBitly implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentBitlyStrategy strategy;

    private final Optional<ConnectionOptionsBitly> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentBitly(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentBitlyStrategy strategy,
            Optional<ConnectionOptionsBitly> options,
    ...
    public CreateConnectionRequestContentBitlyStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsBitly> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentBitly
                && equalTo((CreateConnectionRequestContentBitly) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentBitly other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentBitlyStrategy strategy);

        Builder from(CreateConnectionRequestContentBitly other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentBitly build();
        ...
        _FinalStage options(Optional<ConnectionOptionsBitly> options);

        _FinalStage options(ConnectionOptionsBitly options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentBitlyStrategy strategy;

        private Optional<ConnectionOptionsBitly> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentBitly other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentBitlyStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsBitly options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsBitly> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentBitly build() {
            return new CreateConnectionRequestContentBitly(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
