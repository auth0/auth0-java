...
@JsonDeserialize(builder = CreateLogStreamDatadogRequestBody.Builder.class)
public final class CreateLogStreamDatadogRequestBody {
    ...
    private final LogStreamDatadogSink sink;
    ...
    @JsonProperty("sink")
    public LogStreamDatadogSink getSink() {
        return sink;
    }
    ...
    private boolean equalTo(CreateLogStreamDatadogRequestBody other) {
    ...
    public interface SinkStage {
        _FinalStage sink(@NotNull LogStreamDatadogSink sink);
    }

    public interface _FinalStage {
        CreateLogStreamDatadogRequestBody build();
