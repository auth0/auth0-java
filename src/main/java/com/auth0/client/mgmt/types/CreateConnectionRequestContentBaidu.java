...
@JsonDeserialize(builder = CreateConnectionRequestContentBaidu.Builder.class)
public final class CreateConnectionRequestContentBaidu implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentBaiduStrategy strategy;

    private final Optional<ConnectionOptionsBaidu> options;
    ...
    private CreateConnectionRequestContentBaidu(
            ...
            CreateConnectionRequestContentBaiduStrategy strategy,
            Optional<ConnectionOptionsBaidu> options,
    ...
    public CreateConnectionRequestContentBaiduStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsBaidu> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentBaidu
                && equalTo((CreateConnectionRequestContentBaidu) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentBaidu other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentBaiduStrategy strategy);

        Builder from(CreateConnectionRequestContentBaidu other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentBaidu build();
        ...
        _FinalStage options(Optional<ConnectionOptionsBaidu> options);

        _FinalStage options(ConnectionOptionsBaidu options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentBaiduStrategy strategy;

        private Optional<ConnectionOptionsBaidu> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentBaidu other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentBaiduStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsBaidu options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsBaidu> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentBaidu build() {
            return new CreateConnectionRequestContentBaidu(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
