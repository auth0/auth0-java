...
public final class EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum
            URN_OASIS_NAMES_TC_SAML20BINDINGS_HTTP_REDIRECT =
                    new EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum(
    ...
    EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum
                        && this.string.equals(
    ...
    public static EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum valueOf(
            String value) {
        switch (value) {
            ...
            default:
                return new EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum(
                        Value.UNKNOWN, value);
        }
    }
