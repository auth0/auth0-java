...
@JsonDeserialize(builder = ConnectionResponseContentWindowsLive.Builder.class)
public final class ConnectionResponseContentWindowsLive
    ...
    private final ConnectionResponseContentWindowsLiveStrategy strategy;
    ...
    private ConnectionResponseContentWindowsLive(
            ...
            ConnectionResponseContentWindowsLiveStrategy strategy,
    ...
    public ConnectionResponseContentWindowsLiveStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentWindowsLive
                && equalTo((ConnectionResponseContentWindowsLive) other);
    }
    ...
    private boolean equalTo(ConnectionResponseContentWindowsLive other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentWindowsLiveStrategy strategy);

        Builder from(ConnectionResponseContentWindowsLive other);
    }

    public interface _FinalStage {
        ConnectionResponseContentWindowsLive build();
        ...
        _FinalStage options(Optional<ConnectionOptionsWindowsLive> options);

        _FinalStage options(ConnectionOptionsWindowsLive options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private ConnectionResponseContentWindowsLiveStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(ConnectionResponseContentWindowsLive other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentWindowsLiveStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsWindowsLive options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsWindowsLive> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public ConnectionResponseContentWindowsLive build() {
            return new ConnectionResponseContentWindowsLive(
                    id,
                    realms,
                    name,
                    authentication,
