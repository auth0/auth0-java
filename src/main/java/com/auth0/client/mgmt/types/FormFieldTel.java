...
@JsonDeserialize(builder = FormFieldTel.Builder.class)
public final class FormFieldTel {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeTelConst type;

    private final Optional<FormFieldTelConfig> config;
    ...
    private FormFieldTel(
            ...
            FormFieldTypeTelConst type,
            Optional<FormFieldTelConfig> config,
    ...
    @JsonProperty("type")
    public FormFieldTypeTelConst getType() {
        return type;
    }

    @JsonProperty("config")
    public Optional<FormFieldTelConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldTel && equalTo((FormFieldTel) other);
    }
    ...
    private boolean equalTo(FormFieldTel other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldTel other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull FormFieldTypeTelConst type);
    }
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private FormFieldTypeTelConst type;
        ...
        private Optional<FormFieldTelConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldTel other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull FormFieldTypeTelConst type) {
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldTelConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldTelConfig> config) {
            this.config = config;
            return this;
        }
