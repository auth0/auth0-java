...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedPreviousObject3.Builder.class)
public final class EventStreamCloudEventConnectionCreatedPreviousObject3 {
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionCreatedPreviousObject3(
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Authentication> authentication,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedPreviousObject3
                && equalTo((EventStreamCloudEventConnectionCreatedPreviousObject3) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedPreviousObject3 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedPreviousObject3 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedPreviousObject3 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionCreatedPreviousObject3Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject3Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> options);

        _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject3Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedPreviousObject3 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject3Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject3Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject3Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionCreatedPreviousObject3Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedPreviousObject3 build() {
            return new EventStreamCloudEventConnectionCreatedPreviousObject3(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
