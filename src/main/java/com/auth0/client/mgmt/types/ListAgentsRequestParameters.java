...
@JsonDeserialize(builder = ListAgentsRequestParameters.Builder.class)
public final class ListAgentsRequestParameters {
    ...
    private ListAgentsRequestParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListAgentsRequestParameters && equalTo((ListAgentsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListAgentsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListAgentsRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        public ListAgentsRequestParameters build() {
            return new ListAgentsRequestParameters(from, take, additionalProperties);
        }
