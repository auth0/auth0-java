...
@JsonDeserialize(builder = ConnectionOptionsSharepoint.Builder.class)
public final class ConnectionOptionsSharepoint implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsSharepoint(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsSharepoint && equalTo((ConnectionOptionsSharepoint) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsSharepoint other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsSharepoint other) {
        ...
        public ConnectionOptionsSharepoint build() {
            return new ConnectionOptionsSharepoint(
                    clientId,
                    clientSecret,
                    scope,
