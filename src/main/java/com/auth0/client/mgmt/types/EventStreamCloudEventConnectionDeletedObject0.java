...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedObject0.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject0 {
    private final Optional<EventStreamCloudEventConnectionDeletedObject0Authentication> authentication;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts> connectedAccounts;

    private final Optional<EventStreamCloudEventConnectionDeletedObject0Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedObject0StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedObject0(
            Optional<EventStreamCloudEventConnectionDeletedObject0Authentication> authentication,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts> connectedAccounts,
            Optional<EventStreamCloudEventConnectionDeletedObject0Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedObject0StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject0Authentication> getAuthentication() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts> getConnectedAccounts() {
        return connectedAccounts;
    }

    @JsonProperty("options")
    public Optional<EventStreamCloudEventConnectionDeletedObject0Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedObject0StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject0
                && equalTo((EventStreamCloudEventConnectionDeletedObject0) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject0 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject0 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject0StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject0 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject0Authentication authentication);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject0Metadata metadata);
        ...
        _FinalStage connectedAccounts(EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts connectedAccounts);

        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject0Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedObject0Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedObject0StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject0Options> options = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject0Authentication> authentication = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject0 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedObject0StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedObject0Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedObject0Options> options) {
            this.options = options;
            return this;
        }
        ...
        public _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts connectedAccounts) {
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedObject0Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedObject0Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage authentication(EventStreamCloudEventConnectionDeletedObject0Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject0 build() {
            return new EventStreamCloudEventConnectionDeletedObject0(
                    authentication,
                    displayName,
                    enabledClients,
                    id,
