...
@JsonDeserialize(builder = EventStreamCloudEventOrgMemberDeletedData.Builder.class)
public final class EventStreamCloudEventOrgMemberDeletedData {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventOrgMemberDeletedData
                && equalTo((EventStreamCloudEventOrgMemberDeletedData) other);
    }
    ...
    public interface ObjectStage {
        _FinalStage object(@NotNull EventStreamCloudEventOrgMemberDeletedObject object);

        Builder from(EventStreamCloudEventOrgMemberDeletedData other);
    }

    public interface _FinalStage {
        EventStreamCloudEventOrgMemberDeletedData build();
    ...
    public static final class Builder implements ObjectStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("object")
        public _FinalStage object(@NotNull EventStreamCloudEventOrgMemberDeletedObject object) {
