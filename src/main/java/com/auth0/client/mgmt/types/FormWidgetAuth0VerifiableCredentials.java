...
public final class FormWidgetAuth0VerifiableCredentials {
    ...
    private final FormWidgetTypeAuth0VerifiableCredentialsConst type;

    private final FormWidgetAuth0VerifiableCredentialsConfig config;
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, ConfigStage, _FinalStage {
        ...
        private FormWidgetTypeAuth0VerifiableCredentialsConst type;

        private FormWidgetAuth0VerifiableCredentialsConfig config;
