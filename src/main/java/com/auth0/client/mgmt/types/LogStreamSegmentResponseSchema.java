...
@JsonDeserialize(builder = LogStreamSegmentResponseSchema.Builder.class)
public final class LogStreamSegmentResponseSchema {
    ...
    private final Optional<LogStreamSegmentEnum> type;
    ...
    private final Optional<LogStreamSegmentSinkWriteKey> sink;

    private final Map<String, Object> additionalProperties;

    private LogStreamSegmentResponseSchema(
            Optional<String> id,
            Optional<String> name,
            Optional<LogStreamStatusEnum> status,
            Optional<LogStreamSegmentEnum> type,
            Optional<Boolean> isPriority,
            Optional<List<LogStreamFilter>> filters,
            Optional<LogStreamPiiConfig> piiConfig,
            Optional<LogStreamSegmentSinkWriteKey> sink,
    ...
    @JsonProperty("type")
    public Optional<LogStreamSegmentEnum> getType() {
        return type;
    }
    ...
    @JsonProperty("sink")
    public Optional<LogStreamSegmentSinkWriteKey> getSink() {
        return sink;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LogStreamSegmentResponseSchema && equalTo((LogStreamSegmentResponseSchema) other);
    }
    ...
    private boolean equalTo(LogStreamSegmentResponseSchema other) {
    ...
    public static final class Builder {
        ...
        private Optional<LogStreamSegmentEnum> type = Optional.empty();
        ...
        private Optional<LogStreamSegmentSinkWriteKey> sink = Optional.empty();
        ...
        public Builder from(LogStreamSegmentResponseSchema other) {
            id(other.getId());
            name(other.getName());
        ...
        public Builder type(Optional<LogStreamSegmentEnum> type) {
            this.type = type;
            return this;
        }

        public Builder type(LogStreamSegmentEnum type) {
        ...
        public Builder sink(Optional<LogStreamSegmentSinkWriteKey> sink) {
            this.sink = sink;
            return this;
        }

        public Builder sink(LogStreamSegmentSinkWriteKey sink) {
            this.sink = Optional.ofNullable(sink);
            return this;
        }

        public LogStreamSegmentResponseSchema build() {
            return new LogStreamSegmentResponseSchema(
