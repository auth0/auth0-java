...
@JsonDeserialize(builder = FormFieldBoolean.Builder.class)
public final class FormFieldBoolean {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeBooleanConst type;

    private final FormFieldBooleanConfig config;
    ...
    private FormFieldBoolean(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypeBooleanConst type,
            FormFieldBooleanConfig config,
    ...
    @JsonProperty("type")
    public FormFieldTypeBooleanConst getType() {
        return type;
    }

    @JsonProperty("config")
    public FormFieldBooleanConfig getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldBoolean && equalTo((FormFieldBoolean) other);
    }
    ...
    private boolean equalTo(FormFieldBoolean other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldBoolean other);
    }
    ...
    public interface TypeStage {
        ConfigStage type(@NotNull FormFieldTypeBooleanConst type);
    }

    public interface ConfigStage {
        _FinalStage config(@NotNull FormFieldBooleanConfig config);
    }

    public interface _FinalStage {
        FormFieldBoolean build();
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, ConfigStage, _FinalStage {
        ...
        private FormFieldTypeBooleanConst type;

        private FormFieldBooleanConfig config;
        ...
        @java.lang.Override
        public Builder from(FormFieldBoolean other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public ConfigStage type(@NotNull FormFieldTypeBooleanConst type) {
        ...
        @java.lang.Override
        @JsonSetter("config")
        public _FinalStage config(@NotNull FormFieldBooleanConfig config) {
