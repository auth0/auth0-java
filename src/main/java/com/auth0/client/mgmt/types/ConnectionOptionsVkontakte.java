...
@JsonDeserialize(builder = ConnectionOptionsVkontakte.Builder.class)
public final class ConnectionOptionsVkontakte implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsVkontakte(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsVkontakte && equalTo((ConnectionOptionsVkontakte) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsVkontakte other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsVkontakte other) {
        ...
        public ConnectionOptionsVkontakte build() {
            return new ConnectionOptionsVkontakte(
                    clientId,
                    clientSecret,
                    scope,
