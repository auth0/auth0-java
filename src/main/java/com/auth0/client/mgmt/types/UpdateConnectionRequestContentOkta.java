...
@JsonDeserialize(builder = UpdateConnectionRequestContentOkta.Builder.class)
public final class UpdateConnectionRequestContentOkta implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentOkta(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentOkta
                && equalTo((UpdateConnectionRequestContentOkta) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentOkta other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentOkta other) {
        ...
        public Builder options(Optional<ConnectionOptionsOkta> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsOkta options) {
        ...
        public UpdateConnectionRequestContentOkta build() {
            return new UpdateConnectionRequestContentOkta(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
