...
@JsonDeserialize(builder = ListUserAttributeProfileRequestParameters.Builder.class)
public final class ListUserAttributeProfileRequestParameters {
    ...
    private ListUserAttributeProfileRequestParameters(
    ...
    /**
     * @return Number of results per page. Defaults to 5.
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("take")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUserAttributeProfileRequestParameters
                && equalTo((ListUserAttributeProfileRequestParameters) other);
    }
    ...
    private boolean equalTo(ListUserAttributeProfileRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUserAttributeProfileRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        /**
         * <p>Number of results per page. Defaults to 5.</p>
         */
        ...
        public ListUserAttributeProfileRequestParameters build() {
            return new ListUserAttributeProfileRequestParameters(from, take, additionalProperties);
        }
    }
}
