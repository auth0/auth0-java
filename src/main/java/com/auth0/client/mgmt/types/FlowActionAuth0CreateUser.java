...
@JsonDeserialize(builder = FlowActionAuth0CreateUser.Builder.class)
public final class FlowActionAuth0CreateUser {
    ...
    private final FlowActionAuth0CreateUserParams params;
    ...
    @JsonProperty("params")
    public FlowActionAuth0CreateUserParams getParams() {
        return params;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FlowActionAuth0CreateUser && equalTo((FlowActionAuth0CreateUser) other);
    }
    ...
    public interface ParamsStage {
        _FinalStage params(@NotNull FlowActionAuth0CreateUserParams params);
    }

    public interface _FinalStage {
        FlowActionAuth0CreateUser build();
    ...
    public static final class Builder implements IdStage, ParamsStage, _FinalStage {
        ...
        @Override
        @JsonSetter("params")
        public _FinalStage params(@NotNull FlowActionAuth0CreateUserParams params) {
