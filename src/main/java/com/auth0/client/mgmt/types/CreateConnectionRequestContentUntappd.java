...
@JsonDeserialize(builder = CreateConnectionRequestContentUntappd.Builder.class)
public final class CreateConnectionRequestContentUntappd implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentUntappdStrategy strategy;

    private final Optional<ConnectionOptionsUntappd> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentUntappd(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentUntappdStrategy strategy,
            Optional<ConnectionOptionsUntappd> options,
    ...
    public CreateConnectionRequestContentUntappdStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsUntappd> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentUntappd
                && equalTo((CreateConnectionRequestContentUntappd) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentUntappd other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentUntappdStrategy strategy);

        Builder from(CreateConnectionRequestContentUntappd other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentUntappd build();
        ...
        _FinalStage options(Optional<ConnectionOptionsUntappd> options);

        _FinalStage options(ConnectionOptionsUntappd options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentUntappdStrategy strategy;

        private Optional<ConnectionOptionsUntappd> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentUntappd other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentUntappdStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsUntappd options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsUntappd> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentUntappd build() {
            return new CreateConnectionRequestContentUntappd(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
