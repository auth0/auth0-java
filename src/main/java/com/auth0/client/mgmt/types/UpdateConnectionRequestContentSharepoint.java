...
@JsonDeserialize(builder = UpdateConnectionRequestContentSharepoint.Builder.class)
public final class UpdateConnectionRequestContentSharepoint implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentSharepoint(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentSharepoint
                && equalTo((UpdateConnectionRequestContentSharepoint) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentSharepoint other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentSharepoint other) {
        ...
        public UpdateConnectionRequestContentSharepoint build() {
            return new UpdateConnectionRequestContentSharepoint(
                    displayName,
                    enabledClients,
                    isDomainConnection,
                    metadata,
