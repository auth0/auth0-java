...
@JsonDeserialize(
        builder = EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings {
    private final Optional<List<String>> algorithmExceptions;

    private final EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
            algorithmProfile;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings
                && equalTo((EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings other) {
    ...
    public interface AlgorithmProfileStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings build();
    ...
    public static final class Builder implements AlgorithmProfileStage, _FinalStage {
        private EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
                algorithmProfile;
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings build() {
            return new EventStreamCloudEventConnectionDeletedObject3OptionsAssertionDecryptionSettings(
