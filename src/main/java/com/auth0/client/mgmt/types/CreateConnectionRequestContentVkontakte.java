...
@JsonDeserialize(builder = CreateConnectionRequestContentVkontakte.Builder.class)
public final class CreateConnectionRequestContentVkontakte implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentVkontakteStrategy strategy;

    private final Optional<ConnectionOptionsVkontakte> options;
    ...
    private CreateConnectionRequestContentVkontakte(
            ...
            CreateConnectionRequestContentVkontakteStrategy strategy,
            Optional<ConnectionOptionsVkontakte> options,
    ...
    public CreateConnectionRequestContentVkontakteStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsVkontakte> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentVkontakte
                && equalTo((CreateConnectionRequestContentVkontakte) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentVkontakte other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentVkontakteStrategy strategy);

        Builder from(CreateConnectionRequestContentVkontakte other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentVkontakte build();
        ...
        _FinalStage options(Optional<ConnectionOptionsVkontakte> options);

        _FinalStage options(ConnectionOptionsVkontakte options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentVkontakteStrategy strategy;

        private Optional<ConnectionOptionsVkontakte> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentVkontakte other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentVkontakteStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsVkontakte options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsVkontakte> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentVkontakte build() {
            return new CreateConnectionRequestContentVkontakte(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
