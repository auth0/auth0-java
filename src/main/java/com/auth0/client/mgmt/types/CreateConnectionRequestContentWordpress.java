...
@JsonDeserialize(builder = CreateConnectionRequestContentWordpress.Builder.class)
public final class CreateConnectionRequestContentWordpress implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentWordpressStrategy strategy;

    private final Optional<ConnectionOptionsWordpress> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentWordpress(
            ...
            CreateConnectionRequestContentWordpressStrategy strategy,
            Optional<ConnectionOptionsWordpress> options,
    ...
    public CreateConnectionRequestContentWordpressStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsWordpress> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentWordpress
                && equalTo((CreateConnectionRequestContentWordpress) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentWordpress other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentWordpressStrategy strategy);

        Builder from(CreateConnectionRequestContentWordpress other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentWordpress build();
        ...
        _FinalStage options(Optional<ConnectionOptionsWordpress> options);

        _FinalStage options(ConnectionOptionsWordpress options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentWordpressStrategy strategy;

        private Optional<ConnectionOptionsWordpress> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentWordpress other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentWordpressStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsWordpress options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsWordpress> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentWordpress build() {
            return new CreateConnectionRequestContentWordpress(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
