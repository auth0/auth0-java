...
@JsonDeserialize(builder = EventStreamCloudEventConnectionUpdatedPreviousObject1.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject1 {
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedPreviousObject1(
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication> authentication,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject1
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject1) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedPreviousObject1 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject1 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedPreviousObject1 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> options);

        _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject1Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject1 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionUpdatedPreviousObject1Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedPreviousObject1 build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject1(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
