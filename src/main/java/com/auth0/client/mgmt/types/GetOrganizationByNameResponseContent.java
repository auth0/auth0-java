...
@JsonDeserialize(builder = GetOrganizationByNameResponseContent.Builder.class)
public final class GetOrganizationByNameResponseContent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetOrganizationByNameResponseContent
                && equalTo((GetOrganizationByNameResponseContent) other);
    }
    ...
    private boolean equalTo(GetOrganizationByNameResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetOrganizationByNameResponseContent other) {
            id(other.getId());
            name(other.getName());
