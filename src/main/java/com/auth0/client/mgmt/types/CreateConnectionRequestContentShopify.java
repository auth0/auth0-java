...
@JsonDeserialize(builder = CreateConnectionRequestContentShopify.Builder.class)
public final class CreateConnectionRequestContentShopify implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentShopifyStrategy strategy;

    private final Optional<ConnectionOptionsShopify> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentShopify(
            ...
            CreateConnectionRequestContentShopifyStrategy strategy,
            Optional<ConnectionOptionsShopify> options,
    ...
    public CreateConnectionRequestContentShopifyStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsShopify> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentShopify
                && equalTo((CreateConnectionRequestContentShopify) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentShopify other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentShopifyStrategy strategy);

        Builder from(CreateConnectionRequestContentShopify other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentShopify build();
        ...
        _FinalStage options(Optional<ConnectionOptionsShopify> options);

        _FinalStage options(ConnectionOptionsShopify options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentShopifyStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentShopify other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentShopifyStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsShopify options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsShopify> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentShopify build() {
            return new CreateConnectionRequestContentShopify(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
