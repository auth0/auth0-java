...
@JsonDeserialize(builder = ConnectionProfileTemplate.Builder.class)
public final class ConnectionProfileTemplate {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionProfileTemplate && equalTo((ConnectionProfileTemplate) other);
    }
    ...
    private boolean equalTo(ConnectionProfileTemplate other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionProfileTemplate other) {
            name(other.getName());
