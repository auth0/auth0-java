...
@JsonDeserialize(builder = UpdateConnectionRequestContentDaccount.Builder.class)
public final class UpdateConnectionRequestContentDaccount implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentDaccount(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentDaccount
                && equalTo((UpdateConnectionRequestContentDaccount) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentDaccount other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentDaccount other) {
        ...
        public Builder options(Optional<ConnectionOptionsDaccount> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsDaccount options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentDaccount build() {
            return new UpdateConnectionRequestContentDaccount(
