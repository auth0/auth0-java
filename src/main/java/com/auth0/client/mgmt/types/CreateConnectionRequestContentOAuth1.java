...
@JsonDeserialize(builder = CreateConnectionRequestContentOAuth1.Builder.class)
public final class CreateConnectionRequestContentOAuth1 implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentOAuth1Strategy strategy;

    private final Optional<ConnectionOptionsOAuth1> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentOAuth1(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentOAuth1Strategy strategy,
            Optional<ConnectionOptionsOAuth1> options,
    ...
    public CreateConnectionRequestContentOAuth1Strategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsOAuth1> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentOAuth1
                && equalTo((CreateConnectionRequestContentOAuth1) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentOAuth1 other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentOAuth1Strategy strategy);

        Builder from(CreateConnectionRequestContentOAuth1 other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentOAuth1 build();
        ...
        _FinalStage options(Optional<ConnectionOptionsOAuth1> options);

        _FinalStage options(ConnectionOptionsOAuth1 options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentOAuth1Strategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentOAuth1 other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentOAuth1Strategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsOAuth1 options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsOAuth1> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentOAuth1 build() {
            return new CreateConnectionRequestContentOAuth1(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
