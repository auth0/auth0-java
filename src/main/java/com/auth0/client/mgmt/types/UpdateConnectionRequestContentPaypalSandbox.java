...
@JsonDeserialize(builder = UpdateConnectionRequestContentPaypalSandbox.Builder.class)
public final class UpdateConnectionRequestContentPaypalSandbox implements IConnectionCommon {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentPaypalSandbox
                && equalTo((UpdateConnectionRequestContentPaypalSandbox) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentPaypalSandbox other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentPaypalSandbox other) {
        ...
        public UpdateConnectionRequestContentPaypalSandbox build() {
            return new UpdateConnectionRequestContentPaypalSandbox(
