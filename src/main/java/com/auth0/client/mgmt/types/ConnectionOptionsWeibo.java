...
@JsonDeserialize(builder = ConnectionOptionsWeibo.Builder.class)
public final class ConnectionOptionsWeibo implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsWeibo(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsWeibo && equalTo((ConnectionOptionsWeibo) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsWeibo other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsWeibo other) {
        ...
        public ConnectionOptionsWeibo build() {
            return new ConnectionOptionsWeibo(
                    clientId,
                    clientSecret,
                    scope,
