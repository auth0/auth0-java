...
@JsonDeserialize(builder = ConnectionOptionsYahoo.Builder.class)
public final class ConnectionOptionsYahoo implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsYahoo(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsYahoo && equalTo((ConnectionOptionsYahoo) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsYahoo other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsYahoo other) {
        ...
        public ConnectionOptionsYahoo build() {
            return new ConnectionOptionsYahoo(
                    clientId,
                    clientSecret,
                    upstreamParams,
