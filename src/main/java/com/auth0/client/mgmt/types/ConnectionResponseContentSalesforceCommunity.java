...
public final class ConnectionResponseContentSalesforceCommunity
    ...
    public ConnectionResponseContentSalesforceCommunityStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionResponseContentSalesforceCommunity
                && equalTo((ConnectionResponseContentSalesforceCommunity) other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull ConnectionResponseContentSalesforceCommunityStrategy strategy);

        Builder from(ConnectionResponseContentSalesforceCommunity other);
    }
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull ConnectionResponseContentSalesforceCommunityStrategy strategy) {
