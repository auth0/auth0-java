...
@JsonDeserialize(builder = UpdateOrganizationResponseContent.Builder.class)
public final class UpdateOrganizationResponseContent {
    ...
    private UpdateOrganizationResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateOrganizationResponseContent && equalTo((UpdateOrganizationResponseContent) other);
    }
    ...
    private boolean equalTo(UpdateOrganizationResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateOrganizationResponseContent other) {
            id(other.getId());
            name(other.getName());
        ...
        public UpdateOrganizationResponseContent build() {
            return new UpdateOrganizationResponseContent(
                    id, name, displayName, branding, metadata, tokenQuota, additionalProperties);
        }
    }
}
