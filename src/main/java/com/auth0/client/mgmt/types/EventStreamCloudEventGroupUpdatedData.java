...
@JsonDeserialize(builder = EventStreamCloudEventGroupUpdatedData.Builder.class)
public final class EventStreamCloudEventGroupUpdatedData {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventGroupUpdatedData
                && equalTo((EventStreamCloudEventGroupUpdatedData) other);
    }
    ...
    public interface ObjectStage {
        _FinalStage object(@NotNull EventStreamCloudEventGroupUpdatedObject object);

        Builder from(EventStreamCloudEventGroupUpdatedData other);
    }

    public interface _FinalStage {
        EventStreamCloudEventGroupUpdatedData build();
    ...
    public static final class Builder implements ObjectStage, _FinalStage {
        private EventStreamCloudEventGroupUpdatedObject object;
        ...
        @java.lang.Override
        @JsonSetter("object")
        public _FinalStage object(@NotNull EventStreamCloudEventGroupUpdatedObject object) {
