...
@JsonDeserialize(builder = CreateConnectionRequestContentPlanningCenter.Builder.class)
public final class CreateConnectionRequestContentPlanningCenter implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentPlanningCenterStrategy strategy;

    private final Optional<ConnectionOptionsPlanningCenter> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentPlanningCenter(
            ...
            CreateConnectionRequestContentPlanningCenterStrategy strategy,
            Optional<ConnectionOptionsPlanningCenter> options,
    ...
    public CreateConnectionRequestContentPlanningCenterStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsPlanningCenter> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentPlanningCenter
                && equalTo((CreateConnectionRequestContentPlanningCenter) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentPlanningCenter other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentPlanningCenterStrategy strategy);

        Builder from(CreateConnectionRequestContentPlanningCenter other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentPlanningCenter build();
        ...
        _FinalStage options(Optional<ConnectionOptionsPlanningCenter> options);

        _FinalStage options(ConnectionOptionsPlanningCenter options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentPlanningCenterStrategy strategy;

        private Optional<ConnectionOptionsPlanningCenter> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentPlanningCenter other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentPlanningCenterStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsPlanningCenter options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsPlanningCenter> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentPlanningCenter build() {
            return new CreateConnectionRequestContentPlanningCenter(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
