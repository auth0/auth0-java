...
public final class EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum {
    public static final EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum
            URN_OASIS_NAMES_TC_SAML20BINDINGS_HTTP_REDIRECT =
                    new EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum(
    ...
    EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum
                        && this.string.equals(
                                ((EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum) other)
                                        .string));
    }
    ...
    public static EventStreamCloudEventConnectionCreatedObject3OptionsProtocolBindingEnum valueOf(String value) {
        switch (value) {
