...
@JsonDeserialize(builder = CreateConnectionRequestContentPingFederate.Builder.class)
public final class CreateConnectionRequestContentPingFederate implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentPingFederateStrategy strategy;
    ...
    private CreateConnectionRequestContentPingFederate(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentPingFederateStrategy strategy,
    ...
    public CreateConnectionRequestContentPingFederateStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentPingFederate
                && equalTo((CreateConnectionRequestContentPingFederate) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentPingFederate other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentPingFederateStrategy strategy);

        Builder from(CreateConnectionRequestContentPingFederate other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentPingFederate build();
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentPingFederateStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentPingFederate other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentPingFederateStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentPingFederate build() {
            return new CreateConnectionRequestContentPingFederate(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
