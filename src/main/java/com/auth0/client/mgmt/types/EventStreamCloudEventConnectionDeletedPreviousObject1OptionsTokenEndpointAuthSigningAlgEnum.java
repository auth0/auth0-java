...
public final class EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTokenEndpointAuthSigningAlgEnum {
    ...
    public static EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTokenEndpointAuthSigningAlgEnum valueOf(
            String value) {
        switch (value) {
            case "RS512":
                return RS512;
