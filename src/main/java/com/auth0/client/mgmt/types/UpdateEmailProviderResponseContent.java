...
@JsonDeserialize(builder = UpdateEmailProviderResponseContent.Builder.class)
public final class UpdateEmailProviderResponseContent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateEmailProviderResponseContent
                && equalTo((UpdateEmailProviderResponseContent) other);
    }
    ...
    private boolean equalTo(UpdateEmailProviderResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateEmailProviderResponseContent other) {
            name(other.getName());
        ...
        public UpdateEmailProviderResponseContent build() {
            return new UpdateEmailProviderResponseContent(
