...
@JsonDeserialize(builder = UpdateFlowResponseContent.Builder.class)
public final class UpdateFlowResponseContent {
    ...
    private UpdateFlowResponseContent(
            String id,
            String name,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateFlowResponseContent && equalTo((UpdateFlowResponseContent) other);
    }
    ...
    private boolean equalTo(UpdateFlowResponseContent other) {
    ...
    public interface IdStage {
        ...
        Builder from(UpdateFlowResponseContent other);
    }
    ...
    public interface _FinalStage {
        UpdateFlowResponseContent build();
    ...
    public static final class Builder implements IdStage, NameStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateFlowResponseContent other) {
            id(other.getId());
            name(other.getName());
        ...
        @java.lang.Override
        public UpdateFlowResponseContent build() {
            return new UpdateFlowResponseContent(
