...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedPreviousObject1.Builder.class)
public final class EventStreamCloudEventConnectionCreatedPreviousObject1 {
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionCreatedPreviousObject1(
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Authentication> authentication,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedPreviousObject1
                && equalTo((EventStreamCloudEventConnectionCreatedPreviousObject1) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedPreviousObject1 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedPreviousObject1 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedPreviousObject1 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionCreatedPreviousObject1Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject1Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> options);

        _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject1Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject1ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedPreviousObject1 other) {
        ...
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionCreatedPreviousObject1StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionCreatedPreviousObject1Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionCreatedPreviousObject1Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionCreatedPreviousObject1Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionCreatedPreviousObject1Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedPreviousObject1 build() {
            return new EventStreamCloudEventConnectionCreatedPreviousObject1(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
