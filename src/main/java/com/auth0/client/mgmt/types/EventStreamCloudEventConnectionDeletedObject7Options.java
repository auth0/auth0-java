...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedObject7Options.Builder.class)
public final class EventStreamCloudEventConnectionDeletedObject7Options {
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsFederatedConnectionsAccessTokens>
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum> identityApi;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum>
            setUserRootAttributes;

    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum> useridAttribute;

    private final Optional<EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum> waadProtocol;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedObject7Options(
            ...
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsFederatedConnectionsAccessTokens>
                    federatedConnectionsAccessTokens,
            Optional<Boolean> granted,
            Optional<String> iconUrl,
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum> identityApi,
            Optional<String> maxGroupsToRetrieve,
            Optional<List<String>> nonPersistentAttrs,
            Optional<List<String>> scope,
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum>
                    setUserRootAttributes,
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
                    shouldTrustEmailVerifiedConnection,
            ...
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum> useridAttribute,
            Optional<EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum> waadProtocol,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsFederatedConnectionsAccessTokens>
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum> getIdentityApi() {
        return identityApi;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum>
            getSetUserRootAttributes() {
        return setUserRootAttributes;
    }

    @JsonProperty("should_trust_email_verified_connection")
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum> getUseridAttribute() {
        return useridAttribute;
    }

    @JsonProperty("waad_protocol")
    public Optional<EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum> getWaadProtocol() {
        return waadProtocol;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedObject7Options
                && equalTo((EventStreamCloudEventConnectionDeletedObject7Options) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedObject7Options other) {
    ...
    public interface ClientIdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedObject7Options other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedObject7Options build();
        ...
        _FinalStage identityApi(EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum identityApi);
        ...
        _FinalStage setUserRootAttributes(
                EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum setUserRootAttributes);
        ...
        _FinalStage useridAttribute(
                EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum useridAttribute);

        _FinalStage waadProtocol(
                Optional<EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum> waadProtocol);

        _FinalStage waadProtocol(EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum waadProtocol);
    }
    ...
    public static final class Builder implements ClientIdStage, _FinalStage {
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum> waadProtocol =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum> useridAttribute =
                Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
                shouldTrustEmailVerifiedConnection = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum>
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum> identityApi =
                Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedObject7OptionsFederatedConnectionsAccessTokens>
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedObject7Options other) {
        ...
        public _FinalStage waadProtocol(
                EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum waadProtocol) {
        ...
        public _FinalStage identityApi(
                EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum identityApi) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedObject7Options build() {
            return new EventStreamCloudEventConnectionDeletedObject7Options(
                    apiEnableUsers,
                    appDomain,
                    appId,
                    basicProfile,
