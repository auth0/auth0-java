...
@JsonDeserialize(builder = EventStreamCloudEventOrgGroupRoleAssignedData.Builder.class)
public final class EventStreamCloudEventOrgGroupRoleAssignedData {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventOrgGroupRoleAssignedData
                && equalTo((EventStreamCloudEventOrgGroupRoleAssignedData) other);
    }
    ...
    public interface ObjectStage {
        _FinalStage object(@NotNull EventStreamCloudEventOrgGroupRoleAssignedObject object);

        Builder from(EventStreamCloudEventOrgGroupRoleAssignedData other);
    }
    ...
    public static final class Builder implements ObjectStage, _FinalStage {
        private EventStreamCloudEventOrgGroupRoleAssignedObject object;
        ...
        @java.lang.Override
        @JsonSetter("object")
        public _FinalStage object(@NotNull EventStreamCloudEventOrgGroupRoleAssignedObject object) {
