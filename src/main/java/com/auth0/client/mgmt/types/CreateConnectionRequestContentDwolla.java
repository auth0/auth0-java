...
@JsonDeserialize(builder = CreateConnectionRequestContentDwolla.Builder.class)
public final class CreateConnectionRequestContentDwolla implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentDwollaStrategy strategy;

    private final Optional<ConnectionOptionsDwolla> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentDwolla(
            Optional<String> name,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            Optional<Boolean> isDomainConnection,
            Optional<Map<String, OptionalNullable<String>>> metadata,
            CreateConnectionRequestContentDwollaStrategy strategy,
            Optional<ConnectionOptionsDwolla> options,
    ...
    public CreateConnectionRequestContentDwollaStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsDwolla> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentDwolla
                && equalTo((CreateConnectionRequestContentDwolla) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentDwolla other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentDwollaStrategy strategy);

        Builder from(CreateConnectionRequestContentDwolla other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentDwolla build();
        ...
        _FinalStage options(Optional<ConnectionOptionsDwolla> options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentDwollaStrategy strategy;

        private Optional<ConnectionOptionsDwolla> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentDwolla other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentDwollaStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsDwolla options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsDwolla> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentDwolla build() {
            return new CreateConnectionRequestContentDwolla(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
