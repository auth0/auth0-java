...
@JsonDeserialize(builder = ConnectionForList.Builder.class)
public final class ConnectionForList {
    ...
    private boolean equalTo(ConnectionForList other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionForList other) {
            name(other.getName());
