...
@JsonDeserialize(builder = UpdateConnectionRequestContentEmail.Builder.class)
public final class UpdateConnectionRequestContentEmail implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentEmail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentEmail
                && equalTo((UpdateConnectionRequestContentEmail) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentEmail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentEmail other) {
        ...
        public UpdateConnectionRequestContentEmail build() {
            return new UpdateConnectionRequestContentEmail(
