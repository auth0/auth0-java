...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject7Options.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject7Options {
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum> identityApi;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum>
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum>
            useridAttribute;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum> waadProtocol;
    ...
    private EventStreamCloudEventConnectionDeletedPreviousObject7Options(
            ...
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens>
                    federatedConnectionsAccessTokens,
            Optional<Boolean> granted,
            Optional<String> iconUrl,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum> identityApi,
            Optional<String> maxGroupsToRetrieve,
            Optional<List<String>> nonPersistentAttrs,
            Optional<List<String>> scope,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum>
                    setUserRootAttributes,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
                    shouldTrustEmailVerifiedConnection,
            ...
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum> useridAttribute,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum> waadProtocol,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens>
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum> getIdentityApi() {
        return identityApi;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum>
            getSetUserRootAttributes() {
        return setUserRootAttributes;
    }

    @JsonProperty("should_trust_email_verified_connection")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum>
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum>
            getUseridAttribute() {
        return useridAttribute;
    }

    @JsonProperty("waad_protocol")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum> getWaadProtocol() {
        return waadProtocol;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject7Options
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject7Options) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject7Options other) {
    ...
    public interface ClientIdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject7Options other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedPreviousObject7Options build();
        ...
        _FinalStage identityApi(
                EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum identityApi);
        ...
        _FinalStage useridAttribute(
                Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum>
                        useridAttribute);

        _FinalStage useridAttribute(
                EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum useridAttribute);

        _FinalStage waadProtocol(
                Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum> waadProtocol);

        _FinalStage waadProtocol(
                EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum waadProtocol);
    }
    ...
    public static final class Builder implements ClientIdStage, _FinalStage {
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum> waadProtocol =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum>
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum>
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum> identityApi =
                Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens>
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject7Options other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject7Options build() {
            return new EventStreamCloudEventConnectionDeletedPreviousObject7Options(
                    apiEnableUsers,
                    appDomain,
                    appId,
                    basicProfile,
