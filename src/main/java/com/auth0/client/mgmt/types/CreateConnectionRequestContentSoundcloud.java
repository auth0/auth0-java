...
@JsonDeserialize(builder = CreateConnectionRequestContentSoundcloud.Builder.class)
public final class CreateConnectionRequestContentSoundcloud implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentSoundcloudStrategy strategy;
    ...
    private CreateConnectionRequestContentSoundcloud(
            ...
            CreateConnectionRequestContentSoundcloudStrategy strategy,
    ...
    public CreateConnectionRequestContentSoundcloudStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentSoundcloud
                && equalTo((CreateConnectionRequestContentSoundcloud) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentSoundcloud other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentSoundcloudStrategy strategy);

        Builder from(CreateConnectionRequestContentSoundcloud other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentSoundcloud build();
        ...
        _FinalStage options(Optional<ConnectionOptionsSoundcloud> options);

        _FinalStage options(ConnectionOptionsSoundcloud options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentSoundcloudStrategy strategy;
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentSoundcloud other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentSoundcloudStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsSoundcloud options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsSoundcloud> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentSoundcloud build() {
            return new CreateConnectionRequestContentSoundcloud(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
