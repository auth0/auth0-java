...
@JsonDeserialize(builder = UpdateSessionResponseContent.Builder.class)
public final class UpdateSessionResponseContent {
    ...
    private boolean equalTo(UpdateSessionResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateSessionResponseContent other) {
            id(other.getId());
