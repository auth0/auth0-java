...
@JsonDeserialize(
        builder = EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings {
    ...
    private EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings(
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
            getAlgorithmProfile() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings
                && equalTo((EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings)
                        other);
    }
    ...
    private boolean equalTo(
            EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings other) {
    ...
    public interface AlgorithmProfileStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings build();
    ...
    public static final class Builder implements AlgorithmProfileStage, _FinalStage {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings build() {
            return new EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings(
