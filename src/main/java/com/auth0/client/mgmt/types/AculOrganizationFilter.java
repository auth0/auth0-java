...
@JsonDeserialize(builder = AculOrganizationFilter.Builder.class)
public final class AculOrganizationFilter {
    ...
    private AculOrganizationFilter(
    ...
    public static final class Builder {
        ...
        public Builder from(AculOrganizationFilter other) {
            id(other.getId());
        ...
        public AculOrganizationFilter build() {
            return new AculOrganizationFilter(id, metadata, additionalProperties);
        }
    }
}
