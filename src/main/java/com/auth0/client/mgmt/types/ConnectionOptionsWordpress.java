...
@JsonDeserialize(builder = ConnectionOptionsWordpress.Builder.class)
public final class ConnectionOptionsWordpress implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsWordpress(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsWordpress && equalTo((ConnectionOptionsWordpress) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsWordpress other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsWordpress other) {
        ...
        public ConnectionOptionsWordpress build() {
            return new ConnectionOptionsWordpress(
                    clientId,
                    clientSecret,
                    scope,
