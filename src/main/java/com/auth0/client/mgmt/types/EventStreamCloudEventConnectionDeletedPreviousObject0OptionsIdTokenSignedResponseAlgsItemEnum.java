...
public final class EventStreamCloudEventConnectionDeletedPreviousObject0OptionsIdTokenSignedResponseAlgsItemEnum {
    ...
    public static EventStreamCloudEventConnectionDeletedPreviousObject0OptionsIdTokenSignedResponseAlgsItemEnum valueOf(
            String value) {
        switch (value) {
            case "RS512":
                return RS512;
