...
@JsonDeserialize(builder = UpdateConnectionRequestContentBaidu.Builder.class)
public final class UpdateConnectionRequestContentBaidu implements IConnectionCommon {
    ...
    private UpdateConnectionRequestContentBaidu(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateConnectionRequestContentBaidu
                && equalTo((UpdateConnectionRequestContentBaidu) other);
    }
    ...
    private boolean equalTo(UpdateConnectionRequestContentBaidu other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateConnectionRequestContentBaidu other) {
        ...
        public Builder options(Optional<ConnectionOptionsBaidu> options) {
            this.options = options;
            return this;
        }

        public Builder options(ConnectionOptionsBaidu options) {
            this.options = Optional.ofNullable(options);
            return this;
        }

        public UpdateConnectionRequestContentBaidu build() {
            return new UpdateConnectionRequestContentBaidu(
