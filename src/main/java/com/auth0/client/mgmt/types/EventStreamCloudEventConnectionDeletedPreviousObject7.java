...
@JsonDeserialize(builder = EventStreamCloudEventConnectionDeletedPreviousObject7.Builder.class)
public final class EventStreamCloudEventConnectionDeletedPreviousObject7 {
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Authentication> authentication;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts> connectedAccounts;
    ...
    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> metadata;

    private final String name;

    private final Optional<List<String>> realms;

    private final Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> options;

    private final Optional<Boolean> showAsButton;

    private final EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum strategy;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionDeletedPreviousObject7(
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Authentication> authentication,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts> connectedAccounts,
            Optional<String> displayName,
            Optional<List<String>> enabledClients,
            String id,
            Optional<Boolean> isDomainConnection,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> metadata,
            String name,
            Optional<List<String>> realms,
            Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> options,
            Optional<Boolean> showAsButton,
            EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum strategy,
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Authentication> getAuthentication() {
        return authentication;
    }

    @JsonProperty("connected_accounts")
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts> getConnectedAccounts() {
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> getMetadata() {
        return metadata;
    }
    ...
    public Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> getOptions() {
        return options;
    }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionDeletedPreviousObject7
                && equalTo((EventStreamCloudEventConnectionDeletedPreviousObject7) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionDeletedPreviousObject7 other) {
    ...
    public interface IdStage {
        ...
        Builder from(EventStreamCloudEventConnectionDeletedPreviousObject7 other);
    }
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum strategy);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionDeletedPreviousObject7 build();
        ...
        _FinalStage authentication(EventStreamCloudEventConnectionDeletedPreviousObject7Authentication authentication);

        _FinalStage connectedAccounts(
                Optional<EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts> connectedAccounts);

        _FinalStage connectedAccounts(
                EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts connectedAccounts);
        ...
        _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> metadata);

        _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject7Metadata metadata);
        ...
        _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> options);

        _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject7Options options);
    ...
    public static final class Builder implements IdStage, NameStage, StrategyStage, _FinalStage {
        ...
        private EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> options = Optional.empty();

        private Optional<List<String>> realms = Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> metadata = Optional.empty();
        ...
        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts> connectedAccounts =
                Optional.empty();

        private Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Authentication> authentication =
                Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionDeletedPreviousObject7 other) {
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(
                @NotNull EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum strategy) {
        ...
        @java.lang.Override
        public _FinalStage options(EventStreamCloudEventConnectionDeletedPreviousObject7Options options) {
        ...
        public _FinalStage options(Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Options> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage metadata(EventStreamCloudEventConnectionDeletedPreviousObject7Metadata metadata) {
        ...
        public _FinalStage metadata(Optional<EventStreamCloudEventConnectionDeletedPreviousObject7Metadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public _FinalStage authentication(
                EventStreamCloudEventConnectionDeletedPreviousObject7Authentication authentication) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionDeletedPreviousObject7 build() {
            return new EventStreamCloudEventConnectionDeletedPreviousObject7(
                    authentication,
                    connectedAccounts,
                    displayName,
                    enabledClients,
