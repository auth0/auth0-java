...
@JsonDeserialize(builder = EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts.Builder.class)
public final class EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts
                && equalTo((EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts other) {
    ...
    public interface ActiveStage {
        ...
        Builder from(EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts build();
    ...
    public static final class Builder implements ActiveStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts build() {
            return new EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts(
