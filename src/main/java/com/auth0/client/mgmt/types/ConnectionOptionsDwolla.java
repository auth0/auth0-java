...
@JsonDeserialize(builder = ConnectionOptionsDwolla.Builder.class)
public final class ConnectionOptionsDwolla implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsDwolla(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsDwolla && equalTo((ConnectionOptionsDwolla) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsDwolla other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsDwolla other) {
        ...
        public ConnectionOptionsDwolla build() {
            return new ConnectionOptionsDwolla(
                    clientId,
                    clientSecret,
                    upstreamParams,
