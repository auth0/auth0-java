...
@JsonDeserialize(builder = UpdatePhoneTemplateResponseContent.Builder.class)
public final class UpdatePhoneTemplateResponseContent {
    ...
    private UpdatePhoneTemplateResponseContent(
            String id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdatePhoneTemplateResponseContent
                && equalTo((UpdatePhoneTemplateResponseContent) other);
    }
    ...
    private boolean equalTo(UpdatePhoneTemplateResponseContent other) {
    ...
    public interface _FinalStage {
        UpdatePhoneTemplateResponseContent build();
