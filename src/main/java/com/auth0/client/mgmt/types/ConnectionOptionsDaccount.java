...
@JsonDeserialize(builder = ConnectionOptionsDaccount.Builder.class)
public final class ConnectionOptionsDaccount implements IConnectionOptionsOAuth2Common, IConnectionOptionsCommon {
    ...
    private ConnectionOptionsDaccount(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConnectionOptionsDaccount && equalTo((ConnectionOptionsDaccount) other);
    }
    ...
    private boolean equalTo(ConnectionOptionsDaccount other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ConnectionOptionsDaccount other) {
        ...
        public ConnectionOptionsDaccount build() {
            return new ConnectionOptionsDaccount(
                    clientId,
                    clientSecret,
                    upstreamParams,
