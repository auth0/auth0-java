...
@JsonDeserialize(
        builder = EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings.Builder.class)
public final class EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings {
    private final Optional<List<String>> algorithmExceptions;

    private final EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
            algorithmProfile;

    private final Map<String, Object> additionalProperties;

    private EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings
                && equalTo((EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings) other);
    }
    ...
    private boolean equalTo(EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings other) {
    ...
    public interface AlgorithmProfileStage {
        ...
        Builder from(EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings other);
    }

    public interface _FinalStage {
        EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings build();
    ...
    public static final class Builder implements AlgorithmProfileStage, _FinalStage {
        private EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettingsAlgorithmProfileEnum
                algorithmProfile;
        ...
        @java.lang.Override
        public Builder from(EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings other) {
        ...
        @java.lang.Override
        public EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings build() {
            return new EventStreamCloudEventConnectionUpdatedObject2OptionsAssertionDecryptionSettings(
