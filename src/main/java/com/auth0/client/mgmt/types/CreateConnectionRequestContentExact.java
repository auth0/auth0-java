...
@JsonDeserialize(builder = CreateConnectionRequestContentExact.Builder.class)
public final class CreateConnectionRequestContentExact implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentExactStrategy strategy;

    private final Optional<ConnectionOptionsExact> options;

    private final Map<String, Object> additionalProperties;

    private CreateConnectionRequestContentExact(
            ...
            CreateConnectionRequestContentExactStrategy strategy,
            Optional<ConnectionOptionsExact> options,
    ...
    public CreateConnectionRequestContentExactStrategy getStrategy() {
        return strategy;
    }

    @JsonProperty("options")
    public Optional<ConnectionOptionsExact> getOptions() {
        return options;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentExact
                && equalTo((CreateConnectionRequestContentExact) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentExact other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentExactStrategy strategy);

        Builder from(CreateConnectionRequestContentExact other);
    }

    public interface _FinalStage {
        CreateConnectionRequestContentExact build();
        ...
        _FinalStage options(Optional<ConnectionOptionsExact> options);

        _FinalStage options(ConnectionOptionsExact options);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentExactStrategy strategy;

        private Optional<ConnectionOptionsExact> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentExact other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentExactStrategy strategy) {
            this.strategy = Objects.requireNonNull(strategy, "strategy must not be null");
            return this;
        }

        @java.lang.Override
        public _FinalStage options(ConnectionOptionsExact options) {
        ...
        public _FinalStage options(Optional<ConnectionOptionsExact> options) {
            this.options = options;
            return this;
        }
        ...
        @java.lang.Override
        public CreateConnectionRequestContentExact build() {
            return new CreateConnectionRequestContentExact(
                    name,
                    authentication,
                    connectedAccounts,
                    displayName,
