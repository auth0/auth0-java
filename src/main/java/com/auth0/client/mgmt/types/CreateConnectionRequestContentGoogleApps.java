...
@JsonDeserialize(builder = CreateConnectionRequestContentGoogleApps.Builder.class)
public final class CreateConnectionRequestContentGoogleApps implements ICreateConnectionCommon, IConnectionCommon {
    ...
    private final CreateConnectionRequestContentGoogleAppsStrategy strategy;

    private final Optional<ConnectionOptionsGoogleApps> options;
    ...
    private CreateConnectionRequestContentGoogleApps(
            ...
            CreateConnectionRequestContentGoogleAppsStrategy strategy,
    ...
    public CreateConnectionRequestContentGoogleAppsStrategy getStrategy() {
        return strategy;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateConnectionRequestContentGoogleApps
                && equalTo((CreateConnectionRequestContentGoogleApps) other);
    }
    ...
    private boolean equalTo(CreateConnectionRequestContentGoogleApps other) {
    ...
    public interface StrategyStage {
        _FinalStage strategy(@NotNull CreateConnectionRequestContentGoogleAppsStrategy strategy);

        Builder from(CreateConnectionRequestContentGoogleApps other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage options(Optional<ConnectionOptionsGoogleApps> options);

        _FinalStage options(ConnectionOptionsGoogleApps options);
    ...
    public static final class Builder implements StrategyStage, _FinalStage {
        private CreateConnectionRequestContentGoogleAppsStrategy strategy;

        private Optional<Boolean> showAsButton = Optional.empty();

        private Optional<ConnectionOptionsGoogleApps> options = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateConnectionRequestContentGoogleApps other) {
            name(other.getName());
        ...
        @java.lang.Override
        @JsonSetter("strategy")
        public _FinalStage strategy(@NotNull CreateConnectionRequestContentGoogleAppsStrategy strategy) {
        ...
        @java.lang.Override
        public CreateConnectionRequestContentGoogleApps build() {
            return new CreateConnectionRequestContentGoogleApps(
                    name,
                    displayName,
                    enabledClients,
                    isDomainConnection,
