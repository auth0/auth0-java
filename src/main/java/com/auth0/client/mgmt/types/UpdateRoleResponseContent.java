...
@JsonDeserialize(builder = UpdateRoleResponseContent.Builder.class)
public final class UpdateRoleResponseContent {
    ...
    private UpdateRoleResponseContent(
            Optional<String> id,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateRoleResponseContent && equalTo((UpdateRoleResponseContent) other);
    }
    ...
    private boolean equalTo(UpdateRoleResponseContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateRoleResponseContent other) {
            id(other.getId());
            name(other.getName());
        ...
        public UpdateRoleResponseContent build() {
            return new UpdateRoleResponseContent(id, name, description, type, ownerId, additionalProperties);
        }
