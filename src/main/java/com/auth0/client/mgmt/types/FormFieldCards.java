...
@JsonDeserialize(builder = FormFieldCards.Builder.class)
public final class FormFieldCards {
    private final String id;

    private final FormComponentCategoryFieldConst category;

    private final FormFieldTypeCardsConst type;

    private final Optional<FormFieldCardsConfig> config;
    ...
    private FormFieldCards(
            String id,
            FormComponentCategoryFieldConst category,
            FormFieldTypeCardsConst type,
            Optional<FormFieldCardsConfig> config,
    ...
    @JsonProperty("type")
    public FormFieldTypeCardsConst getType() {
        return type;
    }

    @JsonProperty("config")
    public Optional<FormFieldCardsConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof FormFieldCards && equalTo((FormFieldCards) other);
    }
    ...
    private boolean equalTo(FormFieldCards other) {
    ...
    public interface IdStage {
        ...
        Builder from(FormFieldCards other);
    }
    ...
    public interface TypeStage {
        _FinalStage type(@NotNull FormFieldTypeCardsConst type);
    }
    ...
    public static final class Builder implements IdStage, CategoryStage, TypeStage, _FinalStage {
        ...
        private FormFieldTypeCardsConst type;
        ...
        private Optional<FormFieldCardsConfig> config = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(FormFieldCards other) {
            id(other.getId());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(@NotNull FormFieldTypeCardsConst type) {
        ...
        @java.lang.Override
        public _FinalStage config(FormFieldCardsConfig config) {
        ...
        public _FinalStage config(Optional<FormFieldCardsConfig> config) {
            this.config = config;
            return this;
        }
