...
public class JobsEntity extends BaseManagementEntity {
    ...
    public Request<Job> get(String jobId) {
        ...
        ExtendedBaseRequest<Job> request = new ExtendedBaseRequest<>(client, url, HttpMethod.GET, new TypeReference<Job>() {
        });
    ...
    public Request<List<JobErrorDetails>> getErrorDetails(String jobId) {
        ...
        ExtendedBaseRequest<List<JobErrorDetails>> request = new ExtendedBaseRequest<List<JobErrorDetails>>(client, url, HttpMethod.GET, jobErrorDetailsListType) {
            @Override
    ...
    public Request<Job> sendVerificationEmail(String userId, String clientId, EmailVerificationIdentity emailVerificationIdentity, String orgId) {
        ...
        ExtendedBaseRequest<Job> request = new ExtendedBaseRequest<>(client, url, HttpMethod.POST, new TypeReference<Job>() {
        });
        request.addHeader("Authorization", "Bearer " + apiToken);
