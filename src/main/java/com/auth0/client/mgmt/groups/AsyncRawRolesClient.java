...
public class AsyncRawRolesClient {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListGroupRolesResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListGroupRolesResponseContent.class);
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> create(
            String id, CreateGroupRolesRequestParameters request) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> delete(
            String id, DeleteGroupRolesRequestContent request) {
