...
import com.auth0.client.mgmt.types.ListGroupRolesResponseContent;
...
public class RawRolesClient {
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Role>> list(String id) {
        return list(id, ListGroupRolesRequestParameters.builder().build());
    }
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Role>> list(String id, RequestOptions requestOptions) {
        return list(id, ListGroupRolesRequestParameters.builder().build(), requestOptions);
    }
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Role>> list(
            String id, ListGroupRolesRequestParameters request) {
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Role>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListGroupRolesResponseContent parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListGroupRolesResponseContent.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                ListGroupRolesRequestParameters nextRequest = ListGroupRolesRequestParameters.builder()
                        .from(request)
                        .from(startingAfter)
                        .build();
     ...
     */
    public ManagementApiHttpResponse<Void> create(String id, CreateGroupRolesRequestParameters request) {
     ...
     */
    public ManagementApiHttpResponse<Void> delete(String id, DeleteGroupRolesRequestContent request) {
