...
@JsonDeserialize(builder = ListOrganizationClientsRequestParameters.Builder.class)
public final class ListOrganizationClientsRequestParameters {
    ...
    private ListOrganizationClientsRequestParameters(
    ...
    /**
     * @return Number of results per page. Defaults to 50. Values greater than the maximum of 100 are capped at 100.
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("take")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrganizationClientsRequestParameters
                && equalTo((ListOrganizationClientsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrganizationClientsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListOrganizationClientsRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
            return this;
        }
        ...
        /**
         * <p>Number of results per page. Defaults to 50. Values greater than the maximum of 100 are capped at 100.</p>
         */
        ...
        public ListOrganizationClientsRequestParameters build() {
            return new ListOrganizationClientsRequestParameters(from, take, additionalProperties);
        }
