...
public class RawOrganizationTemplateClient {
     ...
     */
    public ManagementApiHttpResponse<Void> assignOrganizationTemplate(String id, String templateId) {
     ...
     * Assign an Organization Template to an organization.
     */
    public ManagementApiHttpResponse<Void> assignOrganizationTemplate(
     ...
     */
    public ManagementApiHttpResponse<Void> unassignOrganizationTemplate(String id, String templateId) {
     ...
     * Remove an Organization Template assignment from an organization.
     */
    public ManagementApiHttpResponse<Void> unassignOrganizationTemplate(
            String id, String templateId, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("organizations")
