...
import com.auth0.client.mgmt.types.ListOrganizationGroupsResponseContent;
...
public class RawGroupsClient {
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<Group>> list(String organizationId) {
        return list(
                organizationId,
                ListOrganizationGroupsRequestParameters.builder().build());
    }
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<Group>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListOrganizationGroupsResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        responseBodyString, ListOrganizationGroupsResponseContent.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                ListOrganizationGroupsRequestParameters nextRequest = ListOrganizationGroupsRequestParameters.builder()
                        .from(request)
                        .from(startingAfter)
                        .build();
                ...
                return new ManagementApiHttpResponse<>(
                        new SyncPagingIterable<Group>(startingAfter.isPresent(), result, parsedResponse, () -> list(
                                        organizationId, nextRequest, requestOptions)
                                .body()),
                        response);
            }
            try {
