...
public class AsyncRawGroupsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>>> list(
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<RoleGroup>(
                                        startingAfter.isPresent(), result, parsedResponse, () -> {
                                            try {
                                                return list(organizationId, roleId, nextRequest, requestOptions)
                                                        .get()
                                                        .body();
