...
public class AsyncRawOrganizationTemplateClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> assignOrganizationTemplate(String id, String templateId) {
     ...
     * Assign an Organization Template to an organization.
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> assignOrganizationTemplate(
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<Void>> unassignOrganizationTemplate(
