 ...
 */
package com.auth0.client.mgmt.organizations.members.effectiveroles.sources.types;
...
@JsonDeserialize(builder = ListOrganizationMemberRoleSourceGroupsRequestParameters.Builder.class)
public final class ListOrganizationMemberRoleSourceGroupsRequestParameters {
    ...
    private ListOrganizationMemberRoleSourceGroupsRequestParameters(
    ...
    /**
     * @return The role ID to get group sources for.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrganizationMemberRoleSourceGroupsRequestParameters
                && equalTo((ListOrganizationMemberRoleSourceGroupsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrganizationMemberRoleSourceGroupsRequestParameters other) {
        return from.equals(other.from) && take.equals(other.take) && roleId.equals(other.roleId);
    }

    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.from, this.take, this.roleId);
    }
    ...
    public interface RoleIdStage {
        /**
         * <p>The role ID to get group sources for.</p>
         */
        _FinalStage roleId(@NotNull String roleId);

        Builder from(ListOrganizationMemberRoleSourceGroupsRequestParameters other);
    }

    public interface _FinalStage {
        ListOrganizationMemberRoleSourceGroupsRequestParameters build();
    ...
    public static final class Builder implements RoleIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListOrganizationMemberRoleSourceGroupsRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
        ...
        @java.lang.Override
        public ListOrganizationMemberRoleSourceGroupsRequestParameters build() {
            return new ListOrganizationMemberRoleSourceGroupsRequestParameters(
                    from, take, roleId, additionalProperties);
        }
