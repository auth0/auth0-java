...
import com.auth0.client.mgmt.types.OrganizationAccessLevelEnum;
import com.auth0.client.mgmt.types.OrganizationMemberAccessLevelEnum;
...
@JsonDeserialize(builder = CreateOrganizationAllConnectionRequestParameters.Builder.class)
public final class CreateOrganizationAllConnectionRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateOrganizationAllConnectionRequestParameters
                && equalTo((CreateOrganizationAllConnectionRequestParameters) other);
    }
    ...
    private boolean equalTo(CreateOrganizationAllConnectionRequestParameters other) {
    ...
    public interface _FinalStage {
        CreateOrganizationAllConnectionRequestParameters build();
    ...
    public static final class Builder implements ConnectionIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateOrganizationAllConnectionRequestParameters other) {
