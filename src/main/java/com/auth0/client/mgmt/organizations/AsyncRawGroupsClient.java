...
public class AsyncRawGroupsClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<Group>>> list(String organizationId) {
        return list(
                organizationId,
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        ListOrganizationGroupsRequestParameters nextRequest =
                        ...
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<Group>(startingAfter.isPresent(), result, parsedResponse, () -> {
                                    try {
                                        return list(organizationId, nextRequest, requestOptions)
                                                .get()
                                                .body();
