...
import com.auth0.client.mgmt.types.ListOrganizationRoleGroupsResponseContent;
...
public class RawGroupsClient {
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>> list(String organizationId, String roleId) {
        return list(
                organizationId,
                roleId,
                ListOrganizationRoleGroupsRequestParameters.builder().build());
    }

    /**
     * Retrieve the list of groups assigned to a role in the context of an organization.
     */
    public ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>> list(
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>> list(
        ...
        return list(organizationId, roleId, request, null);
    }
    ...
    public ManagementApiHttpResponse<SyncPagingIterable<RoleGroup>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListOrganizationRoleGroupsResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        responseBodyString, ListOrganizationRoleGroupsResponseContent.class);
                Optional<String> startingAfter = parsedResponse.getNext();
                ListOrganizationRoleGroupsRequestParameters nextRequest =
                        ListOrganizationRoleGroupsRequestParameters.builder()
                                .from(request)
                                .from(startingAfter)
                                .build();
                List<RoleGroup> result = parsedResponse.getGroups();
                return new ManagementApiHttpResponse<>(
                        new SyncPagingIterable<RoleGroup>(startingAfter.isPresent(), result, parsedResponse, () -> list(
                                        organizationId, roleId, nextRequest, requestOptions)
                                .body()),
                        response);
            }
            try {
