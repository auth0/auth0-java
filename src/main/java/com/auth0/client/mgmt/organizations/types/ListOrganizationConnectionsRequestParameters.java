...
@JsonDeserialize(builder = ListOrganizationConnectionsRequestParameters.Builder.class)
public final class ListOrganizationConnectionsRequestParameters {
    ...
    private ListOrganizationConnectionsRequestParameters(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrganizationConnectionsRequestParameters
                && equalTo((ListOrganizationConnectionsRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrganizationConnectionsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListOrganizationConnectionsRequestParameters other) {
            page(other.getPage());
        ...
        public ListOrganizationConnectionsRequestParameters build() {
            return new ListOrganizationConnectionsRequestParameters(page, perPage, includeTotals, additionalProperties);
        }
