 ...
 */
package com.auth0.client.mgmt.organizations.roles.types;
...
@JsonDeserialize(builder = ListOrganizationRoleMembersRequestParameters.Builder.class)
public final class ListOrganizationRoleMembersRequestParameters {
    ...
    /**
     * @return Number of results per page. Defaults to 50. Values above the maximum permitted size are capped.
     */
    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("take")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrganizationRoleMembersRequestParameters
                && equalTo((ListOrganizationRoleMembersRequestParameters) other);
    }
    ...
    private boolean equalTo(ListOrganizationRoleMembersRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListOrganizationRoleMembersRequestParameters other) {
            from(other.getFrom());
            take(other.getTake());
        ...
        /**
         * <p>Number of results per page. Defaults to 50. Values above the maximum permitted size are capped.</p>
         */
        ...
        public ListOrganizationRoleMembersRequestParameters build() {
            return new ListOrganizationRoleMembersRequestParameters(
