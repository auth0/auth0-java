...
public class RawOrganizationTemplatesClient {
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplate>> list() {
     ...
     * Retrieve a list of Organization Templates. This endpoint supports Checkpoint pagination. Results are returned in a stable order, sorted by their identifier (<code>id</code>) in ascending order.
     */
    public ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplate>> list(RequestOptions requestOptions) {
     ...
     */
    public ManagementApiHttpResponse<OrganizationTemplate> create(CreateOrganizationTemplateRequestContent request) {
     ...
     * Create an Organization Template.
     */
    public ManagementApiHttpResponse<OrganizationTemplate> create(
     ...
     */
    public ManagementApiHttpResponse<OrganizationTemplate> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieve details about a single Organization Template specified by ID.
     */
    public ManagementApiHttpResponse<OrganizationTemplate> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("organization-templates")
                .addPathSegment(id);
     ...
     */
    public ManagementApiHttpResponse<OrganizationTemplate> update(String id) {
     ...
     * Update the details of a specific Organization Template.
     */
    public ManagementApiHttpResponse<OrganizationTemplate> update(String id, RequestOptions requestOptions) {
     ...
     * Update the details of a specific Organization Template.
     */
    public ManagementApiHttpResponse<OrganizationTemplate> update(
     ...
     */
    public ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplateAssignedOrganization>> listOrganizations(
            String id) {
