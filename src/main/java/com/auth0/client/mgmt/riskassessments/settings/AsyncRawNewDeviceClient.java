...
public class AsyncRawNewDeviceClient {
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetRiskAssessmentsSettingsNewDeviceResponseContent>> get(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetRiskAssessmentsSettingsNewDeviceResponseContent>> future =
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsNewDeviceResponseContent>> update(
    ...
    public CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsNewDeviceResponseContent>> update(
        ...
        CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsNewDeviceResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString,
                                        UpdateRiskAssessmentsSettingsNewDeviceResponseContent.class),
                                response));
                        return;
                    }
                    try {
