...
public class AsyncRawSettingsClient {
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetRiskAssessmentsSettingsResponseContent>> get(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("risk-assessments/settings")
                .build();
        ...
        CompletableFuture<ManagementApiHttpResponse<GetRiskAssessmentsSettingsResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetRiskAssessmentsSettingsResponseContent.class),
                                response));
                        return;
                    }
                    try {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsResponseContent>> update(
    ...
    public CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsResponseContent>> update(
        ...
        CompletableFuture<ManagementApiHttpResponse<UpdateRiskAssessmentsSettingsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpdateRiskAssessmentsSettingsResponseContent.class),
                                response));
                        return;
                    }
                    try {
