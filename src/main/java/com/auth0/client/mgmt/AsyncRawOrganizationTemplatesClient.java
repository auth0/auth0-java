...
public class AsyncRawOrganizationTemplatesClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplate>>> list() {
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplate>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplate>>> future =
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> create(
    ...
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> create(
        ...
        CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> get(String id) {
        return get(id, null);
    }
     ...
     * Retrieve details about a single Organization Template specified by ID.
     */
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> get(
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> update(String id) {
     ...
     * Update the details of a specific Organization Template.
     */
    public CompletableFuture<ManagementApiHttpResponse<OrganizationTemplate>> update(
            String id, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplateAssignedOrganization>>>
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplateAssignedOrganization>>>
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<OrganizationTemplateAssignedOrganization>>>
                    ...
                    if (response.isSuccessful()) {
                        ...
                        ListTemplateOrganizationsRequestParameters nextRequest =
                                ListTemplateOrganizationsRequestParameters.builder()
                                        ...
                                        .from(startingAfter)
                                        .build();
                        List<OrganizationTemplateAssignedOrganization> result = parsedResponse.getOrganizations();
                        future.complete(new ManagementApiHttpResponse<>(
                                new SyncPagingIterable<OrganizationTemplateAssignedOrganization>(
                                        startingAfter.isPresent(), result, parsedResponse, () -> {
                                            try {
