...
@JsonDeserialize(builder = GetTenantSettingsRequestParameters.Builder.class)
public final class GetTenantSettingsRequestParameters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetTenantSettingsRequestParameters
                && equalTo((GetTenantSettingsRequestParameters) other);
    }
    ...
    private boolean equalTo(GetTenantSettingsRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetTenantSettingsRequestParameters other) {
        ...
        public GetTenantSettingsRequestParameters build() {
            return new GetTenantSettingsRequestParameters(fields, includeFields, additionalProperties);
        }
    }
}
