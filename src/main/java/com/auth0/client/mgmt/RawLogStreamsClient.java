...
public class RawLogStreamsClient {
    protected final ClientOptions clientOptions;

    public RawLogStreamsClient(ClientOptions clientOptions) {
    ...
    public ManagementApiHttpResponse<CreateLogStreamResponseContent> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ManagementApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateLogStreamResponseContent.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public ManagementApiHttpResponse<GetLogStreamResponseContent> get(String id, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ManagementApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetLogStreamResponseContent.class),
                        response);
            }
            try {
                switch (response.code()) {
    ...
    public ManagementApiHttpResponse<UpdateLogStreamResponseContent> update(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ManagementApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateLogStreamResponseContent.class),
                        response);
            }
            try {
                switch (response.code()) {
