...
public class AsyncRawAgentsClient {
     ...
     * Get agents
     */
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<AgentResponseContent>>> list() {
    ...
    public CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<AgentResponseContent>>> list(
        ...
        CompletableFuture<ManagementApiHttpResponse<SyncPagingIterable<AgentResponseContent>>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListAgentsResponseContent parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListAgentsResponseContent.class);
     ...
     * Create an agent
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> create(
    ...
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> create(
        ...
        CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AgentResponseContent.class),
                                response));
                        return;
                    }
                    try {
     ...
     * Get an agent
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> read(String id) {
        return read(id, null);
    }
     ...
     * Get an agent
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> read(
     ...
     * Update an agent
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> update(String id) {
     ...
     * Update an agent
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> update(
            String id, RequestOptions requestOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<AgentResponseContent>> update(
            String id, PatchAgentRequestParameters request) {
