...
public class RawPhoneClient {
     ...
     */
    public ManagementApiHttpResponse<GetPhoneFactorSettingsResponseContent> get() {
        return get(null);
    }
     ...
     * TODO: Link this endpoint to relevant documentation when available.
     */
    public ManagementApiHttpResponse<GetPhoneFactorSettingsResponseContent> get(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     * TODO: Link this endpoint to relevant documentation when available.
     */
    public ManagementApiHttpResponse<SetPhoneFactorSettingsResponseContent> set(
