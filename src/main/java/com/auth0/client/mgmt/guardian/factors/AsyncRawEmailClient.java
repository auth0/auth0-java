...
public class AsyncRawEmailClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<GetEmailFactorSettingsResponseContent>> get() {
        return get(null);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetEmailFactorSettingsResponseContent>> get(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetEmailFactorSettingsResponseContent>> future =
     ...
     * TODO: Link this endpoint to relevant documentation when available.
     */
    public CompletableFuture<ManagementApiHttpResponse<SetEmailFactorSettingsResponseContent>> set(
    ...
    public CompletableFuture<ManagementApiHttpResponse<SetEmailFactorSettingsResponseContent>> set(
        ...
        CompletableFuture<ManagementApiHttpResponse<SetEmailFactorSettingsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
