...
@JsonDeserialize(builder = UpdateGuardianFactorDuoSettingsRequestContent.Builder.class)
public final class UpdateGuardianFactorDuoSettingsRequestContent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGuardianFactorDuoSettingsRequestContent
                && equalTo((UpdateGuardianFactorDuoSettingsRequestContent) other);
    }
    ...
    private boolean equalTo(UpdateGuardianFactorDuoSettingsRequestContent other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpdateGuardianFactorDuoSettingsRequestContent other) {
            ikey(other.getIkey());
            skey(other.getSkey());
            host(other.getHost());
            return this;
        ...
        public UpdateGuardianFactorDuoSettingsRequestContent build() {
            return new UpdateGuardianFactorDuoSettingsRequestContent(ikey, skey, host, additionalProperties);
        }
    }
}
