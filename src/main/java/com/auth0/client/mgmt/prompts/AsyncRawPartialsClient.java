...
public class AsyncRawPartialsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawPartialsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<Map<String, Object>>> get(PartialGroupsEnum prompt) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<Void>> set(
            PartialGroupsEnum prompt, Map<String, Object> request) {
