...
public class AsyncRawUsersExportsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawUsersExportsClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> create() {
        return create(CreateExportUsersRequestContent.builder().build());
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> create(
        ...
        CompletableFuture<ManagementApiHttpResponse<CreateExportUsersResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateExportUsersResponseContent.class),
                                response));
                        return;
                    }
                    try {
