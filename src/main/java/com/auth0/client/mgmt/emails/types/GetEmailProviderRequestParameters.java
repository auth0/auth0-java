...
@JsonDeserialize(builder = GetEmailProviderRequestParameters.Builder.class)
public final class GetEmailProviderRequestParameters {
    ...
    private GetEmailProviderRequestParameters(
    ...
    /**
     * @return Comma-separated list of fields to include or exclude (dependent upon include_fields) from the result. Leave empty to retrieve <code>name</code> and <code>enabled</code>. Additional fields available include <code>credentials</code>, <code>default_from_address</code>, and <code>settings</code>.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetEmailProviderRequestParameters && equalTo((GetEmailProviderRequestParameters) other);
    }
    ...
    private boolean equalTo(GetEmailProviderRequestParameters other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetEmailProviderRequestParameters other) {
        ...
        /**
         * <p>Comma-separated list of fields to include or exclude (dependent upon include_fields) from the result. Leave empty to retrieve <code>name</code> and <code>enabled</code>. Additional fields available include <code>credentials</code>, <code>default_from_address</code>, and <code>settings</code>.</p>
         */
        ...
        public GetEmailProviderRequestParameters build() {
            return new GetEmailProviderRequestParameters(fields, includeFields, additionalProperties);
        }
    }
}
