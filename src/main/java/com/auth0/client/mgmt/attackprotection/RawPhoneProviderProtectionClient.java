...
public class RawPhoneProviderProtectionClient {
     ...
     */
    public ManagementApiHttpResponse<GetPhoneProviderProtectionResponseContent> get() {
        return get(null);
    }
     ...
     * Get the phone provider protection configuration for a tenant.
     */
    public ManagementApiHttpResponse<GetPhoneProviderProtectionResponseContent> get(RequestOptions requestOptions) {
     ...
     */
    public ManagementApiHttpResponse<PatchPhoneProviderProtectionResponseContent> patch(
