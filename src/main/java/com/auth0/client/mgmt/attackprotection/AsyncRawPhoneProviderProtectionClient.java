...
public class AsyncRawPhoneProviderProtectionClient {
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<GetPhoneProviderProtectionResponseContent>> get() {
        return get(null);
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetPhoneProviderProtectionResponseContent>> get(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetPhoneProviderProtectionResponseContent>> future =
     ...
     */
    public CompletableFuture<ManagementApiHttpResponse<PatchPhoneProviderProtectionResponseContent>> patch(
    ...
    public CompletableFuture<ManagementApiHttpResponse<PatchPhoneProviderProtectionResponseContent>> patch(
        ...
        CompletableFuture<ManagementApiHttpResponse<PatchPhoneProviderProtectionResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
