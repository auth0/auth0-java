...
public class AsyncRawSuspiciousIpThrottlingClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSuspiciousIpThrottlingClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<ManagementApiHttpResponse<GetSuspiciousIpThrottlingSettingsResponseContent>> get(
        ...
        CompletableFuture<ManagementApiHttpResponse<GetSuspiciousIpThrottlingSettingsResponseContent>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetSuspiciousIpThrottlingSettingsResponseContent.class),
                                response));
                        return;
                    }
                    try {
    ...
    public CompletableFuture<ManagementApiHttpResponse<UpdateSuspiciousIpThrottlingSettingsResponseContent>> update() {
        return update(
                UpdateSuspiciousIpThrottlingSettingsRequestContent.builder().build());
    }
    ...
    public CompletableFuture<ManagementApiHttpResponse<UpdateSuspiciousIpThrottlingSettingsResponseContent>> update(
        ...
        CompletableFuture<ManagementApiHttpResponse<UpdateSuspiciousIpThrottlingSettingsResponseContent>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new ManagementApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpdateSuspiciousIpThrottlingSettingsResponseContent.class),
                                response));
                        return;
                    }
                    try {
