...
public class RawBruteForceProtectionClient {
    protected final ClientOptions clientOptions;

    public RawBruteForceProtectionClient(ClientOptions clientOptions) {
     ...
     */
    public ManagementApiHttpResponse<GetBruteForceSettingsResponseContent> get() {
        return get(null);
    }
