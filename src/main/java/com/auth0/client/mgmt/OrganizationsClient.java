...
import com.auth0.client.mgmt.organizations.ClientsClient;
...
public class OrganizationsClient {
     ...
     */
    public SyncPagingIterable<SearchOrganization> search() {
     ...
     * <p><strong>Sortable fields:</strong> <code>name</code>, <code>display_name</code>, <code>created_at</code> (ascending only). Defaults to insertion order (oldest first).</p>
     */
    public SyncPagingIterable<SearchOrganization> search(RequestOptions requestOptions) {
     ...
     * <p><strong>Sortable fields:</strong> <code>name</code>, <code>display_name</code>, <code>created_at</code> (ascending only). Defaults to insertion order (oldest first).</p>
     */
    public SyncPagingIterable<SearchOrganization> search(SearchOrganizationsRequestParameters request) {
