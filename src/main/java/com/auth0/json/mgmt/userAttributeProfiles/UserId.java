...
public class UserId {
    ...
    private Map<String, StrategyOverridesUserId> strategyOverrides;
     ...
     */
    @JsonProperty("oidc_mapping")
    public void setOidcMapping(String oidcMapping) {
     ...
     */
    @JsonProperty("strategy_overrides")
    public Map<String, StrategyOverridesUserId> getStrategyOverrides() {
     ...
     */
    @JsonProperty("strategy_overrides")
    public void setStrategyOverrides(Map<String, StrategyOverridesUserId> strategyOverrides) {
