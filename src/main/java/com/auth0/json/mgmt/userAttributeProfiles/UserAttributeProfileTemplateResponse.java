...
public class UserAttributeProfileTemplateResponse {
    ...
    private UserAttributeProfileTemplate template;
     ...
     */
    @JsonProperty("template")
    public UserAttributeProfileTemplate getTemplate() {
        return template;
    }
     ...
     */
    @JsonProperty("template")
    public void setTemplate(UserAttributeProfileTemplate template) {
